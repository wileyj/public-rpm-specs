...
%__ln_s  %{IMbindir}/MagickCore-config %{buildroot}%{IMbindir}/Magick-config
%__ln_s  %{IMbindir}/MagickWand-config %{buildroot}%{IMbindir}/Wand-config
%__ln_s %{_mandir}/man1/MagickCore-config.1.gz %{buildroot}%{_mandir}/man1/Magick-config.1.gz 
%__ln_s %{_mandir}/man1/MagickWand-config.1.gz %{buildroot}%{_mandir}/man1/Wand-config.1.gz 
...
%{IMlibdir}/%{name}-%{VER}
%{_datadir}/%{name}-7
#%exclude %{IMlibdir}/%{name}-%{VER}/modules*
%{_installpath}%{_sysconfdir}/%{name}*
...
%{IMlibdir}/libMagickCore*
%{IMlibdir}/libMagickWand*
%{IMlibdir}/pkgconfig/MagickCore*
%{IMlibdir}/pkgconfig/ImageMagick*
%{IMlibdir}/pkgconfig/MagickWand*
