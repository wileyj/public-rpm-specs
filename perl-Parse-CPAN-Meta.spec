...
%define pkgname Parse-CPAN-Meta
...
prefix:    %(echo %{_prefix})
BuildRequires: perl, perl-srpm-macros,  perl-JSON-PP, perl-CPAN-Meta-YAML, perl-ExtUtils-ParseXS, perl-ExtUtils-CBuilder
Requires: perl, perl-JSON-PP, perl-CPAN-Meta-YAML, perl-ExtUtils-ParseXS, perl-ExtUtils-CBuilder
%if 0%{?el6}
buildarch: x86_64
%else
buildarch: noarch
...
Parse::CPAN::Meta provides a legacy API of only two functions,
