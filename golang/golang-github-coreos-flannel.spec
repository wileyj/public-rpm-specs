...
Requires:		golang-github-coreos-etcd
...
%{__rm} -rf %{buildroot}%{gopath}/src/github.com/coreos/etcd
%__rm -rf %{buildroot}%{gopath}/pkg/linux_amd64/github.com/coreos/etcd*
...
%files -f %{filelist}
%{gopath}/src/%{import_path}/vendor/github.com/coreos/etcd/cmd/etcdctl
%{gopath}/src/%{import_path}/vendor/github.com/coreos/etcd/cmd/etcdmain
%{gopath}/src/%{import_path}/vendor/github.com/coreos/etcd/cmd/main.go
%{gopath}/src/%{import_path}/vendor/github.com/coreos/etcd/cmd/tools
