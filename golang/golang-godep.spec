...
%define repo %{url}.git
%define gitversion %(echo `curl -s %{url}/releases | grep 'class="css-truncate-target"' | head -1 |  tr -d '\\-</span class="css-truncate-target">v'`)
...
Requires:   golang-fs golang-pretty golang-go-difflib 
