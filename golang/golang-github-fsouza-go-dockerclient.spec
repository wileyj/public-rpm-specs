...
Requires: golang-github-opencontainers-runc
Requires: golang-github-docker-docker
...
%__rm -rf %{buildroot}%{gopath}/src/github.com/opencontainers/runc
#%__rm -rf %{buildroot}%{gopath}/src/github.com/docker/docker
%__rm -rf %{buildroot}%{gopath}/src/github.com/Sirupsen/logrus
%__rm -rf %{buildroot}%{gopath}/src/github.com/hashicorp/go-cleanhttp
%__rm -rf %{buildroot}%{gopath}/src/github.com/docker/go-units
%__rm -rf %{buildroot}%{gopath}/pkg/linux_amd64/golang
%__rm -rf %{buildroot}%{gopath}/pkg/linux_amd64/github.com/golang
%__rm -rf %{buildroot}%{gopath}/pkg/linux_amd64/github.com/opencontainers
%__rm -rf %{buildroot}%{gopath}/pkg/linux_amd64/github.com/docker
