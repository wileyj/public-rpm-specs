%define consul_root /opt/consul
%define consul_bindir %{consul_root}/bin
...
%__mkdir_p %{buildroot}%{consul_bindir}
%__mkdir_p %{buildroot}%{_bindir}
%__mv %{buildroot}%{gopath}/bin/%{name} %{buildroot}%{consul_bindir}/%{name}
ln -sf %{consul_bindir}/%{name} %{buildroot}%{_bindir}/%{name}
