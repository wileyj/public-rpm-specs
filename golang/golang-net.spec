%define url https://github.com/golang/net
...
Requires:	golang-crypto golang-text
Requires:	golang-text golang-crypto
...
%{__rm} -rf %{buildroot}%{gopath}/src/%{provider}.%{provider_tld}/%{repo_owner}/text
%{__rm} -rf %{buildroot}%{gopath}/src/%{provider}.%{provider_tld}/%{repo_owner}/crypto
%{__rm} -rf %{buildroot}%{gopath}/pkg/%{provider}.%{provider_tld}/%{repo_owner}/text
%{__rm} -rf %{buildroot}%{gopath}/pkg/%{provider}.%{provider_tld}/%{repo_owner}/crypto
