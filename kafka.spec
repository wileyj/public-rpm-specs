...
%define kafka_base_version 2.11-%{kafka_version}
%if  %{!?suse_version:1}0
...
License: ASL 2.0
Source0: %{kafka_name}_%{kafka_base_version}.tgz
...
%prep
%setup -n %{kafka_name}_%{kafka_base_version}

%build
#bash $RPM_SOURCE_DIR/do-component-build $RPM_SOURCE_DIR
