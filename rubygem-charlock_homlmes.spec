...
%global gemname charlock_holmes
...
(
    ...
    echo '%{gem_dir}/gems/%{gemname}-%{version}/test/fixtures/laholator.pyc'
    echo '%{gem_dir}/gems/%{gemname}-%{version}/test/fixtures/laholator.pyo'
