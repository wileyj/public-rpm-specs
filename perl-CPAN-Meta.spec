...
prefix:    %(echo %{_prefix})
BuildRequires: perl, perl-srpm-macros,  perl-JSON-PP, perl-Version-Requirements, perl-CPAN-Meta-YAML
Requires: perl, perl, perl-Parse-CPAN-Meta, perl-JSON-PP, perl-Version-Requirements, perl-CPAN-Meta-YAML
