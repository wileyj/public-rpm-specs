...
#cp src/sysv/systemd/sssd.service $RPM_BUILD_ROOT/%{_initrddir}/%{name}
...
%__mkdir_p $RPM_BUILD_ROOT/lib64/security/
%__ln_s -f %{_libdir}/security/pam_sss.so $RPM_BUILD_ROOT/lib64/security/pam_sss.so
