...
%define pkgname Cache-Memcached
...
summary:   Cache-Memcached - client library for memcached (memory cache daemon)
...
prefix:    %(echo %{_prefix})
BuildRequires: perl-String-CRC32, perl-srpm-macros
