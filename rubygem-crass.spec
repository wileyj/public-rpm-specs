...
echo '%{gem_dir}/gems/%{gemname}-%{version}/test/css-parsing-tests/make_color3_hsl.pyc'
echo '%{gem_dir}/gems/%{gemname}-%{version}/test/css-parsing-tests/make_color3_hsl.pyo'
echo '%{gem_dir}/gems/%{gemname}-%{version}/test/css-parsing-tests/make_color3_keywords.pyc'
echo '%{gem_dir}/gems/%{gemname}-%{version}/test/css-parsing-tests/make_color3_keywords.pyo'
