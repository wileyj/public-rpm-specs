...
#Patch2:   assertion_FwdState.cc_serverConnection_eq_conn-t4.patch
#Patch3:   3.5-ssl_negotiation.patch
...
%configure \
  ...
  --enable-auth \
  --enable-auth-basic="DB,NCSA,NIS,PAM,POP3,RADIUS,SASL,SMB,getpwnam,fake" \
  --enable-auth-ntlm="smb_lm,fake" \
  --enable-auth-digest="file" \
  --enable-auth-negotiate="kerberos,wrapper" \
  --enable-external-acl-helpers="wbinfo_group,delayer,file_userip,SQL_session,unix_group,session,time_quota" \
...
echo "The value of \"LimitNOFILE\" in squid systemd service needs to be changed if you changed it!!"
echo "In the case you want it unlimited replace it with: \"LimitNOFILE=infinity\""
echo "You can find the service file at: /usr/lib/systemd/system/squid.service"
