...
%global gemname sensu-plugins-ansible
...
Summary: Sensu plugins for Ansible configuration management tool
...
%description
Sensu plugins for Ansible configuration management tool.
