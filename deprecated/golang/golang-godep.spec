%define url https://github.com/tools/godep
%global provider        github
%global provider_tld    com
%global repo_owner      tools
%global project         godep
...
%define repo %{url}.git
%define gitversion %(echo `curl -s %{url}/releases | grep 'class="css-truncate-target"' | head -1 |  tr -d '\\-</span class="css-truncate-target">'`)
...
BuildRequires:   golang-fs golang-pretty golang-go-difflib 
