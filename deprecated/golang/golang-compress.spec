%define repo https://github.com/klauspost/compress
%global provider        github
%global provider_tld    com
%global repo_owner      klauspost
%global project         compress
%global secondary	snappy
...
Requires:       golang >= 1.5.0 golang-crc32 golang-cpuid
...
%{__rm} -rf %{buildroot}%{gopath}/src/%{provider}.%{provider_tld}/%{repo_owner}/{crc32,cpuid}
