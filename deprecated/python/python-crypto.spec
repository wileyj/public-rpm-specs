...
%define pypi_name crypto
%define pypi_alternate1 crypto
%define pypi_alternate2 decrypto
...
BuildArch:      x86_64
Requires: python-Naked
Requires: python-shellescape
...
for file in %{pypi_alternate1} %{pypi_alternate2}; do
