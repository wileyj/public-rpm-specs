%define repo https://github.com/apache/apr-util
...
# file.
sed -i '/^old_library/s,libapr.*\.a,,' $RPM_BUILD_ROOT%{_libdir}/libapr*.la

# Remove unnecessary exports from dependency_libs
sed -ri '/^dependency_libs/{s,-l(pq|sqlite[0-9]|rt|dl|uuid) ,,g}' $RPM_BUILD_ROOT%{_libdir}/libapr*.la
