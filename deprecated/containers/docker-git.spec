...
runc-%{commit6}/man/md2man-all.sh
...
#install -p -m 644 runc-%{commit6}/man/man8/%{repo}*.8 %{buildroot}%{_mandir}/man8

# install bash completion
install -dp %{buildroot}%{_datadir}/bash-completion/completions
install -p -m 644 runc-%{commit6}/contrib/completions/bash/* %{buildroot}%{_datadir}/bash-completion/completions
