...
%define pkgname ExtUtils-CBuilder
...
prefix:    %(echo %{_prefix})
BuildRequires: perl, perl-srpm-macros,  perl-IPC-Cmd, perl-Params-Check, perl-ExtUtils-MakeMaker
Requires: perl, perl-IPC-Cmd, perl-Params-Check
