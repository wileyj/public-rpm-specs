%define repo https://github.com/prometheus/procfs
%global provider        github
%global provider_tld    com
%global repo_owner      prometheus
%global project         procfs
...
Requires:       golang >= 1.5.0 golang_x-net golang_prometheus-client_golang golang_prometheus-client_model golang_prometheus-common
...
%__rm -rf %{buildroot}%{gopath}/src/%{import_path}/fixtures/*
(
