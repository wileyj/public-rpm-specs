%define repo https://github.com/fsnotify/fsnotify
%global provider        gopkg
%global provider_tld    in
%global repo_owner      fsnotify
%global project         fsnotify.v1
...
Requires:       golang >= 1.5.0 golang_x-sys
...
%__rm -rf %{buildroot}%{gopath}/src//golang.org/x/sys 
...
echo '"%{gopath}/pkg/linux_amd64/%{provider}.%{provider_tld}/%{project}.a"' >> %{name}-%{version}-filelist
