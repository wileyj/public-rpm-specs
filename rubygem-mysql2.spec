...
%setup -q -c -T
export LIBRARY_PATH="$LIBRARY_PATH:/opt/mysql/product/5.6.19/lib64"
export PATH="$PATH:/opt/mysql/product/5.6.19/bin"
export C_INCLUDE_PATH="-I/opt/mysql/product/5.6.19/include"
