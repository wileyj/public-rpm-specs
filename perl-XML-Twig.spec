...
%if 0%{?el6}
buildarch: x86_64
BuildRequires: perl, perl-devel, perl-libs, perl-ExtUtils-MakeMaker, perl-srpm-macros
%else
buildarch: noarch
%endif
Provides: %{name}
...
use of the "twig_roots " and 
"twig_print_outside_roots " options. The 
"finish " and "finish_print " methods also help 
...
%{__perl} Makefile.PL -y `%{__perl} -MExtUtils::MakeMaker -e ' print qq|PREFIX=%{buildroot}%{_prefix}| if \$ExtUtils::MakeMaker::VERSION =~ /5\.9[1-6]|6\.0[0-5]/ '`
