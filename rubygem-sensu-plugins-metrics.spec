# Generated from sensu-plugins-metrics-0.0.1.gem by gem2rpm -*- rpm-spec -*-
...
%global gemname sensu-plugins-metrics
...
%description
Sensu plugins for various http monitors and metrics.
