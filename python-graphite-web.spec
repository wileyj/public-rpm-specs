...
%{__ln_s} %{_sysconfdir}/%{srcname}/local_settings.py %{buildroot}%{python_sitelib}/graphite/local_settings.py
...
[ -e %{python_sitelib}/graphite/local_settings.py ] || \
    %{__ln_s} %{_sysconfdir}/%{srcname}/local_settings.py %{python_sitelib}/graphite/local_settings.py
