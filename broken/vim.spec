...
%define repo https://github.com/vim/vim
...
%{_datadir}/%{realname}/%{vimdir}/pack/dist/opt/matchit/doc/matchit.txt
%{_datadir}/%{realname}/%{vimdir}/pack/dist/opt/matchit/doc/tags
%{_datadir}/%{realname}/%{vimdir}/pack/dist/opt/matchit/plugin/matchit.vim
...
%{_datadir}/%{realname}/%{vimdir}/pack/dist/opt/dvorak/dvorak/disable.vim
%{_datadir}/%{realname}/%{vimdir}/pack/dist/opt/dvorak/dvorak/enable.vim
%{_datadir}/%{realname}/%{vimdir}/pack/dist/opt/dvorak/plugin/dvorak.vim
%{_datadir}/%{realname}/%{vimdir}/pack/dist/opt/editexisting/plugin/editexisting.vim
%{_datadir}/%{realname}/%{vimdir}/pack/dist/opt/justify/plugin/justify.vim
%{_datadir}/%{realname}/%{vimdir}/pack/dist/opt/shellmenu/plugin/shellmenu.vim
%{_datadir}/%{realname}/%{vimdir}/pack/dist/opt/swapmouse/plugin/swapmouse.vim
%{_datadir}/%{realname}/%{vimdir}/rgb.txt
