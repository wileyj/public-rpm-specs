...
BuildRequires:  python-devel python-rpm-macros python-srpm-macros python-setuptools python-pip
BuildArch:      noarch
Requires: python-quantile-python
Requires: python-requests
Requires: python-protobuf-py3
...
BuildRequires:  python3-devel python3-rpm-macros python-srpm-macros python3-setuptools python3-pip
Requires: python3-quantile-python
