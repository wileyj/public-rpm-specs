...
%define pypi_name whisper
%define pypi_alternate1 rrd2whisper.py
%define pypi_alternate2 whisper-create.py
%define pypi_alternate3 whisper-diff.py
%define pypi_alternate4 whisper-dump.py
%define pypi_alternate5 whisper-fetch.py
%define pypi_alternate6 whisper-fill.py
%define pypi_alternate7 whisper-info.py
%define pypi_alternate8 whisper-merge.py
%define pypi_alternate9 whisper-resize.py
%define pypi_alternate10 whisper-set-aggregation-method.py
%define pypi_alternate11 whisper-update.py
...
for file in %{pypi_alternate1} %{pypi_alternate2} %{pypi_alternate3} %{pypi_alternate4} %{pypi_alternate5} %{pypi_alternate6} %{pypi_alternate7} %{pypi_alternate8} %{pypi_alternate9} %{pypi_alternate10} %{pypi_alternate11}; do
