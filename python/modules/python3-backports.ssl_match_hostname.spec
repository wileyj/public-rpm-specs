%define filelist backports.ssl_match_hostname-3.5.0.1-filelist_python3
...
Provides:       python3-backports.ssl_match_hostname = %{version}-%{release}
Provides:       python3-backports.ssl_match_hostname = %{version}-%{release}
Obsoletes:      python3-backports.ssl_match_hostname < %{version}-%{release}
Obsoletes:      python3-backports.ssl_match_hostname < %{version}-%{release}
...
mv %{_builddir}/backports.ssl_match_hostname-%{version} %{_builddir}/%{name}-%{version}
