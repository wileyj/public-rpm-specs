%define filelist attrs-17.3.0-filelist_python3
...
Provides:       python3-attrs = %{version}-%{release}
Provides:       python3-attrs = %{version}-%{release}
Obsoletes:      python3-attrs < %{version}-%{release}
Obsoletes:      python3-attrs < %{version}-%{release}
...
mv %{_builddir}/attrs-%{version} %{_builddir}/%{name}-%{version}
