%define filelist gnupg-2.3.1-filelist_python3
...
Provides:       python3-gnupg = %{version}-%{release}
Provides:       python3-gnupg = %{version}-%{release}
Obsoletes:      python3-gnupg < %{version}-%{release}
Obsoletes:      python3-gnupg < %{version}-%{release}
...
mv %{_builddir}/gnupg-%{version} %{_builddir}/%{name}-%{version}
