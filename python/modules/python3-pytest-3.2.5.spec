%define filelist pytest-3.2.5-filelist_python3
...
License:        MIT license
URL:            http://pytest.org
Provides:       python3-pytest = %{version}-%{release}
Provides:       python3-pytest = %{version}-%{release}
Obsoletes:      python3-pytest < %{version}-%{release}
Obsoletes:      python3-pytest < %{version}-%{release}
...
mv %{_builddir}/pytest-%{version} %{_builddir}/%{name}-%{version}
