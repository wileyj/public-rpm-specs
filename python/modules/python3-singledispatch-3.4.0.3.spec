%define filelist singledispatch-3.4.0.3-filelist_python3
...
Provides:       python3-singledispatch = %{version}-%{release}
Provides:       python3-singledispatch = %{version}-%{release}
Obsoletes:      python3-singledispatch < %{version}-%{release}
Obsoletes:      python3-singledispatch < %{version}-%{release}
...
mv %{_builddir}/singledispatch-%{version} %{_builddir}/%{name}-%{version}
