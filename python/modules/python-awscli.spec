...
%define filelist awscli-1.12.1-filelist_python
...
Provides:       python-awscli = %{version}-%{release}
Provides:       python-awscli = %{version}-%{release}
Obsoletes:      python-awscli < %{version}-%{release}
Obsoletes:      python-awscli < %{version}-%{release}
...
%if 0%{?with_alinux}
%package -n python27-awscli
Summary:        python27-awscli
Group:          Development/Languages
License:        Apache License 2.0
URL:            http://aws.amazon.com/cli/
Provides:       awscli27 = %{version}-%{release}
Provides:       python27-awscli = %{version}-%{release}
Provides:       python27-awscli = %{version}-%{release}
Obsoletes:      python27-awscli < %{version}-%{release}
Obsoletes:      python27-awscli < %{version}-%{release}
BuildRequires:  python-devel python-rpm-macros python-srpm-macros


%description -n python27-awscli
** Amazon Linux Python
...
%{__mv} %{_builddir}/awscli-%{version} %{_builddir}/%{name}-%{version}
...
%if 0%{?with_alinux}
%files -n python27-awscli -f %{filelist}
%endif
