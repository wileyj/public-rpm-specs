%define filelist pycouchdb-1.14-filelist_python3

Name:           python3-pycouchdb
Version:        1.14
Release:        1.%{?dist}
...
Provides:       python3-pycouchdb = %{version}-%{release}
Provides:       python3-pycouchdb = %{version}-%{release}
Obsoletes:      python3-pycouchdb < %{version}-%{release}
Obsoletes:      python3-pycouchdb < %{version}-%{release}
...
mv %{_builddir}/pycouchdb-%{version} %{_builddir}/%{name}-%{version}
