%define filelist softlayer_messaging-1.0.3-filelist_python3

Name:           python3-softlayer_messaging
Version:        1.0.3
Release:        1.%{?dist}
...
Provides:       python3-softlayer_messaging = %{version}-%{release}
Provides:       python3-softlayer_messaging = %{version}-%{release}
Obsoletes:      python3-softlayer_messaging < %{version}-%{release}
Obsoletes:      python3-softlayer_messaging < %{version}-%{release}
...
mv %{_builddir}/softlayer_messaging-%{version} %{_builddir}/%{name}-%{version}
