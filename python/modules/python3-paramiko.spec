%define filelist paramiko-2.4.0-filelist_python3
...
Provides:       python3-paramiko = %{version}-%{release}
Provides:       python3-paramiko = %{version}-%{release}
Obsoletes:      python3-paramiko < %{version}-%{release}
Obsoletes:      python3-paramiko < %{version}-%{release}
...
mv %{_builddir}/paramiko-%{version} %{_builddir}/%{name}-%{version}
