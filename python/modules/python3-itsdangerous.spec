%define filelist itsdangerous-0.24-filelist_python3
...
Provides:       python3-itsdangerous = %{version}-%{release}
Provides:       python3-itsdangerous = %{version}-%{release}
Obsoletes:      python3-itsdangerous < %{version}-%{release}
Obsoletes:      python3-itsdangerous < %{version}-%{release}
...
mv %{_builddir}/itsdangerous-%{version} %{_builddir}/%{name}-%{version}
