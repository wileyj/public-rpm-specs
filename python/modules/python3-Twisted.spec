%define filelist Twisted-17.9.0-filelist_python3
...
Provides:       python3-Twisted = %{version}-%{release}
Provides:       python3-twisted = %{version}-%{release}
Obsoletes:      python3-Twisted < %{version}-%{release}
Obsoletes:      python3-twisted < %{version}-%{release}
...
mv %{_builddir}/Twisted-%{version} %{_builddir}/%{name}-%{version}
