%define filelist decorator-4.1.2-filelist_python3
...
Provides:       python3-decorator = %{version}-%{release}
Provides:       python3-decorator = %{version}-%{release}
Obsoletes:      python3-decorator < %{version}-%{release}
Obsoletes:      python3-decorator < %{version}-%{release}
...
mv %{_builddir}/decorator-%{version} %{_builddir}/%{name}-%{version}
