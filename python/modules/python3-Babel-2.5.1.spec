%define filelist Babel-2.5.1-filelist_python3
...
Provides:       python3-Babel = %{version}-%{release}
Provides:       python3-babel = %{version}-%{release}
Obsoletes:      python3-Babel < %{version}-%{release}
Obsoletes:      python3-babel < %{version}-%{release}
...
mv %{_builddir}/Babel-%{version} %{_builddir}/%{name}-%{version}
