%define filelist vine-1.1.4-filelist_python3
...
Provides:       python3-vine = %{version}-%{release}
Provides:       python3-vine = %{version}-%{release}
Obsoletes:      python3-vine < %{version}-%{release}
Obsoletes:      python3-vine < %{version}-%{release}
...
mv %{_builddir}/vine-%{version} %{_builddir}/%{name}-%{version}
