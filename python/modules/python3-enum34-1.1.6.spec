%define filelist enum34-1.1.6-filelist_python3
...
Provides:       python3-enum34 = %{version}-%{release}
Provides:       python3-enum34 = %{version}-%{release}
Obsoletes:      python3-enum34 < %{version}-%{release}
Obsoletes:      python3-enum34 < %{version}-%{release}
...
mv %{_builddir}/enum34-%{version} %{_builddir}/%{name}-%{version}
