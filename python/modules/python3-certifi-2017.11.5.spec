%define filelist certifi-2017.11.5-filelist_python3
...
License:        MPL-2.0
URL:            http://certifi.io/
Provides:       python3-certifi = %{version}-%{release}
Provides:       python3-certifi = %{version}-%{release}
Obsoletes:      python3-certifi < %{version}-%{release}
Obsoletes:      python3-certifi < %{version}-%{release}
...
mv %{_builddir}/certifi-%{version} %{_builddir}/%{name}-%{version}
