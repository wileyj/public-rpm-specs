%define filelist idna-2.6-filelist_python3
...
Provides:       python3-idna = %{version}-%{release}
Provides:       python3-idna = %{version}-%{release}
Obsoletes:      python3-idna < %{version}-%{release}
Obsoletes:      python3-idna < %{version}-%{release}
...
mv %{_builddir}/idna-%{version} %{_builddir}/%{name}-%{version}
