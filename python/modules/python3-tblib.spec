%define filelist tblib-1.3.2-filelist_python3
...
Provides:       python3-tblib = %{version}-%{release}
Provides:       python3-tblib = %{version}-%{release}
Obsoletes:      python3-tblib < %{version}-%{release}
Obsoletes:      python3-tblib < %{version}-%{release}
...
mv %{_builddir}/tblib-%{version} %{_builddir}/%{name}-%{version}
