%define filelist bcrypt-3.1.4-filelist_python3
...
Provides:       python3-bcrypt = %{version}-%{release}
Provides:       python3-bcrypt = %{version}-%{release}
Obsoletes:      python3-bcrypt < %{version}-%{release}
Obsoletes:      python3-bcrypt < %{version}-%{release}
...
mv %{_builddir}/bcrypt-%{version} %{_builddir}/%{name}-%{version}
