%define filelist eventlet-0.21.0-filelist_python3
...
Provides:       python3-eventlet = %{version}-%{release}
Provides:       python3-eventlet = %{version}-%{release}
Obsoletes:      python3-eventlet < %{version}-%{release}
Obsoletes:      python3-eventlet < %{version}-%{release}
...
mv %{_builddir}/eventlet-%{version} %{_builddir}/%{name}-%{version}
