%define filelist flower-0.9.2-filelist_python3
...
Provides:       python3-flower = %{version}-%{release}
Provides:       python3-flower = %{version}-%{release}
Obsoletes:      python3-flower < %{version}-%{release}
Obsoletes:      python3-flower < %{version}-%{release}
...
mv %{_builddir}/flower-%{version} %{_builddir}/%{name}-%{version}
