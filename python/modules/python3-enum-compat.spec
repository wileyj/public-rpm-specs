%define filelist enum-compat-0.0.2-filelist_python3

Name:           python3-enum-compat
Version:        0.0.2
Release:        1.%{?dist}
...
Provides:       python3-enum-compat = %{version}-%{release}
Provides:       python3-enum-compat = %{version}-%{release}
Obsoletes:      python3-enum-compat < %{version}-%{release}
Obsoletes:      python3-enum-compat < %{version}-%{release}
...
mv %{_builddir}/enum-compat-%{version} %{_builddir}/%{name}-%{version}
