%define filelist gevent-1.2.2-filelist_python3
...
Provides:       python3-gevent = %{version}-%{release}
Provides:       python3-gevent = %{version}-%{release}
Obsoletes:      python3-gevent < %{version}-%{release}
Obsoletes:      python3-gevent < %{version}-%{release}
...
mv %{_builddir}/gevent-%{version} %{_builddir}/%{name}-%{version}
