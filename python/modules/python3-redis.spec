%define filelist redis-2.10.6-filelist_python3
...
Provides:       python3-redis = %{version}-%{release}
Provides:       python3-redis = %{version}-%{release}
Obsoletes:      python3-redis < %{version}-%{release}
Obsoletes:      python3-redis < %{version}-%{release}
...
mv %{_builddir}/redis-%{version} %{_builddir}/%{name}-%{version}
