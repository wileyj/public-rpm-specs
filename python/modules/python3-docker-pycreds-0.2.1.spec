%define filelist docker-pycreds-0.2.1-filelist_python3

Name:           python3-docker-pycreds
Version:        0.2.1
Release:        1.%{?dist}
...
Provides:       python3-docker-pycreds = %{version}-%{release}
Provides:       python3-docker-pycreds = %{version}-%{release}
Obsoletes:      python3-docker-pycreds < %{version}-%{release}
Obsoletes:      python3-docker-pycreds < %{version}-%{release}
...
mv %{_builddir}/docker-pycreds-%{version} %{_builddir}/%{name}-%{version}
