%define filelist mock-2.0.0-filelist_python3
...
Provides:       python3-mock = %{version}-%{release}
Provides:       python3-mock = %{version}-%{release}
Obsoletes:      python3-mock < %{version}-%{release}
Obsoletes:      python3-mock < %{version}-%{release}
...
mv %{_builddir}/mock-%{version} %{_builddir}/%{name}-%{version}
