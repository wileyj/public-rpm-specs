%define filelist GitPython-2.1.7-filelist_python3
...
Provides:       python3-GitPython = %{version}-%{release}
Provides:       python3-gitpython = %{version}-%{release}
Obsoletes:      python3-GitPython < %{version}-%{release}
Obsoletes:      python3-gitpython < %{version}-%{release}
...
mv %{_builddir}/GitPython-%{version} %{_builddir}/%{name}-%{version}
