%define filelist chardet-3.0.4-filelist_python3
...
Provides:       python3-chardet = %{version}-%{release}
Provides:       python3-chardet = %{version}-%{release}
Obsoletes:      python3-chardet < %{version}-%{release}
Obsoletes:      python3-chardet < %{version}-%{release}
...
mv %{_builddir}/chardet-%{version} %{_builddir}/%{name}-%{version}
