%define filelist greenlet-0.4.12-filelist_python3
...
Provides:       python3-greenlet = %{version}-%{release}
Provides:       python3-greenlet = %{version}-%{release}
Obsoletes:      python3-greenlet < %{version}-%{release}
Obsoletes:      python3-greenlet < %{version}-%{release}
...
mv %{_builddir}/greenlet-%{version} %{_builddir}/%{name}-%{version}
