%define filelist docker-2.6.1-filelist_python3
...
Provides:       python3-docker = %{version}-%{release}
Provides:       python3-docker = %{version}-%{release}
Obsoletes:      python3-docker < %{version}-%{release}
Obsoletes:      python3-docker < %{version}-%{release}
...
mv %{_builddir}/docker-%{version} %{_builddir}/%{name}-%{version}
