%define filelist pep8-1.7.1-filelist_python3
...
Provides:       python3-pep8 = %{version}-%{release}
Provides:       python3-pep8 = %{version}-%{release}
Obsoletes:      python3-pep8 < %{version}-%{release}
Obsoletes:      python3-pep8 < %{version}-%{release}
...
mv %{_builddir}/pep8-%{version} %{_builddir}/%{name}-%{version}
