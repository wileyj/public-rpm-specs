%define filelist coverage-4.4.2-filelist_python3
...
Provides:       python3-coverage = %{version}-%{release}
Provides:       python3-coverage = %{version}-%{release}
Obsoletes:      python3-coverage < %{version}-%{release}
Obsoletes:      python3-coverage < %{version}-%{release}
...
mv %{_builddir}/coverage-%{version} %{_builddir}/%{name}-%{version}
