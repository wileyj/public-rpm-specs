%define filelist flaky-3.4.0-filelist_python3
...
Provides:       python3-flaky = %{version}-%{release}
Provides:       python3-flaky = %{version}-%{release}
Obsoletes:      python3-flaky < %{version}-%{release}
Obsoletes:      python3-flaky < %{version}-%{release}
...
mv %{_builddir}/flaky-%{version} %{_builddir}/%{name}-%{version}
