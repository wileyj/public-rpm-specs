%define filelist brotlipy-0.7.0-filelist_python3
...
Provides:       python3-brotlipy = %{version}-%{release}
Provides:       python3-brotlipy = %{version}-%{release}
Obsoletes:      python3-brotlipy < %{version}-%{release}
Obsoletes:      python3-brotlipy < %{version}-%{release}
...
mv %{_builddir}/brotlipy-%{version} %{_builddir}/%{name}-%{version}
