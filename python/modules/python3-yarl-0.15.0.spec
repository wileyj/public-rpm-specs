%define filelist yarl-0.15.0-filelist_python3
...
Provides:       python3-yarl = %{version}-%{release}
Provides:       python3-yarl = %{version}-%{release}
Obsoletes:      python3-yarl < %{version}-%{release}
Obsoletes:      python3-yarl < %{version}-%{release}
...
mv %{_builddir}/yarl-%{version} %{_builddir}/%{name}-%{version}
