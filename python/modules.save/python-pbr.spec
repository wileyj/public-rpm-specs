...
BuildRequires:  python-devel python2-rpm-macros python-srpm-macros  python-Babel
...
BuildRequires:  python3-devel python3-rpm-macros python-srpm-macros python3-Babel
...
popd
%endif
%__rm -f %{buildroot}%{_bindir}/%{pypi_alternate}
