...
%define pypi_alternate sphinx
%define pypi_alternate1 sphinx-apidoc
%define pypi_alternate2 sphinx-autogen
%define pypi_alternate3 sphinx-build
%define pypi_alternate4 sphinx-quickstart
...
Requires: python27-snowballstemmer
Requires: python27-babel
Requires: python27-alabaster
Requires: python27-imagesize
