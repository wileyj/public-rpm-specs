...
%define pypi_alternate1 aws
%define pypi_alternate2 aws.cmd
%define pypi_alternate3 aws_bash_completer
%define pypi_alternate4 aws_completer
%define pypi_alternate5 aws_zsh_completer.sh
...
Requires: python27-colorama
Requires: python27-docutils
Requires: python27-rsa
