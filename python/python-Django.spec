...
curl -o $RPM_SOURCE_DIR/%{name}.tar.gz `curl -s https://pypi.python.org/pypi/%{pkgname}/%{pip_version} | grep tar.gz | cut -d '"' -f2 | cut -f1 -d "#" | head -1`
