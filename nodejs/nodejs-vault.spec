...
%files -f %{filelist}
%{nodejs_libdir}/%{npmname}-%{version}/bin/vault
%{nodejs_libdir}/%{npmname}-%{version}/lib/node_modules/vault/node_modules/.bin/ssha-list
%{nodejs_libdir}/%{npmname}-%{version}/lib/node_modules/vault/node_modules/.bin/ssha-sign
