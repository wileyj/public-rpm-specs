...
echo '"%{nodejs_libdir}/%{npmname}-%{version}/lib/node_modules/%{npmname}/node_modules/.bin/mkdirp"' >> %{filelist}
echo '"%{nodejs_libdir}/%{npmname}-%{version}/lib/node_modules/%{npmname}/node_modules/.bin/rimraf"' >> %{filelist}
