...
prefix:    %(echo %{_prefix})
BuildRequires: perl, perl-srpm-macros,  perl-Locale-Maketext-Simple, perl-Module-Load-Conditional
Requires: perl, perl-Locale-Maketext-Simple, perl-Module-Load-Conditional
