...
Name: rubygem%{alinux_ruby}-sensu-plugins-monit
Version: 1.0.0
Release: 1.%{dist}
AutoReqProv : no
...
Provides: rubygem%{alinux_ruby}-sensu-plugins-monit = %{version}
Provides: rubygem%{alinux_ruby}(sensu-plugins-monit) = %{version}
Obsoletes: rubygem%{alinux_ruby}-sensu-plugins-monit < %{version}
Obsoletes: rubygem%{alinux_ruby}(sensu-plugins-monit) < %{version}


Requires: rubygem%{alinux_ruby}-mail  >= 2.6.3
