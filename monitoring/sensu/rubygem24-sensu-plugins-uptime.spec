...
Name: rubygem%{alinux_ruby}-sensu-plugins-uptime
Version: 0.0.1
Release: 1.%{dist}
AutoReqProv : no
...
Provides: rubygem%{alinux_ruby}-sensu-plugins-uptime = %{version}
Provides: rubygem%{alinux_ruby}(sensu-plugins-uptime) = %{version}
Obsoletes: rubygem%{alinux_ruby}-sensu-plugins-uptime < %{version}
Obsoletes: rubygem%{alinux_ruby}(sensu-plugins-uptime) < %{version}


Requires: rubygem%{alinux_ruby}-sensu-plugin  >= 1.2.0
