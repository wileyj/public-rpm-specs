...
%global gem_name sensu-plugins-kubernetes
Name: rubygem-sensu-plugins-kubernetes
Version: 3.0.0
Release: 1.%{dist}
Summary: rubygem sensu-plugins-kubernetes
Group: Development/Languages
License: MIT
URL: https://github.com/sensu-plugins/sensu-plugins-kubernetes
Vendor: %{vendor}
Packager: %{packager}
Requires: ruby rubygems
Provides: rubygem-sensu-plugins-kubernetes = %{version}
Provides: rubygem(sensu-plugins-kubernetes) = %{version}
Obsoletes: rubygem-sensu-plugins-kubernetes < %{version}
Obsoletes: rubygem(sensu-plugins-kubernetes) < %{version}


Requires: rubygem-activesupport  < 5.0.0
Requires: rubygem-kubeclient  >= 2.3
...
gem install --install-dir %{buildroot}/%{gem_dir} --bindir %{buildroot}/%{_bindir} --force --no-rdoc --no-ri --no-doc --ignore-dependencies sensu-plugins-kubernetes -v %{version}
