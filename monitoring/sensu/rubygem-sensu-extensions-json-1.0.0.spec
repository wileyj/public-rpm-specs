...
Name: rubygem-sensu-extensions-json
Version: 1.0.0
Release: 1.%{dist}
Summary: rubygem sensu-extensions-json
Group: Development/Languages
License: GPL
URL: https://github.com/sensu-extensions/sensu-extensions-json
Vendor: %{vendor}
Packager: %{packager}
Requires: ruby rubygems
Provides: rubygem-sensu-extensions-json = %{version}
Provides: rubygem(sensu-extensions-json) = %{version}
Obsoletes: rubygem-sensu-extensions-json < %{version}
Obsoletes: rubygem(sensu-extensions-json) < %{version}
...
gem install --install-dir %{buildroot}/%{gem_dir} --bindir %{buildroot}/%{_bindir} --force --no-rdoc --no-ri --no-doc --ignore-dependencies sensu-extensions-json -v %{version}
