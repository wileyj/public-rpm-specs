...
%global gem_name sensu-plugins-apache
Name: rubygem-sensu-plugins-apache
Version: 1.0.0
Release: 1.%{dist}
Summary: rubygem sensu-plugins-apache
Group: Development/Languages
License: MIT
URL: https://github.com/sensu-plugins/sensu-plugins-apache
Vendor: %{vendor}
Packager: %{packager}
Requires: ruby rubygems
Provides: rubygem-sensu-plugins-apache = %{version}
Provides: rubygem(sensu-plugins-apache) = %{version}
Obsoletes: rubygem-sensu-plugins-apache < %{version}
Obsoletes: rubygem(sensu-plugins-apache) < %{version}
...
%description
This plugin provides native Apache instrumentation
...
gem install --install-dir %{buildroot}/%{gem_dir} --bindir %{buildroot}/%{_bindir} --force --no-rdoc --no-ri --no-doc --ignore-dependencies sensu-plugins-apache -v %{version}
