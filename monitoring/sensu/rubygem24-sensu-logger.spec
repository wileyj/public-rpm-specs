...
Name: rubygem%{alinux_ruby}-sensu-logger
Version: 1.2.1
Release: 1.%{dist}
AutoReqProv : no
...
Provides: rubygem%{alinux_ruby}-sensu-logger = %{version}
Provides: rubygem%{alinux_ruby}(sensu-logger) = %{version}
Obsoletes: rubygem%{alinux_ruby}-sensu-logger < %{version}
Obsoletes: rubygem%{alinux_ruby}(sensu-logger) < %{version}


Requires: rubygem%{alinux_ruby}-eventmachine
Requires: rubygem%{alinux_ruby}-sensu-json
