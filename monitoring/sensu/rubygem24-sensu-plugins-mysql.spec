...
Name: rubygem%{alinux_ruby}-sensu-plugins-mysql
Version: 2.2.0
Release: 1.%{dist}
AutoReqProv : no
...
Provides: rubygem%{alinux_ruby}-sensu-plugins-mysql = %{version}
Provides: rubygem%{alinux_ruby}(sensu-plugins-mysql) = %{version}
Obsoletes: rubygem%{alinux_ruby}-sensu-plugins-mysql < %{version}
Obsoletes: rubygem%{alinux_ruby}(sensu-plugins-mysql) < %{version}


Requires: rubygem%{alinux_ruby}-inifile  >= 3.0.0
Requires: rubygem%{alinux_ruby}-ruby-mysql  >= 2.9
