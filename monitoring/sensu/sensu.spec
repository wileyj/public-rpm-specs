...
License:        GPLv2
#AutoReqProv:   no
Requires:       ruby rubygem-sensu ruby rubygem-sensu rubygem-sensu-logger rubygem-sensu-transport rubygem-sensu-spawn sensu rubygem-bigdecimal
...
License:        GPLv2
#AutoReqProv:   no
Requires:       sensu-server rubygem-sensu rubygem-sensu-extension
...
License:        GPLv2
#AutoReqProv:   no
Requires:       sensu-client rubygem-sensu rubygem-sensu-extension
...
%{__install} -p -m 0644 %{SOURCE10} %{buildroot}%{_unitdir}/%{name}-server.service
%{__install} -p -m 0644 %{SOURCE11} %{buildroot}%{_unitdir}/%{name}-runsvdir.service
%{__install} -p -m 0644 %{SOURCE12} %{buildroot}%{_unitdir}/%{name}-client.service
...
%attr(0644, %{user}, %{group}) %{_unitdir}/%{name}-server.service
%attr(0644, %{user}, %{group}) %{_unitdir}/%{name}-runsvdir.service
%attr(0644, %{user}, %{group})%{_sysconfdir}/logrotate.d/%{name}
...
%attr(0644, %{user}, %{group}) %{_unitdir}/%{name}-client.service
