...
Name: rubygem%{alinux_ruby}-sensu-plugins-cpu-checks
Version: 1.1.2
Release: 1.%{dist}
AutoReqProv : no
...
Provides: rubygem%{alinux_ruby}-sensu-plugins-cpu-checks = %{version}
Provides: rubygem%{alinux_ruby}(sensu-plugins-cpu-checks) = %{version}
Obsoletes: rubygem%{alinux_ruby}-sensu-plugins-cpu-checks < %{version}
Obsoletes: rubygem%{alinux_ruby}(sensu-plugins-cpu-checks) < %{version}


Requires: rubygem%{alinux_ruby}-linux-kstat  >= 0.1.3
