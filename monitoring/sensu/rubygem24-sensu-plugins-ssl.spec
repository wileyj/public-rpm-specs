...
Name: rubygem%{alinux_ruby}-sensu-plugins-ssl
Version: 1.5.0
Release: 1.%{dist}
AutoReqProv : no
...
Provides: rubygem%{alinux_ruby}-sensu-plugins-ssl = %{version}
Provides: rubygem%{alinux_ruby}(sensu-plugins-ssl) = %{version}
Obsoletes: rubygem%{alinux_ruby}-sensu-plugins-ssl < %{version}
Obsoletes: rubygem%{alinux_ruby}(sensu-plugins-ssl) < %{version}
