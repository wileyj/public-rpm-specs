...
Name: rubygem%{alinux_ruby}-sensu-plugins-graphite
Version: 3.0.0
Release: 1.%{dist}
AutoReqProv : no
...
Provides: rubygem%{alinux_ruby}-sensu-plugins-graphite = %{version}
Provides: rubygem%{alinux_ruby}(sensu-plugins-graphite) = %{version}
Obsoletes: rubygem%{alinux_ruby}-sensu-plugins-graphite < %{version}
Obsoletes: rubygem%{alinux_ruby}(sensu-plugins-graphite) < %{version}


Requires: rubygem%{alinux_ruby}-array_stats  >= 0.6.0
Requires: rubygem%{alinux_ruby}-ipaddress  >= 0.8.0
Requires: rubygem%{alinux_ruby}-rest-client  >= 1.8.0
Requires: rubygem%{alinux_ruby}-sensu-plugin  >= 2.0
Requires: rubygem%{alinux_ruby}-simple-graphite  >= 2.1.0
