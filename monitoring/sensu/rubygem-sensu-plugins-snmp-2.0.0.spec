...
%global gem_name sensu-plugins-snmp
Name: rubygem-sensu-plugins-snmp
Version: 2.0.0
Release: 1.%{dist}
Summary: rubygem sensu-plugins-snmp
Group: Development/Languages
License: MIT
URL: https://github.com/sensu-plugins/sensu-plugins-snmp
Vendor: %{vendor}
Packager: %{packager}
Requires: ruby rubygems
Provides: rubygem-sensu-plugins-snmp = %{version}
Provides: rubygem(sensu-plugins-snmp) = %{version}
Obsoletes: rubygem-sensu-plugins-snmp < %{version}
Obsoletes: rubygem(sensu-plugins-snmp) < %{version}


Requires: rubygem-sensu-plugin  >= 1.2
Requires: rubygem-snmp  = 1.2.0
...
gem install --install-dir %{buildroot}/%{gem_dir} --bindir %{buildroot}/%{_bindir} --force --no-rdoc --no-ri --no-doc --ignore-dependencies sensu-plugins-snmp -v %{version}
