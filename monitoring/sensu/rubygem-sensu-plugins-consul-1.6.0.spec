...
%global gem_name sensu-plugins-consul
Name: rubygem-sensu-plugins-consul
Version: 1.6.0
Release: 1.%{dist}
Summary: rubygem sensu-plugins-consul
...
Provides: rubygem-sensu-plugins-consul = %{version}
Provides: rubygem(sensu-plugins-consul) = %{version}
Obsoletes: rubygem-sensu-plugins-consul < %{version}
Obsoletes: rubygem(sensu-plugins-consul) < %{version}


Requires: rubygem-diplomat  = 0.14.0
...
gem install --install-dir %{buildroot}/%{gem_dir} --bindir %{buildroot}/%{_bindir} --force --no-rdoc --no-ri --no-doc --ignore-dependencies sensu-plugins-consul -v %{version}
