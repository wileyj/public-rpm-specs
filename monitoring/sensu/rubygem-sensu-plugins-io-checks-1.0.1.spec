...
%global gem_name sensu-plugins-io-checks
Name: rubygem-sensu-plugins-io-checks
Version: 1.0.1
Release: 1.%{dist}
Summary: rubygem sensu-plugins-io-checks
Group: Development/Languages
License: MIT
URL: https://github.com/sensu-plugins/sensu-plugins-io-checks
Vendor: %{vendor}
Packager: %{packager}
Requires: ruby rubygems
Provides: rubygem-sensu-plugins-io-checks = %{version}
Provides: rubygem(sensu-plugins-io-checks) = %{version}
Obsoletes: rubygem-sensu-plugins-io-checks < %{version}
Obsoletes: rubygem(sensu-plugins-io-checks) < %{version}
...
gem install --install-dir %{buildroot}/%{gem_dir} --bindir %{buildroot}/%{_bindir} --force --no-rdoc --no-ri --no-doc --ignore-dependencies sensu-plugins-io-checks -v %{version}
