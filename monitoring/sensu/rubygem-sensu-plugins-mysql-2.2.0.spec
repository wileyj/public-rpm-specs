...
%global gem_name sensu-plugins-mysql
Name: rubygem-sensu-plugins-mysql
Version: 2.2.0
Release: 1.%{dist}
Summary: rubygem sensu-plugins-mysql
Group: Development/Languages
License: MIT
URL: https://github.com/sensu-plugins/sensu-plugins-mysql
Vendor: %{vendor}
Packager: %{packager}
Requires: ruby rubygems
Provides: rubygem-sensu-plugins-mysql = %{version}
Provides: rubygem(sensu-plugins-mysql) = %{version}
Obsoletes: rubygem-sensu-plugins-mysql < %{version}
Obsoletes: rubygem(sensu-plugins-mysql) < %{version}


Requires: rubygem-inifile  = 3.0.0
Requires: rubygem-ruby-mysql  >= 2.9
...
gem install --install-dir %{buildroot}/%{gem_dir} --bindir %{buildroot}/%{_bindir} --force --no-rdoc --no-ri --no-doc --ignore-dependencies sensu-plugins-mysql -v %{version}
