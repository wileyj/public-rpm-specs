...
%global gem_name sensu-plugins-jenkins
Name: rubygem-sensu-plugins-jenkins
Version: 1.4.0
Release: 1.%{dist}
Summary: rubygem sensu-plugins-jenkins
Group: Development/Languages
License: MIT
URL: https://github.com/sensu-plugins/sensu-plugins-jenkins
Vendor: %{vendor}
Packager: %{packager}
Requires: ruby rubygems
Provides: rubygem-sensu-plugins-jenkins = %{version}
Provides: rubygem(sensu-plugins-jenkins) = %{version}
Obsoletes: rubygem-sensu-plugins-jenkins < %{version}
Obsoletes: rubygem(sensu-plugins-jenkins) < %{version}


Requires: rubygem-chronic_duration  = 0.10.6
Requires: rubygem-jenkins_api_client  = 1.4.2
Requires: rubygem-rb-readline  <= 1.0,
Requires: rubygem-rest-client  >= 2.0.2
...
gem install --install-dir %{buildroot}/%{gem_dir} --bindir %{buildroot}/%{_bindir} --force --no-rdoc --no-ri --no-doc --ignore-dependencies sensu-plugins-jenkins -v %{version}
