...
%global gem_name sensu-plugins-monit
Name: rubygem-sensu-plugins-monit
Version: 1.0.0
Release: 1.%{dist}
Summary: rubygem sensu-plugins-monit
...
Provides: rubygem-sensu-plugins-monit = %{version}
Provides: rubygem(sensu-plugins-monit) = %{version}
Obsoletes: rubygem-sensu-plugins-monit < %{version}
Obsoletes: rubygem(sensu-plugins-monit) < %{version}
...
gem install --install-dir %{buildroot}/%{gem_dir} --bindir %{buildroot}/%{_bindir} --force --no-rdoc --no-ri --no-doc --ignore-dependencies sensu-plugins-monit -v %{version}
