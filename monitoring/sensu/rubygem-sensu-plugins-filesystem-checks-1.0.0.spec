...
%global gem_name sensu-plugins-filesystem-checks
Name: rubygem-sensu-plugins-filesystem-checks
Version: 1.0.0
Release: 1.%{dist}
Summary: rubygem sensu-plugins-filesystem-checks
Group: Development/Languages
License: MIT
URL: https://github.com/sensu-plugins/sensu-plugins-filesystem-checks
Vendor: %{vendor}
Packager: %{packager}
Requires: ruby rubygems
Provides: rubygem-sensu-plugins-filesystem-checks = %{version}
Provides: rubygem(sensu-plugins-filesystem-checks) = %{version}
Obsoletes: rubygem-sensu-plugins-filesystem-checks < %{version}
Obsoletes: rubygem(sensu-plugins-filesystem-checks) < %{version}
...
gem install --install-dir %{buildroot}/%{gem_dir} --bindir %{buildroot}/%{_bindir} --force --no-rdoc --no-ri --no-doc --ignore-dependencies sensu-plugins-filesystem-checks -v %{version}
