...
Name: rubygem%{alinux_ruby}-sensu-plugins-ntp
Version: 1.0.1
Release: 1.%{dist}
AutoReqProv : no
...
Provides: rubygem%{alinux_ruby}-sensu-plugins-ntp = %{version}
Provides: rubygem%{alinux_ruby}(sensu-plugins-ntp) = %{version}
Obsoletes: rubygem%{alinux_ruby}-sensu-plugins-ntp < %{version}
Obsoletes: rubygem%{alinux_ruby}(sensu-plugins-ntp) < %{version}
