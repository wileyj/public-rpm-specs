...
Name: rubygem%{alinux_ruby}-sensu-plugins-logs
Version: 1.3.1
Release: 1.%{dist}
AutoReqProv : no
...
Provides: rubygem%{alinux_ruby}-sensu-plugins-logs = %{version}
Provides: rubygem%{alinux_ruby}(sensu-plugins-logs) = %{version}
Obsoletes: rubygem%{alinux_ruby}-sensu-plugins-logs < %{version}
Obsoletes: rubygem%{alinux_ruby}(sensu-plugins-logs) < %{version}
