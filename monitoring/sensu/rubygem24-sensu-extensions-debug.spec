...
Name: rubygem%{alinux_ruby}-sensu-extensions-debug
Version: 1.0.0
Release: 1.%{dist}
AutoReqProv : no
...
Provides: rubygem%{alinux_ruby}-sensu-extensions-debug = %{version}
Provides: rubygem%{alinux_ruby}(sensu-extensions-debug) = %{version}
Obsoletes: rubygem%{alinux_ruby}-sensu-extensions-debug < %{version}
Obsoletes: rubygem%{alinux_ruby}(sensu-extensions-debug) < %{version}
