...
%global gem_name sensu-plugins-ntp
Name: rubygem-sensu-plugins-ntp
Version: 1.0.1
Release: 1.%{dist}
Summary: rubygem sensu-plugins-ntp
Group: Development/Languages
License: MIT
URL: https://github.com/sensu-plugins/sensu-plugins-ntp
Vendor: %{vendor}
Packager: %{packager}
Requires: ruby rubygems
Provides: rubygem-sensu-plugins-ntp = %{version}
Provides: rubygem(sensu-plugins-ntp) = %{version}
Obsoletes: rubygem-sensu-plugins-ntp < %{version}
Obsoletes: rubygem(sensu-plugins-ntp) < %{version}
...
gem install --install-dir %{buildroot}/%{gem_dir} --bindir %{buildroot}/%{_bindir} --force --no-rdoc --no-ri --no-doc --ignore-dependencies sensu-plugins-ntp -v %{version}
