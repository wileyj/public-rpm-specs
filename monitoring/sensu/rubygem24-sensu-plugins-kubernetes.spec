...
Name: rubygem%{alinux_ruby}-sensu-plugins-kubernetes
Version: 3.0.0
Release: 1.%{dist}
AutoReqProv : no
...
Provides: rubygem%{alinux_ruby}-sensu-plugins-kubernetes = %{version}
Provides: rubygem%{alinux_ruby}(sensu-plugins-kubernetes) = %{version}
Obsoletes: rubygem%{alinux_ruby}-sensu-plugins-kubernetes < %{version}
Obsoletes: rubygem%{alinux_ruby}(sensu-plugins-kubernetes) < %{version}


Requires: rubygem%{alinux_ruby}-activesupport  < 5.0.0
Requires: rubygem%{alinux_ruby}-kubeclient  >= 2.3
