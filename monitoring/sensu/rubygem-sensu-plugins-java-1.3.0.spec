...
%global gem_name sensu-plugins-java
Name: rubygem-sensu-plugins-java
Version: 1.3.0
Release: 1.%{dist}
Summary: rubygem sensu-plugins-java
Group: Development/Languages
License: MIT
URL: https://github.com/sensu-plugins/sensu-plugins-java
Vendor: %{vendor}
Packager: %{packager}
Requires: ruby rubygems
Provides: rubygem-sensu-plugins-java = %{version}
Provides: rubygem(sensu-plugins-java) = %{version}
Obsoletes: rubygem-sensu-plugins-java < %{version}
Obsoletes: rubygem(sensu-plugins-java) < %{version}


Requires: rubygem-english  = 0.6.3
...
gem install --install-dir %{buildroot}/%{gem_dir} --bindir %{buildroot}/%{_bindir} --force --no-rdoc --no-ri --no-doc --ignore-dependencies sensu-plugins-java -v %{version}
