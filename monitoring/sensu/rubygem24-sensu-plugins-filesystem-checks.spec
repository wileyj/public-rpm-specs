...
Name: rubygem%{alinux_ruby}-sensu-plugins-filesystem-checks
Version: 1.0.0
Release: 1.%{dist}
AutoReqProv : no
...
Provides: rubygem%{alinux_ruby}-sensu-plugins-filesystem-checks = %{version}
Provides: rubygem%{alinux_ruby}(sensu-plugins-filesystem-checks) = %{version}
Obsoletes: rubygem%{alinux_ruby}-sensu-plugins-filesystem-checks < %{version}
Obsoletes: rubygem%{alinux_ruby}(sensu-plugins-filesystem-checks) < %{version}
