...
Name: rubygem%{alinux_ruby}-sensu-plugins-erlang
Version: 1.0.0
Release: 1.%{dist}
AutoReqProv : no
...
Provides: rubygem%{alinux_ruby}-sensu-plugins-erlang = %{version}
Provides: rubygem%{alinux_ruby}(sensu-plugins-erlang) = %{version}
Obsoletes: rubygem%{alinux_ruby}-sensu-plugins-erlang < %{version}
Obsoletes: rubygem%{alinux_ruby}(sensu-plugins-erlang) < %{version}
