...
Name: rubygem%{alinux_ruby}-sensu-extensions-json
Version: 1.0.0
Release: 1.%{dist}
AutoReqProv : no
...
Provides: rubygem%{alinux_ruby}-sensu-extensions-json = %{version}
Provides: rubygem%{alinux_ruby}(sensu-extensions-json) = %{version}
Obsoletes: rubygem%{alinux_ruby}-sensu-extensions-json < %{version}
Obsoletes: rubygem%{alinux_ruby}(sensu-extensions-json) < %{version}
