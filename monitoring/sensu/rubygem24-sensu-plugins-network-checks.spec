...
Name: rubygem%{alinux_ruby}-sensu-plugins-network-checks
Version: 2.1.0
Release: 1.%{dist}
AutoReqProv : no
...
Provides: rubygem%{alinux_ruby}-sensu-plugins-network-checks = %{version}
Provides: rubygem%{alinux_ruby}(sensu-plugins-network-checks) = %{version}
Obsoletes: rubygem%{alinux_ruby}-sensu-plugins-network-checks < %{version}
Obsoletes: rubygem%{alinux_ruby}(sensu-plugins-network-checks) < %{version}


Requires: rubygem%{alinux_ruby}-activesupport  >= 4.2
Requires: rubygem%{alinux_ruby}-dnsbl-client  >= 1.0.2
Requires: rubygem%{alinux_ruby}-net-ping  >= 1.7.8
Requires: rubygem%{alinux_ruby}-sensu-plugin  >= 1.2
Requires: rubygem%{alinux_ruby}-whois  >= 4.0
Requires: rubygem%{alinux_ruby}-whois-parser  >= 1.0.0
