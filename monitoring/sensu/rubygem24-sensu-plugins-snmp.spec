...
Name: rubygem%{alinux_ruby}-sensu-plugins-snmp
Version: 2.0.0
Release: 1.%{dist}
AutoReqProv : no
...
Provides: rubygem%{alinux_ruby}-sensu-plugins-snmp = %{version}
Provides: rubygem%{alinux_ruby}(sensu-plugins-snmp) = %{version}
Obsoletes: rubygem%{alinux_ruby}-sensu-plugins-snmp < %{version}
Obsoletes: rubygem%{alinux_ruby}(sensu-plugins-snmp) < %{version}


Requires: rubygem%{alinux_ruby}-sensu-plugin  >= 1.2
Requires: rubygem%{alinux_ruby}-snmp  >= 1.2.0
