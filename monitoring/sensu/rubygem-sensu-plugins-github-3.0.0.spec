...
%global gem_name sensu-plugins-github
Name: rubygem-sensu-plugins-github
Version: 3.0.0
Release: 1.%{dist}
Summary: rubygem sensu-plugins-github
Group: Development/Languages
License: MIT
URL: https://github.com/sensu-plugins/sensu-plugins-github
Vendor: %{vendor}
Packager: %{packager}
Requires: ruby rubygems
Provides: rubygem-sensu-plugins-github = %{version}
Provides: rubygem(sensu-plugins-github) = %{version}
Obsoletes: rubygem-sensu-plugins-github < %{version}
Obsoletes: rubygem(sensu-plugins-github) < %{version}
...
%description
This plugin provides native GitHub instrumentation
...
gem install --install-dir %{buildroot}/%{gem_dir} --bindir %{buildroot}/%{_bindir} --force --no-rdoc --no-ri --no-doc --ignore-dependencies sensu-plugins-github -v %{version}
