...
%global gem_name sensu-plugins-http
Name: rubygem%{alinux_ruby}-sensu-plugins-http
Version: 2.6.0
Release: 1.%{dist}
AutoReqProv : no
Summary: rubygem sensu-plugins-http
Group: Development/Languages
License: MIT
URL: https://github.com/sensu-plugins/sensu-plugins-http
Vendor: %{vendor}
Packager: %{packager}
Requires: ruby%{alinux_ruby} rubygems%{alinux_ruby}
Provides: rubygem%{alinux_ruby}-sensu-plugins-http = %{version}
Requires: rubygem%{alinux_ruby}-sensu
Provides: rubygem%{alinux_ruby}(sensu-plugins-http) = %{version}
Obsoletes: rubygem%{alinux_ruby}-sensu-plugins-http < %{version}
Obsoletes: rubygem%{alinux_ruby}(sensu-plugins-http) < %{version}


Requires: rubygem%{alinux_ruby}-aws-sdk  >= 2.3
