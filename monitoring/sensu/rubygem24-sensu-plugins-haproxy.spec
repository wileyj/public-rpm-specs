...
Name: rubygem%{alinux_ruby}-sensu-plugins-haproxy
Version: 1.4.0
Release: 1.%{dist}
AutoReqProv : no
...
Provides: rubygem%{alinux_ruby}-sensu-plugins-haproxy = %{version}
Provides: rubygem%{alinux_ruby}(sensu-plugins-haproxy) = %{version}
Obsoletes: rubygem%{alinux_ruby}-sensu-plugins-haproxy < %{version}
Obsoletes: rubygem%{alinux_ruby}(sensu-plugins-haproxy) < %{version}
