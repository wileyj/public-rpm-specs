...
Name: rubygem-sensu-extensions-ruby-hash
Version: 1.0.0
Release: 1.%{dist}
Summary: rubygem sensu-extensions-ruby-hash
Group: Development/Languages
License: GPL
URL: https://github.com/sensu-extensions/sensu-extensions-ruby-hash
Vendor: %{vendor}
Packager: %{packager}
Requires: ruby rubygems
Provides: rubygem-sensu-extensions-ruby-hash = %{version}
Provides: rubygem(sensu-extensions-ruby-hash) = %{version}
Obsoletes: rubygem-sensu-extensions-ruby-hash < %{version}
Obsoletes: rubygem(sensu-extensions-ruby-hash) < %{version}
...
gem install --install-dir %{buildroot}/%{gem_dir} --bindir %{buildroot}/%{_bindir} --force --no-rdoc --no-ri --no-doc --ignore-dependencies sensu-extensions-ruby-hash -v %{version}
