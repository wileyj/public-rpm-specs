...
Name: rubygem%{alinux_ruby}-sensu-plugins-disk-checks
...
Provides: rubygem%{alinux_ruby}-sensu-plugins-disk-checks = %{version}
Provides: rubygem%{alinux_ruby}(sensu-plugins-disk-checks) = %{version}
Obsoletes: rubygem%{alinux_ruby}-sensu-plugins-disk-checks < %{version}
Obsoletes: rubygem%{alinux_ruby}(sensu-plugins-disk-checks) < %{version}


Requires: rubygem%{alinux_ruby}-sensu-plugin  >= 1.2
Requires: rubygem%{alinux_ruby}-sys-filesystem  >= 1.1.7
