...
Name: rubygem%{alinux_ruby}-sensu-plugins-mongodb
Version: 2.0.1
Release: 1.%{dist}
AutoReqProv : no
...
Provides: rubygem%{alinux_ruby}-sensu-plugins-mongodb = %{version}
Provides: rubygem%{alinux_ruby}(sensu-plugins-mongodb) = %{version}
Obsoletes: rubygem%{alinux_ruby}-sensu-plugins-mongodb < %{version}
Obsoletes: rubygem%{alinux_ruby}(sensu-plugins-mongodb) < %{version}


Requires: rubygem%{alinux_ruby}-bson  >= 4.0
Requires: rubygem%{alinux_ruby}-mongo  >= 2.4.1
