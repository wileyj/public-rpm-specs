...
Name: rubygem%{alinux_ruby}-sensu-plugins-consul
Version: 1.6.0
Release: 1.%{dist}
AutoReqProv : no
...
Provides: rubygem%{alinux_ruby}-sensu-plugins-consul = %{version}
Provides: rubygem%{alinux_ruby}(sensu-plugins-consul) = %{version}
Obsoletes: rubygem%{alinux_ruby}-sensu-plugins-consul < %{version}
Obsoletes: rubygem%{alinux_ruby}(sensu-plugins-consul) < %{version}


Requires: rubygem%{alinux_ruby}-diplomat  >= 0.14.0
