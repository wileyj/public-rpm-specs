...
Name: rubygem%{alinux_ruby}-sensu-plugins-nginx
Version: 2.2.0
Release: 1.%{dist}
AutoReqProv : no
...
Provides: rubygem%{alinux_ruby}-sensu-plugins-nginx = %{version}
Provides: rubygem%{alinux_ruby}(sensu-plugins-nginx) = %{version}
Obsoletes: rubygem%{alinux_ruby}-sensu-plugins-nginx < %{version}
Obsoletes: rubygem%{alinux_ruby}(sensu-plugins-nginx) < %{version}
