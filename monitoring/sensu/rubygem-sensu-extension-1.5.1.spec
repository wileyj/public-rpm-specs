...
Name: rubygem-sensu-extension
Version: 1.5.1
Release: 1.%{dist}
Summary: rubygem sensu-extension
...
Provides: rubygem-sensu-extension = %{version}
Provides: rubygem(sensu-extension) = %{version}
Obsoletes: rubygem-sensu-extension < %{version}
Obsoletes: rubygem(sensu-extension) < %{version}
...
gem install --install-dir %{buildroot}/%{gem_dir} --bindir %{buildroot}/%{_bindir} --force --no-rdoc --no-ri --no-doc --ignore-dependencies sensu-extension -v %{version}
