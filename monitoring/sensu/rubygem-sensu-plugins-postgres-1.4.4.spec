...
%global gem_name sensu-plugins-postgres
Name: rubygem-sensu-plugins-postgres
Version: 1.4.4
Release: 1.%{dist}
Summary: rubygem sensu-plugins-postgres
Group: Development/Languages
License: MIT
URL: https://github.com/sensu-plugins/sensu-plugins-postgres
Vendor: %{vendor}
Packager: %{packager}
Requires: ruby rubygems
Provides: rubygem-sensu-plugins-postgres = %{version}
Provides: rubygem(sensu-plugins-postgres) = %{version}
Obsoletes: rubygem-sensu-plugins-postgres < %{version}
Obsoletes: rubygem(sensu-plugins-postgres) < %{version}


Requires: rubygem-dentaku  = 2.0.4
Requires: rubygem-pg  = 0.18.3
...
gem install --install-dir %{buildroot}/%{gem_dir} --bindir %{buildroot}/%{_bindir} --force --no-rdoc --no-ri --no-doc --ignore-dependencies sensu-plugins-postgres -v %{version}
