...
Name: rubygem%{alinux_ruby}-sensu-extensions-check-dependencies
Version: 1.0.1
Release: 1.%{dist}
AutoReqProv : no
...
Provides: rubygem%{alinux_ruby}-sensu-extensions-check-dependencies = %{version}
Provides: rubygem%{alinux_ruby}(sensu-extensions-check-dependencies) = %{version}
Obsoletes: rubygem%{alinux_ruby}-sensu-extensions-check-dependencies < %{version}
Obsoletes: rubygem%{alinux_ruby}(sensu-extensions-check-dependencies) < %{version}
