...
Name: rubygem%{alinux_ruby}-sensu-plugins-uchiwa
Version: 1.0.0
Release: 1.%{dist}
AutoReqProv : no
...
Provides: rubygem%{alinux_ruby}-sensu-plugins-uchiwa = %{version}
Provides: rubygem%{alinux_ruby}(sensu-plugins-uchiwa) = %{version}
Obsoletes: rubygem%{alinux_ruby}-sensu-plugins-uchiwa < %{version}
Obsoletes: rubygem%{alinux_ruby}(sensu-plugins-uchiwa) < %{version}
