...
%global gem_name sensu-plugins-redis
Name: rubygem-sensu-plugins-redis
Version: 2.3.0
Release: 1.%{dist}
Summary: rubygem sensu-plugins-redis
Group: Development/Languages
License: MIT
URL: https://github.com/sensu-plugins/sensu-plugins-redis
Vendor: %{vendor}
Packager: %{packager}
Requires: ruby rubygems
Provides: rubygem-sensu-plugins-redis = %{version}
Provides: rubygem(sensu-plugins-redis) = %{version}
Obsoletes: rubygem-sensu-plugins-redis < %{version}
Obsoletes: rubygem(sensu-plugins-redis) < %{version}


Requires: rubygem-redis  >= 3.3
...
gem install --install-dir %{buildroot}/%{gem_dir} --bindir %{buildroot}/%{_bindir} --force --no-rdoc --no-ri --no-doc --ignore-dependencies sensu-plugins-redis -v %{version}
