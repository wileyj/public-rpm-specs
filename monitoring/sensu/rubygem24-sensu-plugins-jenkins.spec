...
Name: rubygem%{alinux_ruby}-sensu-plugins-jenkins
Version: 1.4.0
Release: 1.%{dist}
AutoReqProv : no
...
Provides: rubygem%{alinux_ruby}-sensu-plugins-jenkins = %{version}
Provides: rubygem%{alinux_ruby}(sensu-plugins-jenkins) = %{version}
Obsoletes: rubygem%{alinux_ruby}-sensu-plugins-jenkins < %{version}
Obsoletes: rubygem%{alinux_ruby}(sensu-plugins-jenkins) < %{version}


Requires: rubygem%{alinux_ruby}-chronic_duration  >= 0.10.6
Requires: rubygem%{alinux_ruby}-jenkins_api_client  >= 1.4.2
Requires: rubygem%{alinux_ruby}-rb-readline  <= 1.0,
Requires: rubygem%{alinux_ruby}-rest-client  >= 2.0.2
