...
Name: rubygem%{alinux_ruby}-sensu-plugins-slack
Version: 2.0.0
Release: 1.%{dist}
AutoReqProv : no
...
Provides: rubygem%{alinux_ruby}-sensu-plugins-slack = %{version}
Provides: rubygem%{alinux_ruby}(sensu-plugins-slack) = %{version}
Obsoletes: rubygem%{alinux_ruby}-sensu-plugins-slack < %{version}
Obsoletes: rubygem%{alinux_ruby}(sensu-plugins-slack) < %{version}
