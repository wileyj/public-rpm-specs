...
Name: rubygem%{alinux_ruby}-sensu-plugins-github
Version: 3.0.0
Release: 1.%{dist}
AutoReqProv : no
...
Provides: rubygem%{alinux_ruby}-sensu-plugins-github = %{version}
Provides: rubygem%{alinux_ruby}(sensu-plugins-github) = %{version}
Obsoletes: rubygem%{alinux_ruby}-sensu-plugins-github < %{version}
Obsoletes: rubygem%{alinux_ruby}(sensu-plugins-github) < %{version}
