...
%global gem_name sensu-plugins-dns
Name: rubygem-sensu-plugins-dns
Version: 1.3.0
Release: 1.%{dist}
Summary: rubygem sensu-plugins-dns
Group: Development/Languages
License: MIT
URL: https://github.com/sensu-plugins/sensu-plugins-dns
Vendor: %{vendor}
Packager: %{packager}
Requires: ruby rubygems
Provides: rubygem-sensu-plugins-dns = %{version}
Provides: rubygem(sensu-plugins-dns) = %{version}
Obsoletes: rubygem-sensu-plugins-dns < %{version}
Obsoletes: rubygem(sensu-plugins-dns) < %{version}


Requires: rubygem-dnsruby  >= 1.59.2,
...
gem install --install-dir %{buildroot}/%{gem_dir} --bindir %{buildroot}/%{_bindir} --force --no-rdoc --no-ri --no-doc --ignore-dependencies sensu-plugins-dns -v %{version}
