...
Name: rubygem%{alinux_ruby}-sensu-extensions-only-check-output
Version: 1.0.0
Release: 1.%{dist}
AutoReqProv : no
...
Provides: rubygem%{alinux_ruby}-sensu-extensions-only-check-output = %{version}
Provides: rubygem%{alinux_ruby}(sensu-extensions-only-check-output) = %{version}
Obsoletes: rubygem%{alinux_ruby}-sensu-extensions-only-check-output < %{version}
Obsoletes: rubygem%{alinux_ruby}(sensu-extensions-only-check-output) < %{version}
