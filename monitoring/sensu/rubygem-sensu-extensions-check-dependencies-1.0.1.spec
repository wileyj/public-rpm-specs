...
Name: rubygem-sensu-extensions-check-dependencies
Version: 1.0.1
Release: 1.%{dist}
Summary: rubygem sensu-extensions-check-dependencies
...
Provides: rubygem-sensu-extensions-check-dependencies = %{version}
Provides: rubygem(sensu-extensions-check-dependencies) = %{version}
Obsoletes: rubygem-sensu-extensions-check-dependencies < %{version}
Obsoletes: rubygem(sensu-extensions-check-dependencies) < %{version}
...
gem install --install-dir %{buildroot}/%{gem_dir} --bindir %{buildroot}/%{_bindir} --force --no-rdoc --no-ri --no-doc --ignore-dependencies sensu-extensions-check-dependencies -v %{version}
