...
Name: rubygem-sensu-extensions-occurrences
Version: 1.2.0
Release: 1.%{dist}
Summary: rubygem sensu-extensions-occurrences
Group: Development/Languages
License: GPL
URL: https://github.com/sensu-extensions/sensu-extensions-occurrences
Vendor: %{vendor}
Packager: %{packager}
Requires: ruby rubygems
Provides: rubygem-sensu-extensions-occurrences = %{version}
Provides: rubygem(sensu-extensions-occurrences) = %{version}
Obsoletes: rubygem-sensu-extensions-occurrences < %{version}
Obsoletes: rubygem(sensu-extensions-occurrences) < %{version}
...
gem install --install-dir %{buildroot}/%{gem_dir} --bindir %{buildroot}/%{_bindir} --force --no-rdoc --no-ri --no-doc --ignore-dependencies sensu-extensions-occurrences -v %{version}
