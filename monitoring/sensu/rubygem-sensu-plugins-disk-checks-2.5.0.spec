...
Name: rubygem-sensu-plugins-disk-checks
Version: 2.5.0
Release: 1.%{dist}
Summary: rubygem sensu-plugins-disk-checks
Group: Development/Languages
License: MIT
URL: https://github.com/sensu-plugins/sensu-plugins-disk-checks
Vendor: %{vendor}
Packager: %{packager}
Requires: ruby rubygems
Provides: rubygem-sensu-plugins-disk-checks = %{version}
Provides: rubygem(sensu-plugins-disk-checks) = %{version}
Obsoletes: rubygem-sensu-plugins-disk-checks < %{version}
Obsoletes: rubygem(sensu-plugins-disk-checks) < %{version}


Requires: rubygem-sensu-plugin  >= 1.2
Requires: rubygem-sys-filesystem  = 1.1.7
...
gem install --install-dir %{buildroot}/%{gem_dir} --bindir %{buildroot}/%{_bindir} --force --no-rdoc --no-ri --no-doc --ignore-dependencies sensu-plugins-disk-checks -v %{version}
