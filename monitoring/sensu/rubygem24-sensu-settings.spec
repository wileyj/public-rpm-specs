...
Name: rubygem%{alinux_ruby}-sensu-settings
Version: 10.12.0
Release: 1.%{dist}
AutoReqProv : no
...
Provides: rubygem%{alinux_ruby}-sensu-settings = %{version}
Provides: rubygem%{alinux_ruby}(sensu-settings) = %{version}
Obsoletes: rubygem%{alinux_ruby}-sensu-settings < %{version}
Obsoletes: rubygem%{alinux_ruby}(sensu-settings) < %{version}


Requires: rubygem%{alinux_ruby}-parse-cron
