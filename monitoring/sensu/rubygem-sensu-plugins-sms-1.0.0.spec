...
%global gem_name sensu-plugins-sms
Name: rubygem-sensu-plugins-sms
Version: 1.0.0
Release: 1.%{dist}
Summary: rubygem sensu-plugins-sms
...
Provides: rubygem-sensu-plugins-sms = %{version}
Provides: rubygem(sensu-plugins-sms) = %{version}
Obsoletes: rubygem-sensu-plugins-sms < %{version}
Obsoletes: rubygem(sensu-plugins-sms) < %{version}


Requires: rubygem-mail  = 2.6.3
Requires: rubygem-playsms  = 0.0.1
...
gem install --install-dir %{buildroot}/%{gem_dir} --bindir %{buildroot}/%{_bindir} --force --no-rdoc --no-ri --no-doc --ignore-dependencies sensu-plugins-sms -v %{version}
