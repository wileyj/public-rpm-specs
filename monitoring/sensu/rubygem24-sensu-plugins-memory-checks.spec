...
Name: rubygem%{alinux_ruby}-sensu-plugins-memory-checks
Version: 3.1.1
Release: 1.%{dist}
AutoReqProv : no
...
Provides: rubygem%{alinux_ruby}-sensu-plugins-memory-checks = %{version}
Provides: rubygem%{alinux_ruby}(sensu-plugins-memory-checks) = %{version}
Obsoletes: rubygem%{alinux_ruby}-sensu-plugins-memory-checks < %{version}
Obsoletes: rubygem%{alinux_ruby}(sensu-plugins-memory-checks) < %{version}
