...
%global gem_name sensu-plugins-varnish
Name: rubygem-sensu-plugins-varnish
Version: 1.1.2
Release: 1.%{dist}
Summary: rubygem sensu-plugins-varnish
Group: Development/Languages
License: MIT
URL: https://github.com/sensu-plugins/sensu-plugins-varnish
Vendor: %{vendor}
Packager: %{packager}
Requires: ruby rubygems
Provides: rubygem-sensu-plugins-varnish = %{version}
Provides: rubygem(sensu-plugins-varnish) = %{version}
Obsoletes: rubygem-sensu-plugins-varnish < %{version}
Obsoletes: rubygem(sensu-plugins-varnish) < %{version}
...
gem install --install-dir %{buildroot}/%{gem_dir} --bindir %{buildroot}/%{_bindir} --force --no-rdoc --no-ri --no-doc --ignore-dependencies sensu-plugins-varnish -v %{version}
