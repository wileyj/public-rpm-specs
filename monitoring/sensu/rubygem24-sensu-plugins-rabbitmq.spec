...
Name: rubygem%{alinux_ruby}-sensu-plugins-rabbitmq
Version: 3.6.0
Release: 1.%{dist}
AutoReqProv : no
...
Provides: rubygem%{alinux_ruby}-sensu-plugins-rabbitmq = %{version}
Provides: rubygem%{alinux_ruby}(sensu-plugins-rabbitmq) = %{version}
Obsoletes: rubygem%{alinux_ruby}-sensu-plugins-rabbitmq < %{version}
Obsoletes: rubygem%{alinux_ruby}(sensu-plugins-rabbitmq) < %{version}


Requires: rubygem%{alinux_ruby}-amq-protocol  >= 2.0.1
Requires: rubygem%{alinux_ruby}-bunny  >= 2.5.0
Requires: rubygem%{alinux_ruby}-carrot-top  >= 0.0.7
Requires: rubygem%{alinux_ruby}-inifile  >= 3.0.0
Requires: rubygem%{alinux_ruby}-rest-client  >= 1.8.0
Requires: rubygem%{alinux_ruby}-ruby_dig  >= 0.0.2
Requires: rubygem%{alinux_ruby}-sensu-plugin  >= 1.2
Requires: rubygem%{alinux_ruby}-stomp  >= 1.4.3
