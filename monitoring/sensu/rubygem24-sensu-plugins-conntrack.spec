...
Name: rubygem%{alinux_ruby}-sensu-plugins-conntrack
Version: 1.0.0
Release: 1.%{dist}
AutoReqProv : no
...
Provides: rubygem%{alinux_ruby}-sensu-plugins-conntrack = %{version}
Provides: rubygem%{alinux_ruby}(sensu-plugins-conntrack) = %{version}
Obsoletes: rubygem%{alinux_ruby}-sensu-plugins-conntrack < %{version}
Obsoletes: rubygem%{alinux_ruby}(sensu-plugins-conntrack) < %{version}
