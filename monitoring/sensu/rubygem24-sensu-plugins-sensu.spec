...
Name: rubygem%{alinux_ruby}-sensu-plugins-sensu
Version: 2.4.0
Release: 1.%{dist}
AutoReqProv : no
...
Provides: rubygem%{alinux_ruby}-sensu-plugins-sensu = %{version}
Provides: rubygem%{alinux_ruby}(sensu-plugins-sensu) = %{version}
Obsoletes: rubygem%{alinux_ruby}-sensu-plugins-sensu < %{version}
Obsoletes: rubygem%{alinux_ruby}(sensu-plugins-sensu) < %{version}
