...
Name: rubygem%{alinux_ruby}-sensu-plugin
Version: 2.3.0
Release: 1.%{dist}
AutoReqProv : no
...
Provides: rubygem%{alinux_ruby}-sensu-plugin = %{version}
Provides: rubygem%{alinux_ruby}(sensu-plugin) = %{version}
Obsoletes: rubygem%{alinux_ruby}-sensu-plugin < %{version}
Obsoletes: rubygem%{alinux_ruby}(sensu-plugin) < %{version}


Requires: rubygem%{alinux_ruby}-json  < 3.0.0
Requires: rubygem%{alinux_ruby}-mixlib-cli  >= 1.5.0
