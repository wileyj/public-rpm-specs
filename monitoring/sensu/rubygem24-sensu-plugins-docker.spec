...
Name: rubygem%{alinux_ruby}-sensu-plugins-docker
Version: 2.0.0
Release: 1.%{dist}
AutoReqProv : no
...
Provides: rubygem%{alinux_ruby}-sensu-plugins-docker = %{version}
Provides: rubygem%{alinux_ruby}(sensu-plugins-docker) = %{version}
Obsoletes: rubygem%{alinux_ruby}-sensu-plugins-docker < %{version}
Obsoletes: rubygem%{alinux_ruby}(sensu-plugins-docker) < %{version}


Requires: rubygem%{alinux_ruby}-docker-api  >= 1.21.0
Requires: rubygem%{alinux_ruby}-net_http_unix  >= 0.2.2
