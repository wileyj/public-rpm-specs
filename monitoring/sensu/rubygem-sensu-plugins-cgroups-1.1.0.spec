...
%global gem_name sensu-plugins-cgroups
Name: rubygem-sensu-plugins-cgroups
Version: 1.1.0
Release: 1.%{dist}
Summary: rubygem sensu-plugins-cgroups
Group: Development/Languages
License: MIT
URL: https://github.com/sensu-plugins/sensu-plugins-cgroups
Vendor: %{vendor}
Packager: %{packager}
Requires: ruby rubygems
Provides: rubygem-sensu-plugins-cgroups = %{version}
Provides: rubygem(sensu-plugins-cgroups) = %{version}
Obsoletes: rubygem-sensu-plugins-cgroups < %{version}
Obsoletes: rubygem(sensu-plugins-cgroups) < %{version}
...
gem install --install-dir %{buildroot}/%{gem_dir} --bindir %{buildroot}/%{_bindir} --force --no-rdoc --no-ri --no-doc --ignore-dependencies sensu-plugins-cgroups -v %{version}
