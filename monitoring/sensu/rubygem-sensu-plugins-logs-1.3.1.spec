...
%global gem_name sensu-plugins-logs
Name: rubygem-sensu-plugins-logs
Version: 1.3.1
Release: 1.%{dist}
Summary: rubygem sensu-plugins-logs
Group: Development/Languages
License: MIT
URL: https://github.com/sensu-plugins/sensu-plugins-logs
Vendor: %{vendor}
Packager: %{packager}
Requires: ruby rubygems
Provides: rubygem-sensu-plugins-logs = %{version}
Provides: rubygem(sensu-plugins-logs) = %{version}
Obsoletes: rubygem-sensu-plugins-logs < %{version}
Obsoletes: rubygem(sensu-plugins-logs) < %{version}
...
gem install --install-dir %{buildroot}/%{gem_dir} --bindir %{buildroot}/%{_bindir} --force --no-rdoc --no-ri --no-doc --ignore-dependencies sensu-plugins-logs -v %{version}
