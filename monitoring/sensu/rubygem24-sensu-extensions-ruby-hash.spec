...
Name: rubygem%{alinux_ruby}-sensu-extensions-ruby-hash
Version: 1.0.0
Release: 1.%{dist}
AutoReqProv : no
...
Provides: rubygem%{alinux_ruby}-sensu-extensions-ruby-hash = %{version}
Provides: rubygem%{alinux_ruby}(sensu-extensions-ruby-hash) = %{version}
Obsoletes: rubygem%{alinux_ruby}-sensu-extensions-ruby-hash < %{version}
Obsoletes: rubygem%{alinux_ruby}(sensu-extensions-ruby-hash) < %{version}
