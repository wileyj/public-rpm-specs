...
%global gem_name sensu-plugins-rabbitmq
Name: rubygem-sensu-plugins-rabbitmq
Version: 3.6.0
Release: 1.%{dist}
Summary: rubygem sensu-plugins-rabbitmq
Group: Development/Languages
License: MIT
URL: https://github.com/sensu-plugins/sensu-plugins-rabbitmq
Vendor: %{vendor}
Packager: %{packager}
Requires: ruby rubygems
Provides: rubygem-sensu-plugins-rabbitmq = %{version}
Provides: rubygem(sensu-plugins-rabbitmq) = %{version}
Obsoletes: rubygem-sensu-plugins-rabbitmq < %{version}
Obsoletes: rubygem(sensu-plugins-rabbitmq) < %{version}


Requires: rubygem-amq-protocol  = 2.0.1
Requires: rubygem-bunny  = 2.5.0
Requires: rubygem-carrot-top  = 0.0.7
Requires: rubygem-inifile  = 3.0.0
Requires: rubygem-rest-client  >= 1.8.0
Requires: rubygem-ruby_dig  = 0.0.2
Requires: rubygem-sensu-plugin  >= 1.2
Requires: rubygem-stomp  = 1.4.3
...
gem install --install-dir %{buildroot}/%{gem_dir} --bindir %{buildroot}/%{_bindir} --force --no-rdoc --no-ri --no-doc --ignore-dependencies sensu-plugins-rabbitmq -v %{version}
