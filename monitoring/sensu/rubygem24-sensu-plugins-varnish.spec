...
Name: rubygem%{alinux_ruby}-sensu-plugins-varnish
Version: 1.1.2
Release: 1.%{dist}
AutoReqProv : no
...
Provides: rubygem%{alinux_ruby}-sensu-plugins-varnish = %{version}
Provides: rubygem%{alinux_ruby}(sensu-plugins-varnish) = %{version}
Obsoletes: rubygem%{alinux_ruby}-sensu-plugins-varnish < %{version}
Obsoletes: rubygem%{alinux_ruby}(sensu-plugins-varnish) < %{version}


Requires: rubygem%{alinux_ruby}-crack  >= 0.4.2
