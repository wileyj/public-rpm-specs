...
Name: rubygem%{alinux_ruby}-sensu-extensions-occurrences
Version: 1.2.0
Release: 1.%{dist}
AutoReqProv : no
...
Provides: rubygem%{alinux_ruby}-sensu-extensions-occurrences = %{version}
Provides: rubygem%{alinux_ruby}(sensu-extensions-occurrences) = %{version}
Obsoletes: rubygem%{alinux_ruby}-sensu-extensions-occurrences < %{version}
Obsoletes: rubygem%{alinux_ruby}(sensu-extensions-occurrences) < %{version}
