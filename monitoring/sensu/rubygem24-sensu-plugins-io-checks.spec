...
Name: rubygem%{alinux_ruby}-sensu-plugins-io-checks
Version: 1.0.1
Release: 1.%{dist}
AutoReqProv : no
...
Provides: rubygem%{alinux_ruby}-sensu-plugins-io-checks = %{version}
Provides: rubygem%{alinux_ruby}(sensu-plugins-io-checks) = %{version}
Obsoletes: rubygem%{alinux_ruby}-sensu-plugins-io-checks < %{version}
Obsoletes: rubygem%{alinux_ruby}(sensu-plugins-io-checks) < %{version}
