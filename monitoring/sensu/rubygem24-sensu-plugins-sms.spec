...
Name: rubygem%{alinux_ruby}-sensu-plugins-sms
Version: 1.0.0
Release: 1.%{dist}
AutoReqProv : no
...
Provides: rubygem%{alinux_ruby}-sensu-plugins-sms = %{version}
Provides: rubygem%{alinux_ruby}(sensu-plugins-sms) = %{version}
Obsoletes: rubygem%{alinux_ruby}-sensu-plugins-sms < %{version}
Obsoletes: rubygem%{alinux_ruby}(sensu-plugins-sms) < %{version}


Requires: rubygem%{alinux_ruby}-mail  >= 2.6.3
Requires: rubygem%{alinux_ruby}-playsms  >= 0.0.1
