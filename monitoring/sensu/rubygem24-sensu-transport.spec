...
Name: rubygem%{alinux_ruby}-sensu-transport
Version: 7.0.2
Release: 1.%{dist}
AutoReqProv : no
Summary: rubygem sensu-transport
...
Provides: rubygem%{alinux_ruby}-sensu-transport = %{version}
Provides: rubygem%{alinux_ruby}(sensu-transport) = %{version}
Obsoletes: rubygem%{alinux_ruby}-sensu-transport < %{version}
Obsoletes: rubygem%{alinux_ruby}(sensu-transport) < %{version}


Requires: rubygem%{alinux_ruby}-amqp  >= 1.6.0
Requires: rubygem%{alinux_ruby}-amq-protocol  >= 2.0.1
Requires: rubygem%{alinux_ruby}-eventmachine
Requires: rubygem%{alinux_ruby}-sensu-redis  >= 1.0.0
