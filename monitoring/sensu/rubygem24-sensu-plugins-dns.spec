...
Name: rubygem%{alinux_ruby}-sensu-plugins-dns
Version: 1.3.0
Release: 1.%{dist}
AutoReqProv : no
...
Provides: rubygem%{alinux_ruby}-sensu-plugins-dns = %{version}
Provides: rubygem%{alinux_ruby}(sensu-plugins-dns) = %{version}
Obsoletes: rubygem%{alinux_ruby}-sensu-plugins-dns < %{version}
Obsoletes: rubygem%{alinux_ruby}(sensu-plugins-dns) < %{version}


Requires: rubygem%{alinux_ruby}-dnsruby  >= 1.59.2,
