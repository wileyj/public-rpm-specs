...
Name: rubygem%{alinux_ruby}-sensu-plugins-vmstats
Version: 1.0.0
Release: 1.%{dist}
AutoReqProv : no
...
Provides: rubygem%{alinux_ruby}-sensu-plugins-vmstats = %{version}
Provides: rubygem%{alinux_ruby}(sensu-plugins-vmstats) = %{version}
Obsoletes: rubygem%{alinux_ruby}-sensu-plugins-vmstats < %{version}
Obsoletes: rubygem%{alinux_ruby}(sensu-plugins-vmstats) < %{version}
