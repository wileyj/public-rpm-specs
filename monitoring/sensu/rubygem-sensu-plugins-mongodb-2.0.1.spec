...
%global gem_name sensu-plugins-mongodb
Name: rubygem-sensu-plugins-mongodb
Version: 2.0.1
Release: 1.%{dist}
Summary: rubygem sensu-plugins-mongodb
...
Provides: rubygem-sensu-plugins-mongodb = %{version}
Provides: rubygem(sensu-plugins-mongodb) = %{version}
Obsoletes: rubygem-sensu-plugins-mongodb < %{version}
Obsoletes: rubygem(sensu-plugins-mongodb) < %{version}


Requires: rubygem-bson  >= 4.0
Requires: rubygem-mongo  = 2.4.1
...
gem install --install-dir %{buildroot}/%{gem_dir} --bindir %{buildroot}/%{_bindir} --force --no-rdoc --no-ri --no-doc --ignore-dependencies sensu-plugins-mongodb -v %{version}
