...
Name: rubygem%{alinux_ruby}-sensu-plugins-java
Version: 1.3.0
Release: 1.%{dist}
AutoReqProv : no
...
Provides: rubygem%{alinux_ruby}-sensu-plugins-java = %{version}
Provides: rubygem%{alinux_ruby}(sensu-plugins-java) = %{version}
Obsoletes: rubygem%{alinux_ruby}-sensu-plugins-java < %{version}
Obsoletes: rubygem%{alinux_ruby}(sensu-plugins-java) < %{version}
