...
Name: rubygem%{alinux_ruby}-sensu-plugins-cgroups
Version: 1.1.0
Release: 1.%{dist}
AutoReqProv : no
...
Provides: rubygem%{alinux_ruby}-sensu-plugins-cgroups = %{version}
Provides: rubygem%{alinux_ruby}(sensu-plugins-cgroups) = %{version}
Obsoletes: rubygem%{alinux_ruby}-sensu-plugins-cgroups < %{version}
Obsoletes: rubygem%{alinux_ruby}(sensu-plugins-cgroups) < %{version}
