...
%global gem_name sensu-plugins-graphite
Name: rubygem-sensu-plugins-graphite
Version: 2.3.0
Release: 1.%{dist}
Summary: rubygem sensu-plugins-graphite
...
Provides: rubygem-sensu-plugins-graphite = %{version}
Provides: rubygem(sensu-plugins-graphite) = %{version}
Obsoletes: rubygem-sensu-plugins-graphite < %{version}
Obsoletes: rubygem(sensu-plugins-graphite) < %{version}


Requires: rubygem-array_stats  = 0.6.0
Requires: rubygem-ipaddress  = 0.8.0
Requires: rubygem-rest-client  >= 1.8.0
Requires: rubygem-sensu-plugin  >= 1.2
Requires: rubygem-simple-graphite  = 2.1.0
...
gem install --install-dir %{buildroot}/%{gem_dir} --bindir %{buildroot}/%{_bindir} --force --no-rdoc --no-ri --no-doc --ignore-dependencies sensu-plugins-graphite -v %{version}
