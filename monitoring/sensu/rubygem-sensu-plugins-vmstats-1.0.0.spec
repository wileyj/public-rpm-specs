...
%global gem_name sensu-plugins-vmstats
Name: rubygem-sensu-plugins-vmstats
Version: 1.0.0
Release: 1.%{dist}
Summary: rubygem sensu-plugins-vmstats
Group: Development/Languages
License: MIT
URL: https://github.com/sensu-plugins/sensu-plugins-vmstats
Vendor: %{vendor}
Packager: %{packager}
Requires: ruby rubygems
Provides: rubygem-sensu-plugins-vmstats = %{version}
Provides: rubygem(sensu-plugins-vmstats) = %{version}
Obsoletes: rubygem-sensu-plugins-vmstats < %{version}
Obsoletes: rubygem(sensu-plugins-vmstats) < %{version}
...
gem install --install-dir %{buildroot}/%{gem_dir} --bindir %{buildroot}/%{_bindir} --force --no-rdoc --no-ri --no-doc --ignore-dependencies sensu-plugins-vmstats -v %{version}
