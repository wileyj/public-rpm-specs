...
Name: rubygem%{alinux_ruby}-sensu-plugins-postgres
Version: 1.4.4
Release: 1.%{dist}
AutoReqProv : no
...
Provides: rubygem%{alinux_ruby}-sensu-plugins-postgres = %{version}
Provides: rubygem%{alinux_ruby}(sensu-plugins-postgres) = %{version}
Obsoletes: rubygem%{alinux_ruby}-sensu-plugins-postgres < %{version}
Obsoletes: rubygem%{alinux_ruby}(sensu-plugins-postgres) < %{version}


Requires: rubygem%{alinux_ruby}-dentaku  >= 2.0.4
Requires: rubygem%{alinux_ruby}-pg  >= 0.18.3
