...
%global gem_name sensu-plugins-conntrack
Name: rubygem-sensu-plugins-conntrack
Version: 1.0.0
Release: 1.%{dist}
Summary: rubygem sensu-plugins-conntrack
Group: Development/Languages
License: MIT
URL: https://github.com/sensu-plugins/sensu-plugins-conntrack
Vendor: %{vendor}
Packager: %{packager}
Requires: ruby rubygems
Provides: rubygem-sensu-plugins-conntrack = %{version}
Provides: rubygem(sensu-plugins-conntrack) = %{version}
Obsoletes: rubygem-sensu-plugins-conntrack < %{version}
Obsoletes: rubygem(sensu-plugins-conntrack) < %{version}
...
%description
This plugin provides native conntrack instrumentation
...
gem install --install-dir %{buildroot}/%{gem_dir} --bindir %{buildroot}/%{_bindir} --force --no-rdoc --no-ri --no-doc --ignore-dependencies sensu-plugins-conntrack -v %{version}
