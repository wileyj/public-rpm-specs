...
%global gem_name sensu-plugins-uchiwa
Name: rubygem-sensu-plugins-uchiwa
Version: 1.0.0
Release: 1.%{dist}
Summary: rubygem sensu-plugins-uchiwa
Group: Development/Languages
License: MIT
URL: https://github.com/sensu-plugins/sensu-plugins-uchiwa
Vendor: %{vendor}
Packager: %{packager}
Requires: ruby rubygems
Provides: rubygem-sensu-plugins-uchiwa = %{version}
Provides: rubygem(sensu-plugins-uchiwa) = %{version}
Obsoletes: rubygem-sensu-plugins-uchiwa < %{version}
Obsoletes: rubygem(sensu-plugins-uchiwa) < %{version}
...
gem install --install-dir %{buildroot}/%{gem_dir} --bindir %{buildroot}/%{_bindir} --force --no-rdoc --no-ri --no-doc --ignore-dependencies sensu-plugins-uchiwa -v %{version}
