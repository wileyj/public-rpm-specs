...
Name: rubygem%{alinux_ruby}-sensu-plugins-load-checks
Version: 4.0.0
Release: 1.%{dist}
AutoReqProv : no
...
Provides: rubygem%{alinux_ruby}-sensu-plugins-load-checks = %{version}
Provides: rubygem%{alinux_ruby}(sensu-plugins-load-checks) = %{version}
Obsoletes: rubygem%{alinux_ruby}-sensu-plugins-load-checks < %{version}
Obsoletes: rubygem%{alinux_ruby}(sensu-plugins-load-checks) < %{version}
