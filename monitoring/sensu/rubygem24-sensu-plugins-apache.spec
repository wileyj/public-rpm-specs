...
Name: rubygem%{alinux_ruby}-sensu-plugins-apache
Version: 2.0.0
Release: 1.%{dist}
AutoReqProv : no
...
Provides: rubygem%{alinux_ruby}-sensu-plugins-apache = %{version}
Provides: rubygem%{alinux_ruby}(sensu-plugins-apache) = %{version}
Obsoletes: rubygem%{alinux_ruby}-sensu-plugins-apache < %{version}
Obsoletes: rubygem%{alinux_ruby}(sensu-plugins-apache) < %{version}
