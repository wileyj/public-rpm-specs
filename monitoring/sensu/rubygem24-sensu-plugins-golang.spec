...
Name: rubygem%{alinux_ruby}-sensu-plugins-golang
Version: 1.0.0
Release: 1.%{dist}
AutoReqProv : no
...
Provides: rubygem%{alinux_ruby}-sensu-plugins-golang = %{version}
Provides: rubygem%{alinux_ruby}(sensu-plugins-golang) = %{version}
Obsoletes: rubygem%{alinux_ruby}-sensu-plugins-golang < %{version}
Obsoletes: rubygem%{alinux_ruby}(sensu-plugins-golang) < %{version}


Requires: rubygem%{alinux_ruby}-oj  >= 2.18.1
