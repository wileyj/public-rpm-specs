...
Name: rubygem%{alinux_ruby}-sensu-plugins-tripwire
Version: 1.0.0
Release: 1.%{dist}
AutoReqProv : no
...
Provides: rubygem%{alinux_ruby}-sensu-plugins-tripwire = %{version}
Provides: rubygem%{alinux_ruby}(sensu-plugins-tripwire) = %{version}
Obsoletes: rubygem%{alinux_ruby}-sensu-plugins-tripwire < %{version}
Obsoletes: rubygem%{alinux_ruby}(sensu-plugins-tripwire) < %{version}
