...
Name: rubygem%{alinux_ruby}-sensu-plugins-redis
Version: 2.3.2
Release: 1.%{dist}
AutoReqProv : no
...
Provides: rubygem%{alinux_ruby}-sensu-plugins-redis = %{version}
Provides: rubygem%{alinux_ruby}(sensu-plugins-redis) = %{version}
Obsoletes: rubygem%{alinux_ruby}-sensu-plugins-redis < %{version}
Obsoletes: rubygem%{alinux_ruby}(sensu-plugins-redis) < %{version}


Requires: rubygem%{alinux_ruby}-redis  >= 3.3
