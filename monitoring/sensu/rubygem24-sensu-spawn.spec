...
Name: rubygem%{alinux_ruby}-sensu-spawn
Version: 2.2.1
Release: 1.%{dist}
AutoReqProv : no
...
Provides: rubygem%{alinux_ruby}-sensu-spawn = %{version}
Provides: rubygem%{alinux_ruby}(sensu-spawn) = %{version}
Obsoletes: rubygem%{alinux_ruby}-sensu-spawn < %{version}
Obsoletes: rubygem%{alinux_ruby}(sensu-spawn) < %{version}


Requires: rubygem%{alinux_ruby}-childprocess  >= 0.5.8
Requires: rubygem%{alinux_ruby}-em-worker  >= 0.0.2
