...
%global gemname sensu-extensions
...
#pwd
#ls
#ls -al spec/assets/extensions
#read ans
#%{__rm} -f spec/assets/extensions/extensions_symlinked
#ls spec
#ls spec/assets
#ls -al spec/assets/extensions
#read ans
#spec/assets/extensions_symlinked
...
cp -pa %{_builddir}/%{name}/* %{buildroot}/
#A=`pwd`
#cd %{buildroot}%{gem_dir}/gems/%{name}-%{version}/spec/assets/
#BUILD/rubygem-sensu-extensions-1.5.0/spec/assets/extensions

#%{__ln} -sf extensions_symlinked extensions/extensions_symlinked
#cd $PWD
