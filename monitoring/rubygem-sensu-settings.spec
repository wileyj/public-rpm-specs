...
echo '"%{gem_dir}/gems/%{gemname}-%{version}/spec/assets/alternative/conf.d/loop"' >> %{filelist}
echo '"%{gem_dir}/gems/%{gemname}-%{version}/spec/assets/conf.d/alternative"' >> %{filelist}
