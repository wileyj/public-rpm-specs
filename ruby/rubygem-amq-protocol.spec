...
(
    ...
    echo '"%{gem_dir}/gems/%{gemname}-%{version}/codegen/__init__.pyc"'
    echo '"%{gem_dir}/gems/%{gemname}-%{version}/codegen/__init__.pyo"'
    echo '"%{gem_dir}/gems/%{gemname}-%{version}/codegen/codegen.pyc"'
    echo '"%{gem_dir}/gems/%{gemname}-%{version}/codegen/codegen.pyo"'
    echo '"%{gem_dir}/gems/%{gemname}-%{version}/codegen/codegen_helpers.pyc"'
    echo '"%{gem_dir}/gems/%{gemname}-%{version}/codegen/codegen_helpers.pyo"'
