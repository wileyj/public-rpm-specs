...
Name: rubygem%{alinux_ruby}-rest-client
Version: 1.8.0
Release: 1.%{dist}
AutoReqProv : no
...
Provides: rubygem%{alinux_ruby}-rest-client = %{version}
Provides: rubygem%{alinux_ruby}(rest-client) = %{version}
Obsoletes: rubygem%{alinux_ruby}-rest-client < %{version}
Obsoletes: rubygem%{alinux_ruby}(rest-client) < %{version}


Requires: rubygem%{alinux_ruby}-ffi
Requires: rubygem%{alinux_ruby}-http-cookie  < 2.0,
Requires: rubygem%{alinux_ruby}-mime-types  < 4.0,
Requires: rubygem%{alinux_ruby}-netrc  >= 0.7
