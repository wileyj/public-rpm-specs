...
Name: rubygem%{alinux_ruby}-diplomat
Version: 0.14.0
Release: 1.%{dist}
AutoReqProv : no
...
Provides: rubygem%{alinux_ruby}-diplomat = %{version}
Provides: rubygem%{alinux_ruby}(diplomat) = %{version}
Obsoletes: rubygem%{alinux_ruby}-diplomat < %{version}
Obsoletes: rubygem%{alinux_ruby}(diplomat) < %{version}


Requires: rubygem%{alinux_ruby}-faraday  >= 0.9
Requires: rubygem%{alinux_ruby}-json  >= 1.8
