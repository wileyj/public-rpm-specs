...
Name: rubygem%{alinux_ruby}-addressable
Version: 2.5.2
Release: 1.%{dist}
AutoReqProv : no
...
Provides: rubygem%{alinux_ruby}-addressable = %{version}
Provides: rubygem%{alinux_ruby}(addressable) = %{version}
Obsoletes: rubygem%{alinux_ruby}-addressable < %{version}
Obsoletes: rubygem%{alinux_ruby}(addressable) < %{version}


Requires: rubygem%{alinux_ruby}-public_suffix  < 4.0,
