...
Name: rubygem%{alinux_ruby}-faraday
Version: 0.13.1
Release: 1.%{dist}
AutoReqProv : no
...
Provides: rubygem%{alinux_ruby}-faraday = %{version}
Provides: rubygem%{alinux_ruby}(faraday) = %{version}
Obsoletes: rubygem%{alinux_ruby}-faraday < %{version}
Obsoletes: rubygem%{alinux_ruby}(faraday) < %{version}


Requires: rubygem%{alinux_ruby}-multipart-post  < 3,
