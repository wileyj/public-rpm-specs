...
Name: rubygem%{alinux_ruby}-activesupport
Version: 5.1.4
Release: 1.%{dist}
AutoReqProv : no
...
Provides: rubygem%{alinux_ruby}-activesupport = %{version}
Provides: rubygem%{alinux_ruby}(activesupport) = %{version}
Obsoletes: rubygem%{alinux_ruby}-activesupport < %{version}
Obsoletes: rubygem%{alinux_ruby}(activesupport) < %{version}
Requires: rubygem%{alinux_ruby}-concurrent-ruby  >= 1.0.2,
Requires: rubygem%{alinux_ruby}-i18n  >= 0.7
Requires: rubygem%{alinux_ruby}-minitest  >= 5.1
Requires: rubygem%{alinux_ruby}-tzinfo  >= 1.1
