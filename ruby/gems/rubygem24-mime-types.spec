...
Name: rubygem%{alinux_ruby}-mime-types
Version: 3.1
Release: 1.%{dist}
AutoReqProv : no
...
Provides: rubygem%{alinux_ruby}-mime-types = %{version}
Provides: rubygem%{alinux_ruby}(mime-types) = %{version}
Obsoletes: rubygem%{alinux_ruby}-mime-types < %{version}
Obsoletes: rubygem%{alinux_ruby}(mime-types) < %{version}


Requires: rubygem%{alinux_ruby}-mime-types-data  >= 3.2015
