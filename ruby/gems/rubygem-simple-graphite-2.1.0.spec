...
%global gem_name simple-graphite
Name: rubygem-simple-graphite
Version: 2.1.0
Release: 1.%{dist}
Summary: rubygem simple-graphite
Group: Development/Languages
License: MIT
URL: http://github.com/imeyer/simple-graphite
Vendor: %{vendor}
Packager: %{packager}
Requires: ruby rubygems
Provides: rubygem-simple-graphite = %{version}
Provides: rubygem(simple-graphite) = %{version}
Obsoletes: rubygem-simple-graphite < %{version}
Obsoletes: rubygem(simple-graphite) < %{version}
...
gem install --install-dir %{buildroot}/%{gem_dir} --bindir %{buildroot}/%{_bindir} --force --no-rdoc --no-ri --no-doc --ignore-dependencies simple-graphite -v %{version}
