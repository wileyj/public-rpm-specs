...
%global gem_name dnsbl-client
Name: rubygem-dnsbl-client
Version: 1.0.2
Release: 1.%{dist}
Summary: rubygem dnsbl-client
Group: Development/Languages
License: MIT
URL: http://github.com/chrislee35/dnsbl-client
Vendor: %{vendor}
Packager: %{packager}
Requires: ruby rubygems
Provides: rubygem-dnsbl-client = %{version}
Provides: rubygem(dnsbl-client) = %{version}
Obsoletes: rubygem-dnsbl-client < %{version}
Obsoletes: rubygem(dnsbl-client) < %{version}
...
gem install --install-dir %{buildroot}/%{gem_dir} --bindir %{buildroot}/%{_bindir} --force --no-rdoc --no-ri --no-doc --ignore-dependencies dnsbl-client -v %{version}
