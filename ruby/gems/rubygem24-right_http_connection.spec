...
Name: rubygem%{alinux_ruby}-right_http_connection
Version: 1.5.0
Release: 1.%{dist}
AutoReqProv : no
...
Provides: rubygem%{alinux_ruby}-right_http_connection = %{version}
Provides: rubygem%{alinux_ruby}(right_http_connection) = %{version}
Obsoletes: rubygem%{alinux_ruby}-right_http_connection < %{version}
Obsoletes: rubygem%{alinux_ruby}(right_http_connection) < %{version}
