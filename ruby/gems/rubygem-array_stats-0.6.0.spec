...
%global gem_name array_stats
Name: rubygem-array_stats
Version: 0.6.0
Release: 1.%{dist}
Summary: rubygem array_stats
Group: Development/Languages
License: GPL
URL: http://github.com/bkoski/array_stats
Vendor: %{vendor}
Packager: %{packager}
Requires: ruby rubygems
Provides: rubygem-array_stats = %{version}
Provides: rubygem(array_stats) = %{version}
Obsoletes: rubygem-array_stats < %{version}
Obsoletes: rubygem(array_stats) < %{version}
...
gem install --install-dir %{buildroot}/%{gem_dir} --bindir %{buildroot}/%{_bindir} --force --no-rdoc --no-ri --no-doc --ignore-dependencies array_stats -v %{version}
