...
Name: rubygem%{alinux_ruby}-http
Version: 0.9.8
Release: 1.%{dist}
AutoReqProv : no
Summary: rubygem http
...
Provides: rubygem%{alinux_ruby}-http = %{version}
Provides: rubygem%{alinux_ruby}(http) = %{version}
Obsoletes: rubygem%{alinux_ruby}-http < %{version}
Obsoletes: rubygem%{alinux_ruby}(http) < %{version}


Requires: rubygem%{alinux_ruby}-addressable  >= 2.3
Requires: rubygem%{alinux_ruby}-http-cookie  >= 1.0
Requires: rubygem%{alinux_ruby}-http-form_data  >= 1.0.1
Requires: rubygem%{alinux_ruby}-http_parser.rb  >= 0.6.0
