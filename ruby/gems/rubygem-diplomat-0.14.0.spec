...
Name: rubygem-diplomat
Version: 0.14.0
Release: 1.%{dist}
Summary: rubygem diplomat
Group: Development/Languages
License: BSD
URL: https://github.com/WeAreFarmGeek/diplomat
Vendor: %{vendor}
Packager: %{packager}
Requires: ruby rubygems
Provides: rubygem-diplomat = %{version}
Provides: rubygem(diplomat) = %{version}
Obsoletes: rubygem-diplomat < %{version}
Obsoletes: rubygem(diplomat) < %{version}
...
gem install --install-dir %{buildroot}/%{gem_dir} --bindir %{buildroot}/%{_bindir} --force --no-rdoc --no-ri --no-doc --ignore-dependencies diplomat -v %{version}
