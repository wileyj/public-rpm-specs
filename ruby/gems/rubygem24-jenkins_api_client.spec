...
Name: rubygem%{alinux_ruby}-jenkins_api_client
Version: 1.4.2
Release: 1.%{dist}
AutoReqProv : no
Summary: rubygem jenkins_api_client
...
Provides: rubygem%{alinux_ruby}-jenkins_api_client = %{version}
Provides: rubygem%{alinux_ruby}(jenkins_api_client) = %{version}
Obsoletes: rubygem%{alinux_ruby}-jenkins_api_client < %{version}
Obsoletes: rubygem%{alinux_ruby}(jenkins_api_client) < %{version}


Requires: rubygem%{alinux_ruby}-json
Requires: rubygem%{alinux_ruby}-mixlib-shellout  >= 1.1.0
Requires: rubygem%{alinux_ruby}-nokogiri  >= 1.6.0
Requires: rubygem%{alinux_ruby}-terminal-table  >= 1.4.0
Requires: rubygem%{alinux_ruby}-thor  >= 0.16.0
