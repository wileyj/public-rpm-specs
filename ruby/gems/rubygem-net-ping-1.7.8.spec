...
Provides: rubygem(net-ping) = %{version}
Obsoletes: rubygem-net-ping < %{version}
Obsoletes: rubygem(net-ping) < %{version}
...
gem install --install-dir %{buildroot}/%{gem_dir} --bindir %{buildroot}/%{_bindir} --force --no-rdoc --no-ri --no-doc --ignore-dependencies net-ping -v %{version}
