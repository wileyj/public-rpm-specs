...
Name: rubygem%{alinux_ruby}-docker-api
Version: 1.21.0
Release: 1.%{dist}
AutoReqProv : no
...
Provides: rubygem%{alinux_ruby}-docker-api = %{version}
Provides: rubygem%{alinux_ruby}(docker-api) = %{version}
Obsoletes: rubygem%{alinux_ruby}-docker-api < %{version}
Obsoletes: rubygem%{alinux_ruby}(docker-api) < %{version}


Requires: rubygem%{alinux_ruby}-excon  >= 0.38.0
