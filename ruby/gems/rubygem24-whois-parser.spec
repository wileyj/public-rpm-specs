...
Name: rubygem%{alinux_ruby}-whois-parser
Version: 1.0.0
Release: 1.%{dist}
AutoReqProv : no
...
Provides: rubygem%{alinux_ruby}-whois-parser = %{version}
Provides: rubygem%{alinux_ruby}(whois-parser) = %{version}
Obsoletes: rubygem%{alinux_ruby}-whois-parser < %{version}
Obsoletes: rubygem%{alinux_ruby}(whois-parser) < %{version}


Requires: rubygem%{alinux_ruby}-activesupport  >= 4
Requires: rubygem%{alinux_ruby}-whois  >= 4.0.0
