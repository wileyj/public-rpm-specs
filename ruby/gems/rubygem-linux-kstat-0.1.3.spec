...
%global gem_name linux-kstat
Name: rubygem-linux-kstat
Version: 0.1.3
Release: 1.%{dist}
Summary: rubygem linux-kstat
Group: Development/Languages
License: Artistic 2.0
URL: https://github.com/djberg96/linux-kstat
Vendor: %{vendor}
Packager: %{packager}
Requires: ruby rubygems
Provides: rubygem-linux-kstat = %{version}
Provides: rubygem(linux-kstat) = %{version}
Obsoletes: rubygem-linux-kstat < %{version}
Obsoletes: rubygem(linux-kstat) < %{version}
...
gem install --install-dir %{buildroot}/%{gem_dir} --bindir %{buildroot}/%{_bindir} --force --no-rdoc --no-ri --no-doc --ignore-dependencies linux-kstat -v %{version}
