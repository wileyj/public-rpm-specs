...
Name: rubygem%{alinux_ruby}-childprocess
Version: 0.5.8
Release: 1.%{dist}
AutoReqProv : no
...
Provides: rubygem%{alinux_ruby}-childprocess = %{version}
Provides: rubygem%{alinux_ruby}(childprocess) = %{version}
Obsoletes: rubygem%{alinux_ruby}-childprocess < %{version}
Obsoletes: rubygem%{alinux_ruby}(childprocess) < %{version}


Requires: rubygem%{alinux_ruby}-ffi  >= 1.0.11,
