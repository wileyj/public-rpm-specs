...
%global gem_name dentaku
Name: rubygem-dentaku
Version: 2.0.4
Release: 1.%{dist}
Summary: rubygem dentaku
Group: Development/Languages
License: MIT
URL: http://github.com/rubysolo/dentaku
Vendor: %{vendor}
Packager: %{packager}
Requires: ruby rubygems
Provides: rubygem-dentaku = %{version}
Provides: rubygem(dentaku) = %{version}
Obsoletes: rubygem-dentaku < %{version}
Obsoletes: rubygem(dentaku) < %{version}
...
gem install --install-dir %{buildroot}/%{gem_dir} --bindir %{buildroot}/%{_bindir} --force --no-rdoc --no-ri --no-doc --ignore-dependencies dentaku -v %{version}
