...
%global gem_name whois-parser
Name: rubygem-whois-parser
Version: 1.0.0
Release: 1.%{dist}
Summary: rubygem whois-parser
Group: Development/Languages
License: MIT
URL: https://whoisrb.org/
Vendor: %{vendor}
Packager: %{packager}
Requires: ruby rubygems
Provides: rubygem-whois-parser = %{version}
Provides: rubygem(whois-parser) = %{version}
Obsoletes: rubygem-whois-parser < %{version}
Obsoletes: rubygem(whois-parser) < %{version}


Requires: rubygem-activesupport  >= 4
Requires: rubygem-whois  >= 4.0.0
...
gem install --install-dir %{buildroot}/%{gem_dir} --bindir %{buildroot}/%{_bindir} --force --no-rdoc --no-ri --no-doc --ignore-dependencies whois-parser -v %{version}
