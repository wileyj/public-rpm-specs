...
Name: rubygem%{alinux_ruby}-aws-sdk-importexport
Version: 1.0.0
Release: 1.%{dist}
...
Provides: rubygem%{alinux_ruby}-aws-sdk-importexport = %{version}
Provides: rubygem%{alinux_ruby}(aws-sdk-importexport) = %{version}
Obsoletes: rubygem%{alinux_ruby}-aws-sdk-importexport < %{version}
Obsoletes: rubygem%{alinux_ruby}(aws-sdk-importexport) < %{version}


Requires: rubygem%{alinux_ruby}-aws-sdk-core  = 3
Requires: rubygem%{alinux_ruby}-aws-sigv2  = 1.0
