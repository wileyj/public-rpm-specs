...
Name: rubygem%{alinux_ruby}-aws-sdk-opsworkscm
Version: 1.2.0
Release: 1.%{dist}
...
Provides: rubygem%{alinux_ruby}-aws-sdk-opsworkscm = %{version}
Provides: rubygem%{alinux_ruby}(aws-sdk-opsworkscm) = %{version}
Obsoletes: rubygem%{alinux_ruby}-aws-sdk-opsworkscm < %{version}
Obsoletes: rubygem%{alinux_ruby}(aws-sdk-opsworkscm) < %{version}
