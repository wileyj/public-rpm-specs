...
%global gem_name aws-sdk-ec2
Name: rubygem-aws-sdk-ec2
Version: 1.18.0
Release: 1.%{dist}
...
Provides: rubygem-aws-sdk-ec2 = %{version}
Provides: rubygem(aws-sdk-ec2) = %{version}
Obsoletes: rubygem-aws-sdk-ec2 < %{version}
Obsoletes: rubygem(aws-sdk-ec2) < %{version}
...
gem install --install-dir %{buildroot}/%{gem_dir} --bindir %{buildroot}/%{_bindir} --force --no-rdoc --no-ri --no-doc --ignore-dependencies aws-sdk-ec2 -v %{version}
