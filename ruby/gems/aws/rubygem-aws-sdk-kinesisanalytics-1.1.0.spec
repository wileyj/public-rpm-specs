...
Provides: rubygem-aws-sdk-kinesisanalytics = %{version}
Provides: rubygem(aws-sdk-kinesisanalytics) = %{version}
Obsoletes: rubygem-aws-sdk-kinesisanalytics < %{version}
Obsoletes: rubygem(aws-sdk-kinesisanalytics) < %{version}
...
gem install --install-dir %{buildroot}/%{gem_dir} --bindir %{buildroot}/%{_bindir} --force --no-rdoc --no-ri --no-doc --ignore-dependencies aws-sdk-kinesisanalytics -v %{version}
