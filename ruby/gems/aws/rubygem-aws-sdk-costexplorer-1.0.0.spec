...
%global gem_name aws-sdk-costexplorer
Name: rubygem-aws-sdk-costexplorer
Version: 1.0.0
Release: 1.%{dist}
Summary: rubygem aws-sdk-costexplorer
...
Provides: rubygem-aws-sdk-costexplorer = %{version}
Provides: rubygem(aws-sdk-costexplorer) = %{version}
Obsoletes: rubygem-aws-sdk-costexplorer < %{version}
Obsoletes: rubygem(aws-sdk-costexplorer) < %{version}
...
gem install --install-dir %{buildroot}/%{gem_dir} --bindir %{buildroot}/%{_bindir} --force --no-rdoc --no-ri --no-doc --ignore-dependencies aws-sdk-costexplorer -v %{version}
