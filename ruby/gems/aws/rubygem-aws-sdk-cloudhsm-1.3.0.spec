...
%global gem_name aws-sdk-cloudhsm
Name: rubygem-aws-sdk-cloudhsm
Version: 1.3.0
Release: 1.%{dist}
...
Provides: rubygem-aws-sdk-cloudhsm = %{version}
Provides: rubygem(aws-sdk-cloudhsm) = %{version}
Obsoletes: rubygem-aws-sdk-cloudhsm < %{version}
Obsoletes: rubygem(aws-sdk-cloudhsm) < %{version}
...
gem install --install-dir %{buildroot}/%{gem_dir} --bindir %{buildroot}/%{_bindir} --force --no-rdoc --no-ri --no-doc --ignore-dependencies aws-sdk-cloudhsm -v %{version}
