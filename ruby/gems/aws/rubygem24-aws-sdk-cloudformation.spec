...
%global gem_name aws-sdk-cloudformation
Name: rubygem%{alinux_ruby}-aws-sdk-cloudformation
Version: 1.3.0
Release: 1.%{dist}
...
Provides: rubygem%{alinux_ruby}-aws-sdk-cloudformation = %{version}
Provides: rubygem%{alinux_ruby}(aws-sdk-cloudformation) = %{version}
Obsoletes: rubygem%{alinux_ruby}-aws-sdk-cloudformation < %{version}
Obsoletes: rubygem%{alinux_ruby}(aws-sdk-cloudformation) < %{version}
