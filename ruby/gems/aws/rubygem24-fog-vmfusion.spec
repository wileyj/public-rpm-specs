...
Name: rubygem%{alinux_ruby}-fog-vmfusion
Version: 0.1.0
Release: 1.%{dist}
...
Provides: rubygem%{alinux_ruby}-fog-vmfusion = %{version}
Provides: rubygem%{alinux_ruby}(fog-vmfusion) = %{version}
Obsoletes: rubygem%{alinux_ruby}-fog-vmfusion < %{version}
Obsoletes: rubygem%{alinux_ruby}(fog-vmfusion) < %{version}


Requires: rubygem%{alinux_ruby}-fission
