...
Name: rubygem%{alinux_ruby}-aws-sdk-rekognition
Version: 1.2.0
Release: 1.%{dist}
...
Provides: rubygem%{alinux_ruby}-aws-sdk-rekognition = %{version}
Provides: rubygem%{alinux_ruby}(aws-sdk-rekognition) = %{version}
Obsoletes: rubygem%{alinux_ruby}-aws-sdk-rekognition < %{version}
Obsoletes: rubygem%{alinux_ruby}(aws-sdk-rekognition) < %{version}
