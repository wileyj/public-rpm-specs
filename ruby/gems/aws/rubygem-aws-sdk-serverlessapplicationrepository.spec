...
Name: rubygem-aws-sdk-serverlessapplicationrepository
Version: 1.0.0
Release: 1.%{dist}
...
Provides: rubygem-aws-sdk-serverlessapplicationrepository = %{version}
Provides: rubygem(aws-sdk-serverlessapplicationrepository) = %{version}
Obsoletes: rubygem-aws-sdk-serverlessapplicationrepository < %{version}
Obsoletes: rubygem(aws-sdk-serverlessapplicationrepository) < %{version}
