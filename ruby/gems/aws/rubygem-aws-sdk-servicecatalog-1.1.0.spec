...
%global gem_name aws-sdk-servicecatalog
Name: rubygem-aws-sdk-servicecatalog
Version: 1.1.0
Release: 1.%{dist}
...
Provides: rubygem-aws-sdk-servicecatalog = %{version}
Provides: rubygem(aws-sdk-servicecatalog) = %{version}
Obsoletes: rubygem-aws-sdk-servicecatalog < %{version}
Obsoletes: rubygem(aws-sdk-servicecatalog) < %{version}
...
gem install --install-dir %{buildroot}/%{gem_dir} --bindir %{buildroot}/%{_bindir} --force --no-rdoc --no-ri --no-doc --ignore-dependencies aws-sdk-servicecatalog -v %{version}
