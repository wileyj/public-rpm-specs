...
Name: rubygem%{alinux_ruby}-aws-sdk
Version: 3.0.1
Release: 1.%{dist}
...
Provides: rubygem%{alinux_ruby}-aws-sdk = %{version}
Provides: rubygem%{alinux_ruby}(aws-sdk) = %{version}
Obsoletes: rubygem%{alinux_ruby}-aws-sdk < %{version}
Obsoletes: rubygem%{alinux_ruby}(aws-sdk) < %{version}


Requires: rubygem%{alinux_ruby}-aws-sdk-resources  = 3
