...
Name: rubygem%{alinux_ruby}-aws-sdk-v1
Version: 1.66.0
Release: 1.%{dist}
...
Provides: rubygem%{alinux_ruby}-aws-sdk-v1 = %{version}
Provides: rubygem%{alinux_ruby}(aws-sdk-v1) = %{version}
Obsoletes: rubygem%{alinux_ruby}-aws-sdk-v1 < %{version}
Obsoletes: rubygem%{alinux_ruby}(aws-sdk-v1) < %{version}


Requires: rubygem%{alinux_ruby}-json  = 1.4
Requires: rubygem%{alinux_ruby}-nokogiri  >= 1.4.4
