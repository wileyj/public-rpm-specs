...
%global gem_name aws-sdk-directconnect
Name: rubygem%{alinux_ruby}-aws-sdk-directconnect
Version: 1.1.0
Release: 1.%{dist}
Summary: rubygem aws-sdk-directconnect
...
Provides: rubygem%{alinux_ruby}-aws-sdk-directconnect = %{version}
Provides: rubygem%{alinux_ruby}(aws-sdk-directconnect) = %{version}
Obsoletes: rubygem%{alinux_ruby}-aws-sdk-directconnect < %{version}
Obsoletes: rubygem%{alinux_ruby}(aws-sdk-directconnect) < %{version}
