...
Name: rubygem%{alinux_ruby}-aws-sdk-elasticsearchservice
Version: 1.3.0
Release: 1.%{dist}
...
Provides: rubygem%{alinux_ruby}-aws-sdk-elasticsearchservice = %{version}
Provides: rubygem%{alinux_ruby}(aws-sdk-elasticsearchservice) = %{version}
Obsoletes: rubygem%{alinux_ruby}-aws-sdk-elasticsearchservice < %{version}
Obsoletes: rubygem%{alinux_ruby}(aws-sdk-elasticsearchservice) < %{version}
