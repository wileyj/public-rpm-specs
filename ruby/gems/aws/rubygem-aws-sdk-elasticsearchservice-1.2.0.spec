...
%global gem_name aws-sdk-elasticsearchservice
Name: rubygem-aws-sdk-elasticsearchservice
Version: 1.2.0
Release: 1.%{dist}
...
Provides: rubygem-aws-sdk-elasticsearchservice = %{version}
Provides: rubygem(aws-sdk-elasticsearchservice) = %{version}
Obsoletes: rubygem-aws-sdk-elasticsearchservice < %{version}
Obsoletes: rubygem(aws-sdk-elasticsearchservice) < %{version}
...
gem install --install-dir %{buildroot}/%{gem_dir} --bindir %{buildroot}/%{_bindir} --force --no-rdoc --no-ri --no-doc --ignore-dependencies aws-sdk-elasticsearchservice -v %{version}
