...
Name: rubygem%{alinux_ruby}-aws-sdk-datapipeline
Version: 1.0.0
Release: 1.%{dist}
...
Provides: rubygem%{alinux_ruby}-aws-sdk-datapipeline = %{version}
Provides: rubygem%{alinux_ruby}(aws-sdk-datapipeline) = %{version}
Obsoletes: rubygem%{alinux_ruby}-aws-sdk-datapipeline < %{version}
Obsoletes: rubygem%{alinux_ruby}(aws-sdk-datapipeline) < %{version}
