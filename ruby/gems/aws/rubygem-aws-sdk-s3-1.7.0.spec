...
Provides: rubygem-aws-sdk-s3 = %{version}
Provides: rubygem(aws-sdk-s3) = %{version}
Obsoletes: rubygem-aws-sdk-s3 < %{version}
Obsoletes: rubygem(aws-sdk-s3) < %{version}
...
gem install --install-dir %{buildroot}/%{gem_dir} --bindir %{buildroot}/%{_bindir} --force --no-rdoc --no-ri --no-doc --ignore-dependencies aws-sdk-s3 -v %{version}
