...
Name: rubygem%{alinux_ruby}-aws-sdk-elasticloadbalancingv2
Version: 1.6.0
Release: 1.%{dist}
...
Provides: rubygem%{alinux_ruby}-aws-sdk-elasticloadbalancingv2 = %{version}
Provides: rubygem%{alinux_ruby}(aws-sdk-elasticloadbalancingv2) = %{version}
Obsoletes: rubygem%{alinux_ruby}-aws-sdk-elasticloadbalancingv2 < %{version}
Obsoletes: rubygem%{alinux_ruby}(aws-sdk-elasticloadbalancingv2) < %{version}
