...
Name: rubygem%{alinux_ruby}-aws-sdk-applicationdiscoveryservice
Version: 1.0.0
Release: 1.%{dist}
...
Provides: rubygem%{alinux_ruby}-aws-sdk-applicationdiscoveryservice = %{version}
Provides: rubygem%{alinux_ruby}(aws-sdk-applicationdiscoveryservice) = %{version}
Obsoletes: rubygem%{alinux_ruby}-aws-sdk-applicationdiscoveryservice < %{version}
Obsoletes: rubygem%{alinux_ruby}(aws-sdk-applicationdiscoveryservice) < %{version}
