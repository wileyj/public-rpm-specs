...
%global gem_name aws-sdk-shield
Name: rubygem-aws-sdk-shield
Version: 1.0.0
Release: 1.%{dist}
...
Provides: rubygem-aws-sdk-shield = %{version}
Provides: rubygem(aws-sdk-shield) = %{version}
Obsoletes: rubygem-aws-sdk-shield < %{version}
Obsoletes: rubygem(aws-sdk-shield) < %{version}
...
gem install --install-dir %{buildroot}/%{gem_dir} --bindir %{buildroot}/%{_bindir} --force --no-rdoc --no-ri --no-doc --ignore-dependencies aws-sdk-shield -v %{version}
(
    cd %{buildroot}
