...
Provides: rubygem-aws-sdk-codepipeline = %{version}
Provides: rubygem(aws-sdk-codepipeline) = %{version}
Obsoletes: rubygem-aws-sdk-codepipeline < %{version}
Obsoletes: rubygem(aws-sdk-codepipeline) < %{version}
...
gem install --install-dir %{buildroot}/%{gem_dir} --bindir %{buildroot}/%{_bindir} --force --no-rdoc --no-ri --no-doc --ignore-dependencies aws-sdk-codepipeline -v %{version}
