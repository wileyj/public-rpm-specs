...
Name: rubygem%{alinux_ruby}-aws-sdk-cognitoidentityprovider
Version: 1.2.0
Release: 1.%{dist}
...
Provides: rubygem%{alinux_ruby}-aws-sdk-cognitoidentityprovider = %{version}
Provides: rubygem%{alinux_ruby}(aws-sdk-cognitoidentityprovider) = %{version}
Obsoletes: rubygem%{alinux_ruby}-aws-sdk-cognitoidentityprovider < %{version}
Obsoletes: rubygem%{alinux_ruby}(aws-sdk-cognitoidentityprovider) < %{version}
