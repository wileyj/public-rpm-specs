...
Provides: rubygem-aws-sdk-wafregional = %{version}
Provides: rubygem(aws-sdk-wafregional) = %{version}
Obsoletes: rubygem-aws-sdk-wafregional < %{version}
Obsoletes: rubygem(aws-sdk-wafregional) < %{version}
...
gem install --install-dir %{buildroot}/%{gem_dir} --bindir %{buildroot}/%{_bindir} --force --no-rdoc --no-ri --no-doc --ignore-dependencies aws-sdk-wafregional -v %{version}
