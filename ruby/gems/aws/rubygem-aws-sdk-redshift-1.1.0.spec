...
%global gem_name aws-sdk-redshift
Name: rubygem-aws-sdk-redshift
Version: 1.1.0
Release: 1.%{dist}
...
Provides: rubygem-aws-sdk-redshift = %{version}
Provides: rubygem(aws-sdk-redshift) = %{version}
Obsoletes: rubygem-aws-sdk-redshift < %{version}
Obsoletes: rubygem(aws-sdk-redshift) < %{version}
...
gem install --install-dir %{buildroot}/%{gem_dir} --bindir %{buildroot}/%{_bindir} --force --no-rdoc --no-ri --no-doc --ignore-dependencies aws-sdk-redshift -v %{version}
