...
%global gem_name aws-sdk-swf
Name: rubygem-aws-sdk-swf
Version: 1.0.0
Release: 1.%{dist}
Summary: rubygem aws-sdk-swf
...
Provides: rubygem-aws-sdk-swf = %{version}
Provides: rubygem(aws-sdk-swf) = %{version}
Obsoletes: rubygem-aws-sdk-swf < %{version}
Obsoletes: rubygem(aws-sdk-swf) < %{version}
...
gem install --install-dir %{buildroot}/%{gem_dir} --bindir %{buildroot}/%{_bindir} --force --no-rdoc --no-ri --no-doc --ignore-dependencies aws-sdk-swf -v %{version}
