...
%global gem_name aws-sdk-sagemakerruntime
Name: rubygem%{alinux_ruby}-aws-sdk-sagemakerruntime
Version: 1.0.0
Release: 1.%{dist}
Summary: rubygem aws-sdk-sagemakerruntime
...
Provides: rubygem%{alinux_ruby}-aws-sdk-sagemakerruntime = %{version}
Provides: rubygem%{alinux_ruby}(aws-sdk-sagemakerruntime) = %{version}
Obsoletes: rubygem%{alinux_ruby}-aws-sdk-sagemakerruntime < %{version}
Obsoletes: rubygem%{alinux_ruby}(aws-sdk-sagemakerruntime) < %{version}
...
%description
Official AWS Ruby gem for Amazon SageMaker Runtime. This gem is part of the AWS SDK for Ruby.
