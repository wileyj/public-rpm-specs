...
Name: rubygem%{alinux_ruby}-aws-sdk-codedeploy
Version: 1.2.0
Release: 1.%{dist}
...
Provides: rubygem%{alinux_ruby}-aws-sdk-codedeploy = %{version}
Provides: rubygem%{alinux_ruby}(aws-sdk-codedeploy) = %{version}
Obsoletes: rubygem%{alinux_ruby}-aws-sdk-codedeploy < %{version}
Obsoletes: rubygem%{alinux_ruby}(aws-sdk-codedeploy) < %{version}
