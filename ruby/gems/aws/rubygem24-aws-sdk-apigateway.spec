...
Name: rubygem%{alinux_ruby}-aws-sdk-apigateway
Version: 1.9.0
Release: 1.%{dist}
...
Provides: rubygem%{alinux_ruby}-aws-sdk-apigateway = %{version}
Provides: rubygem%{alinux_ruby}(aws-sdk-apigateway) = %{version}
Obsoletes: rubygem%{alinux_ruby}-aws-sdk-apigateway < %{version}
Obsoletes: rubygem%{alinux_ruby}(aws-sdk-apigateway) < %{version}
