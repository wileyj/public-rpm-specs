...
Name: rubygem%{alinux_ruby}-aws-sdk-codecommit
Version: 1.2.0
Release: 1.%{dist}
...
Provides: rubygem%{alinux_ruby}-aws-sdk-codecommit = %{version}
Provides: rubygem%{alinux_ruby}(aws-sdk-codecommit) = %{version}
Obsoletes: rubygem%{alinux_ruby}-aws-sdk-codecommit < %{version}
Obsoletes: rubygem%{alinux_ruby}(aws-sdk-codecommit) < %{version}
