...
%global gem_name aws-sdk-codestar
Name: rubygem-aws-sdk-codestar
Version: 1.1.0
Release: 1.%{dist}
Summary: rubygem aws-sdk-codestar
...
Provides: rubygem-aws-sdk-codestar = %{version}
Provides: rubygem(aws-sdk-codestar) = %{version}
Obsoletes: rubygem-aws-sdk-codestar < %{version}
Obsoletes: rubygem(aws-sdk-codestar) < %{version}
...
%description
Official AWS Ruby gem for AWS CodeStar (CodeStar). This gem is part of the AWS SDK for Ruby.

%prep
%build
%install
export CONFIGURE_ARGS="--with-cflags='%{optflags}'"
gem install --install-dir %{buildroot}/%{gem_dir} --bindir %{buildroot}/%{_bindir} --force --no-rdoc --no-ri --no-doc --ignore-dependencies aws-sdk-codestar -v %{version}
