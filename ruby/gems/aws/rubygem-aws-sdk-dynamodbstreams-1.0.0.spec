...
%global gem_name aws-sdk-dynamodbstreams
Name: rubygem-aws-sdk-dynamodbstreams
Version: 1.0.0
Release: 1.%{dist}
Summary: rubygem aws-sdk-dynamodbstreams
...
Provides: rubygem-aws-sdk-dynamodbstreams = %{version}
Provides: rubygem(aws-sdk-dynamodbstreams) = %{version}
Obsoletes: rubygem-aws-sdk-dynamodbstreams < %{version}
Obsoletes: rubygem(aws-sdk-dynamodbstreams) < %{version}
...
gem install --install-dir %{buildroot}/%{gem_dir} --bindir %{buildroot}/%{_bindir} --force --no-rdoc --no-ri --no-doc --ignore-dependencies aws-sdk-dynamodbstreams -v %{version}
