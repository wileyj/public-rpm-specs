...
%global gem_name aws-sdk-costandusagereportservice
Name: rubygem-aws-sdk-costandusagereportservice
Version: 1.0.0
Release: 1.%{dist}
...
Provides: rubygem-aws-sdk-costandusagereportservice = %{version}
Provides: rubygem(aws-sdk-costandusagereportservice) = %{version}
Obsoletes: rubygem-aws-sdk-costandusagereportservice < %{version}
Obsoletes: rubygem(aws-sdk-costandusagereportservice) < %{version}
...
%description
Official AWS Ruby gem for AWS Cost and Usage Report Service. This gem is part of the AWS SDK for Ruby.

%prep
%build
%install
export CONFIGURE_ARGS="--with-cflags='%{optflags}'"
gem install --install-dir %{buildroot}/%{gem_dir} --bindir %{buildroot}/%{_bindir} --force --no-rdoc --no-ri --no-doc --ignore-dependencies aws-sdk-costandusagereportservice -v %{version}
