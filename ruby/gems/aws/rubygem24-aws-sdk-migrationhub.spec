...
Name: rubygem%{alinux_ruby}-aws-sdk-migrationhub
Version: 1.0.0
Release: 1.%{dist}
...
Provides: rubygem%{alinux_ruby}-aws-sdk-migrationhub = %{version}
Provides: rubygem%{alinux_ruby}(aws-sdk-migrationhub) = %{version}
Obsoletes: rubygem%{alinux_ruby}-aws-sdk-migrationhub < %{version}
Obsoletes: rubygem%{alinux_ruby}(aws-sdk-migrationhub) < %{version}
