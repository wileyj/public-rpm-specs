...
%global gem_name aws-sdk-acm
Name: rubygem-aws-sdk-acm
Version: 1.2.0
Release: 1.%{dist}
Summary: rubygem aws-sdk-acm
...
Provides: rubygem-aws-sdk-acm = %{version}
Provides: rubygem(aws-sdk-acm) = %{version}
Obsoletes: rubygem-aws-sdk-acm < %{version}
Obsoletes: rubygem(aws-sdk-acm) < %{version}
...
gem install --install-dir %{buildroot}/%{gem_dir} --bindir %{buildroot}/%{_bindir} --force --no-rdoc --no-ri --no-doc --ignore-dependencies aws-sdk-acm -v %{version}
