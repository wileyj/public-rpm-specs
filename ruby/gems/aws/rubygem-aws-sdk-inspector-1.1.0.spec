...
%global gem_name aws-sdk-inspector
Name: rubygem-aws-sdk-inspector
Version: 1.1.0
Release: 1.%{dist}
Summary: rubygem aws-sdk-inspector
...
Provides: rubygem-aws-sdk-inspector = %{version}
Provides: rubygem(aws-sdk-inspector) = %{version}
Obsoletes: rubygem-aws-sdk-inspector < %{version}
Obsoletes: rubygem(aws-sdk-inspector) < %{version}
...
%description
Official AWS Ruby gem for Amazon Inspector. This gem is part of the AWS SDK for Ruby.

%prep
%build
%install
export CONFIGURE_ARGS="--with-cflags='%{optflags}'"
gem install --install-dir %{buildroot}/%{gem_dir} --bindir %{buildroot}/%{_bindir} --force --no-rdoc --no-ri --no-doc --ignore-dependencies aws-sdk-inspector -v %{version}
