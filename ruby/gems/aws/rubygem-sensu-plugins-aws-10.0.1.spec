...
Name: rubygem-sensu-plugins-aws
Version: 10.0.1
Release: 1.%{dist}
...
Provides: rubygem-sensu-plugins-aws = %{version}
Provides: rubygem(sensu-plugins-aws) = %{version}
Obsoletes: rubygem-sensu-plugins-aws < %{version}
Obsoletes: rubygem(sensu-plugins-aws) < %{version}


Requires: rubygem-aws-sdk   = 2.10
Requires: rubygem-aws-sdk-v1   = 1.66.0
Requires: rubygem-erubis   = 2.7.0
Requires: rubygem-fog   = 1.32.0
Requires: rubygem-fog-core   = 1.43.0
Requires: rubygem-rest-client   = 1.8.0
Requires: rubygem-right_aws   = 3.1.0
...
gem install --install-dir %{buildroot}/%{gem_dir} --bindir %{buildroot}/%{_bindir} --force --no-rdoc --no-ri --no-doc --ignore-dependencies sensu-plugins-aws -v %{version}
(
    cd %{buildroot}
