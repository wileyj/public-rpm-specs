...
%global gem_name aws-sdk-importexport
Name: rubygem-aws-sdk-importexport
Version: 1.0.0
Release: 1.%{dist}
Summary: rubygem aws-sdk-importexport
...
Provides: rubygem-aws-sdk-importexport = %{version}
Provides: rubygem(aws-sdk-importexport) = %{version}
Obsoletes: rubygem-aws-sdk-importexport < %{version}
Obsoletes: rubygem(aws-sdk-importexport) < %{version}


Requires: rubygem-aws-sdk-core  = 3
Requires: rubygem-aws-sigv2  = 1.0


%description
Official AWS Ruby gem for AWS Import/Export. This gem is part of the AWS SDK for Ruby.

%prep
%build
%install
export CONFIGURE_ARGS="--with-cflags='%{optflags}'"
gem install --install-dir %{buildroot}/%{gem_dir} --bindir %{buildroot}/%{_bindir} --force --no-rdoc --no-ri --no-doc --ignore-dependencies aws-sdk-importexport -v %{version}
