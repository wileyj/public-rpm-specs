...
%global gem_name aws-sdk-mediastore
Name: rubygem%{alinux_ruby}-aws-sdk-mediastore
Version: 1.0.0
Release: 1.%{dist}
Summary: rubygem aws-sdk-mediastore
...
Provides: rubygem%{alinux_ruby}-aws-sdk-mediastore = %{version}
Provides: rubygem%{alinux_ruby}(aws-sdk-mediastore) = %{version}
Obsoletes: rubygem%{alinux_ruby}-aws-sdk-mediastore < %{version}
Obsoletes: rubygem%{alinux_ruby}(aws-sdk-mediastore) < %{version}
