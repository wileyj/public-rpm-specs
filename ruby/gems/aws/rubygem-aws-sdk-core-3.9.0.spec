...
Provides: rubygem-aws-sdk-core = %{version}
Provides: rubygem(aws-sdk-core) = %{version}
Obsoletes: rubygem-aws-sdk-core < %{version}
Obsoletes: rubygem(aws-sdk-core) < %{version}
...
gem install --install-dir %{buildroot}/%{gem_dir} --bindir %{buildroot}/%{_bindir} --force --no-rdoc --no-ri --no-doc --ignore-dependencies aws-sdk-core -v %{version}
