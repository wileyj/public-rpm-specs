...
%global gem_name aws-sdk-budgets
Name: rubygem%{alinux_ruby}-aws-sdk-budgets
Version: 1.3.0
Release: 1.%{dist}
...
Provides: rubygem%{alinux_ruby}-aws-sdk-budgets = %{version}
Provides: rubygem%{alinux_ruby}(aws-sdk-budgets) = %{version}
Obsoletes: rubygem%{alinux_ruby}-aws-sdk-budgets < %{version}
Obsoletes: rubygem%{alinux_ruby}(aws-sdk-budgets) < %{version}
