...
%global gem_name aws-sdk-cloudwatch
Name: rubygem-aws-sdk-cloudwatch
Version: 1.2.0
Release: 1.%{dist}
...
Provides: rubygem-aws-sdk-cloudwatch = %{version}
Provides: rubygem(aws-sdk-cloudwatch) = %{version}
Obsoletes: rubygem-aws-sdk-cloudwatch < %{version}
Obsoletes: rubygem(aws-sdk-cloudwatch) < %{version}
...
gem install --install-dir %{buildroot}/%{gem_dir} --bindir %{buildroot}/%{_bindir} --force --no-rdoc --no-ri --no-doc --ignore-dependencies aws-sdk-cloudwatch -v %{version}
