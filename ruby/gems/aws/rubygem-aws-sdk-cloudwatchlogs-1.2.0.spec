...
%global gem_name aws-sdk-cloudwatchlogs
Name: rubygem-aws-sdk-cloudwatchlogs
Version: 1.2.0
Release: 1.%{dist}
...
Provides: rubygem-aws-sdk-cloudwatchlogs = %{version}
Provides: rubygem(aws-sdk-cloudwatchlogs) = %{version}
Obsoletes: rubygem-aws-sdk-cloudwatchlogs < %{version}
Obsoletes: rubygem(aws-sdk-cloudwatchlogs) < %{version}
...
gem install --install-dir %{buildroot}/%{gem_dir} --bindir %{buildroot}/%{_bindir} --force --no-rdoc --no-ri --no-doc --ignore-dependencies aws-sdk-cloudwatchlogs -v %{version}
