...
%global gem_name aws-sdk-clouddirectory
Name: rubygem-aws-sdk-clouddirectory
Version: 1.0.0
Release: 1.%{dist}
Summary: rubygem aws-sdk-clouddirectory
...
Provides: rubygem-aws-sdk-clouddirectory = %{version}
Provides: rubygem(aws-sdk-clouddirectory) = %{version}
Obsoletes: rubygem-aws-sdk-clouddirectory < %{version}
Obsoletes: rubygem(aws-sdk-clouddirectory) < %{version}
...
gem install --install-dir %{buildroot}/%{gem_dir} --bindir %{buildroot}/%{_bindir} --force --no-rdoc --no-ri --no-doc --ignore-dependencies aws-sdk-clouddirectory -v %{version}
