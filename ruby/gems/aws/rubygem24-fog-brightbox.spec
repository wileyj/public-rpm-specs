...
Name: rubygem%{alinux_ruby}-fog-brightbox
Version: 0.14.0
Release: 1.%{dist}
...
Provides: rubygem%{alinux_ruby}-fog-brightbox = %{version}
Provides: rubygem%{alinux_ruby}(fog-brightbox) = %{version}
Obsoletes: rubygem%{alinux_ruby}-fog-brightbox < %{version}
Obsoletes: rubygem%{alinux_ruby}(fog-brightbox) < %{version}


Requires: rubygem%{alinux_ruby}-fog-core  = 1.22
Requires: rubygem%{alinux_ruby}-fog-json
Requires: rubygem%{alinux_ruby}-inflecto  = 0.0.2
