...
Name: rubygem-fog-storm_on_demand
Version: 0.1.1
Release: 1.%{dist}
Summary: rubygem fog-storm_on_demand
...
Provides: rubygem-fog-storm_on_demand = %{version}
Provides: rubygem(fog-storm_on_demand) = %{version}
Obsoletes: rubygem-fog-storm_on_demand < %{version}
Obsoletes: rubygem(fog-storm_on_demand) < %{version}
...
gem install --install-dir %{buildroot}/%{gem_dir} --bindir %{buildroot}/%{_bindir} --force --no-rdoc --no-ri --no-doc --ignore-dependencies fog-storm_on_demand -v %{version}
