...
%global gem_name aws-sdk-kinesisvideo
Name: rubygem%{alinux_ruby}-aws-sdk-kinesisvideo
Version: 1.0.0
Release: 1.%{dist}
Summary: rubygem aws-sdk-kinesisvideo
...
Provides: rubygem%{alinux_ruby}-aws-sdk-kinesisvideo = %{version}
Provides: rubygem%{alinux_ruby}(aws-sdk-kinesisvideo) = %{version}
Obsoletes: rubygem%{alinux_ruby}-aws-sdk-kinesisvideo < %{version}
Obsoletes: rubygem%{alinux_ruby}(aws-sdk-kinesisvideo) < %{version}
