...
%global gem_name aws-sdk-cognitosync
Name: rubygem-aws-sdk-cognitosync
Version: 1.0.0
Release: 1.%{dist}
Summary: rubygem aws-sdk-cognitosync
...
Provides: rubygem-aws-sdk-cognitosync = %{version}
Provides: rubygem(aws-sdk-cognitosync) = %{version}
Obsoletes: rubygem-aws-sdk-cognitosync < %{version}
Obsoletes: rubygem(aws-sdk-cognitosync) < %{version}
...
gem install --install-dir %{buildroot}/%{gem_dir} --bindir %{buildroot}/%{_bindir} --force --no-rdoc --no-ri --no-doc --ignore-dependencies aws-sdk-cognitosync -v %{version}
