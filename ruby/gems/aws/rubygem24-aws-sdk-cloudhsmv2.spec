...
Name: rubygem%{alinux_ruby}-aws-sdk-cloudhsmv2
Version: 1.1.0
Release: 1.%{dist}
...
Provides: rubygem%{alinux_ruby}-aws-sdk-cloudhsmv2 = %{version}
Provides: rubygem%{alinux_ruby}(aws-sdk-cloudhsmv2) = %{version}
Obsoletes: rubygem%{alinux_ruby}-aws-sdk-cloudhsmv2 < %{version}
Obsoletes: rubygem%{alinux_ruby}(aws-sdk-cloudhsmv2) < %{version}
