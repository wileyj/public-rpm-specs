...
%global gem_name aws-sdk-sagemaker
Name: rubygem%{alinux_ruby}-aws-sdk-sagemaker
Version: 1.4.0
Release: 1.%{dist}
Summary: rubygem aws-sdk-sagemaker
...
Provides: rubygem%{alinux_ruby}-aws-sdk-sagemaker = %{version}
Provides: rubygem%{alinux_ruby}(aws-sdk-sagemaker) = %{version}
Obsoletes: rubygem%{alinux_ruby}-aws-sdk-sagemaker < %{version}
Obsoletes: rubygem%{alinux_ruby}(aws-sdk-sagemaker) < %{version}
