...
%global gem_name aws-sdk-servicediscovery
Name: rubygem%{alinux_ruby}-aws-sdk-servicediscovery
Version: 1.0.0
Release: 1.%{dist}
Summary: rubygem aws-sdk-servicediscovery
...
Provides: rubygem%{alinux_ruby}-aws-sdk-servicediscovery = %{version}
Provides: rubygem%{alinux_ruby}(aws-sdk-servicediscovery) = %{version}
Obsoletes: rubygem%{alinux_ruby}-aws-sdk-servicediscovery < %{version}
Obsoletes: rubygem%{alinux_ruby}(aws-sdk-servicediscovery) < %{version}
...
%description
Official AWS Ruby gem for Amazon Route 53 Auto Naming (ServiceDiscovery). This gem is part of the AWS SDK for Ruby.
