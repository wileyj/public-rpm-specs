...
%global gem_name aws-sdk-configservice
Name: rubygem-aws-sdk-configservice
Version: 1.4.0
Release: 1.%{dist}
...
Provides: rubygem-aws-sdk-configservice = %{version}
Provides: rubygem(aws-sdk-configservice) = %{version}
Obsoletes: rubygem-aws-sdk-configservice < %{version}
Obsoletes: rubygem(aws-sdk-configservice) < %{version}
...
%description
Official AWS Ruby gem for AWS Config (Config Service). This gem is part of the AWS SDK for Ruby.

%prep
%build
%install
export CONFIGURE_ARGS="--with-cflags='%{optflags}'"
gem install --install-dir %{buildroot}/%{gem_dir} --bindir %{buildroot}/%{_bindir} --force --no-rdoc --no-ri --no-doc --ignore-dependencies aws-sdk-configservice -v %{version}
