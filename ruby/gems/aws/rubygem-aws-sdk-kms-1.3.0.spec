...
Provides: rubygem-aws-sdk-kms = %{version}
Provides: rubygem(aws-sdk-kms) = %{version}
Obsoletes: rubygem-aws-sdk-kms < %{version}
Obsoletes: rubygem(aws-sdk-kms) < %{version}
...
gem install --install-dir %{buildroot}/%{gem_dir} --bindir %{buildroot}/%{_bindir} --force --no-rdoc --no-ri --no-doc --ignore-dependencies aws-sdk-kms -v %{version}
