...
Name: rubygem%{alinux_ruby}-aws-sdk-servicecatalog
Version: 1.2.0
Release: 1.%{dist}
...
Provides: rubygem%{alinux_ruby}-aws-sdk-servicecatalog = %{version}
Provides: rubygem%{alinux_ruby}(aws-sdk-servicecatalog) = %{version}
Obsoletes: rubygem%{alinux_ruby}-aws-sdk-servicecatalog < %{version}
Obsoletes: rubygem%{alinux_ruby}(aws-sdk-servicecatalog) < %{version}
