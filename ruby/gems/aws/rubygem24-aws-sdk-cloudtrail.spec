...
Name: rubygem%{alinux_ruby}-aws-sdk-cloudtrail
Version: 1.0.0
Release: 1.%{dist}
...
Provides: rubygem%{alinux_ruby}-aws-sdk-cloudtrail = %{version}
Provides: rubygem%{alinux_ruby}(aws-sdk-cloudtrail) = %{version}
Obsoletes: rubygem%{alinux_ruby}-aws-sdk-cloudtrail < %{version}
Obsoletes: rubygem%{alinux_ruby}(aws-sdk-cloudtrail) < %{version}
