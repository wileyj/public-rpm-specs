...
Name: rubygem%{alinux_ruby}-aws-sdk-clouddirectory
Version: 1.1.0
Release: 1.%{dist}
...
Provides: rubygem%{alinux_ruby}-aws-sdk-clouddirectory = %{version}
Provides: rubygem%{alinux_ruby}(aws-sdk-clouddirectory) = %{version}
Obsoletes: rubygem%{alinux_ruby}-aws-sdk-clouddirectory < %{version}
Obsoletes: rubygem%{alinux_ruby}(aws-sdk-clouddirectory) < %{version}
