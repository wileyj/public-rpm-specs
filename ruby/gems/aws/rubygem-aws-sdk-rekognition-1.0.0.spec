...
%global gem_name aws-sdk-rekognition
Name: rubygem-aws-sdk-rekognition
Version: 1.0.0
Release: 1.%{dist}
Summary: rubygem aws-sdk-rekognition
...
Provides: rubygem-aws-sdk-rekognition = %{version}
Provides: rubygem(aws-sdk-rekognition) = %{version}
Obsoletes: rubygem-aws-sdk-rekognition < %{version}
Obsoletes: rubygem(aws-sdk-rekognition) < %{version}
...
gem install --install-dir %{buildroot}/%{gem_dir} --bindir %{buildroot}/%{_bindir} --force --no-rdoc --no-ri --no-doc --ignore-dependencies aws-sdk-rekognition -v %{version}
(
    cd %{buildroot}
