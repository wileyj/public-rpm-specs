...
Name: rubygem%{alinux_ruby}-aws-sdk-costexplorer
Version: 1.0.0
Release: 1.%{dist}
...
Provides: rubygem%{alinux_ruby}-aws-sdk-costexplorer = %{version}
Provides: rubygem%{alinux_ruby}(aws-sdk-costexplorer) = %{version}
Obsoletes: rubygem%{alinux_ruby}-aws-sdk-costexplorer < %{version}
Obsoletes: rubygem%{alinux_ruby}(aws-sdk-costexplorer) < %{version}
