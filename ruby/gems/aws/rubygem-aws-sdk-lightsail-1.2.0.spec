...
%global gem_name aws-sdk-lightsail
Name: rubygem-aws-sdk-lightsail
Version: 1.2.0
Release: 1.%{dist}
Summary: rubygem aws-sdk-lightsail
...
Provides: rubygem-aws-sdk-lightsail = %{version}
Provides: rubygem(aws-sdk-lightsail) = %{version}
Obsoletes: rubygem-aws-sdk-lightsail < %{version}
Obsoletes: rubygem(aws-sdk-lightsail) < %{version}
...
gem install --install-dir %{buildroot}/%{gem_dir} --bindir %{buildroot}/%{_bindir} --force --no-rdoc --no-ri --no-doc --ignore-dependencies aws-sdk-lightsail -v %{version}
