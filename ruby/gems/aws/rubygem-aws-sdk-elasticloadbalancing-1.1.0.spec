...
%global gem_name aws-sdk-elasticloadbalancing
Name: rubygem-aws-sdk-elasticloadbalancing
Version: 1.1.0
Release: 1.%{dist}
...
Provides: rubygem-aws-sdk-elasticloadbalancing = %{version}
Provides: rubygem(aws-sdk-elasticloadbalancing) = %{version}
Obsoletes: rubygem-aws-sdk-elasticloadbalancing < %{version}
Obsoletes: rubygem(aws-sdk-elasticloadbalancing) < %{version}
...
gem install --install-dir %{buildroot}/%{gem_dir} --bindir %{buildroot}/%{_bindir} --force --no-rdoc --no-ri --no-doc --ignore-dependencies aws-sdk-elasticloadbalancing -v %{version}
