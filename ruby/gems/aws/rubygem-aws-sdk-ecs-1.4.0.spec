...
%global gem_name aws-sdk-ecs
Name: rubygem-aws-sdk-ecs
Version: 1.4.0
Release: 1.%{dist}
...
Provides: rubygem-aws-sdk-ecs = %{version}
Provides: rubygem(aws-sdk-ecs) = %{version}
Obsoletes: rubygem-aws-sdk-ecs < %{version}
Obsoletes: rubygem(aws-sdk-ecs) < %{version}
...
gem install --install-dir %{buildroot}/%{gem_dir} --bindir %{buildroot}/%{_bindir} --force --no-rdoc --no-ri --no-doc --ignore-dependencies aws-sdk-ecs -v %{version}
