...
Name: rubygem%{alinux_ruby}-aws-sdk-marketplacemetering
Version: 1.0.0
Release: 1.%{dist}
...
Provides: rubygem%{alinux_ruby}-aws-sdk-marketplacemetering = %{version}
Provides: rubygem%{alinux_ruby}(aws-sdk-marketplacemetering) = %{version}
Obsoletes: rubygem%{alinux_ruby}-aws-sdk-marketplacemetering < %{version}
Obsoletes: rubygem%{alinux_ruby}(aws-sdk-marketplacemetering) < %{version}
