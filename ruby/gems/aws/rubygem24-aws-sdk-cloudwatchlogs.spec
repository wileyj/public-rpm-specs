...
Name: rubygem%{alinux_ruby}-aws-sdk-cloudwatchlogs
Version: 1.2.0
Release: 1.%{dist}
...
Provides: rubygem%{alinux_ruby}-aws-sdk-cloudwatchlogs = %{version}
Provides: rubygem%{alinux_ruby}(aws-sdk-cloudwatchlogs) = %{version}
Obsoletes: rubygem%{alinux_ruby}-aws-sdk-cloudwatchlogs < %{version}
Obsoletes: rubygem%{alinux_ruby}(aws-sdk-cloudwatchlogs) < %{version}
