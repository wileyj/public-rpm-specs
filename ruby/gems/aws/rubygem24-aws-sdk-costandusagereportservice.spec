...
Name: rubygem%{alinux_ruby}-aws-sdk-costandusagereportservice
Version: 1.0.0
Release: 1.%{dist}
...
Provides: rubygem%{alinux_ruby}-aws-sdk-costandusagereportservice = %{version}
Provides: rubygem%{alinux_ruby}(aws-sdk-costandusagereportservice) = %{version}
Obsoletes: rubygem%{alinux_ruby}-aws-sdk-costandusagereportservice < %{version}
Obsoletes: rubygem%{alinux_ruby}(aws-sdk-costandusagereportservice) < %{version}
