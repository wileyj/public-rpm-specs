...
Provides: rubygem-aws-sdk-greengrass = %{version}
Provides: rubygem(aws-sdk-greengrass) = %{version}
Obsoletes: rubygem-aws-sdk-greengrass < %{version}
Obsoletes: rubygem(aws-sdk-greengrass) < %{version}
...
gem install --install-dir %{buildroot}/%{gem_dir} --bindir %{buildroot}/%{_bindir} --force --no-rdoc --no-ri --no-doc --ignore-dependencies aws-sdk-greengrass -v %{version}
