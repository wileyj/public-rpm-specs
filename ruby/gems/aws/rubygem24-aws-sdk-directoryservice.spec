...
%global gem_name aws-sdk-directoryservice
Name: rubygem%{alinux_ruby}-aws-sdk-directoryservice
Version: 1.0.0
Release: 1.%{dist}
Summary: rubygem aws-sdk-directoryservice
...
Provides: rubygem%{alinux_ruby}-aws-sdk-directoryservice = %{version}
Provides: rubygem%{alinux_ruby}(aws-sdk-directoryservice) = %{version}
Obsoletes: rubygem%{alinux_ruby}-aws-sdk-directoryservice < %{version}
Obsoletes: rubygem%{alinux_ruby}(aws-sdk-directoryservice) < %{version}
...
%description
Official AWS Ruby gem for AWS Directory Service (Directory Service). This gem is part of the AWS SDK for Ruby.
