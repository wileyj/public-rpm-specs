...
Name: rubygem%{alinux_ruby}-aws-sdk-marketplaceentitlementservice
Version: 1.0.0
Release: 1.%{dist}
...
Provides: rubygem%{alinux_ruby}-aws-sdk-marketplaceentitlementservice = %{version}
Provides: rubygem%{alinux_ruby}(aws-sdk-marketplaceentitlementservice) = %{version}
Obsoletes: rubygem%{alinux_ruby}-aws-sdk-marketplaceentitlementservice < %{version}
Obsoletes: rubygem%{alinux_ruby}(aws-sdk-marketplaceentitlementservice) < %{version}
