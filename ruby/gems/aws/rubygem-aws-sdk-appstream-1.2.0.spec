...
%global gem_name aws-sdk-appstream
Name: rubygem-aws-sdk-appstream
Version: 1.2.0
Release: 1.%{dist}
Summary: rubygem aws-sdk-appstream
...
Provides: rubygem-aws-sdk-appstream = %{version}
Provides: rubygem(aws-sdk-appstream) = %{version}
Obsoletes: rubygem-aws-sdk-appstream < %{version}
Obsoletes: rubygem(aws-sdk-appstream) < %{version}
...
gem install --install-dir %{buildroot}/%{gem_dir} --bindir %{buildroot}/%{_bindir} --force --no-rdoc --no-ri --no-doc --ignore-dependencies aws-sdk-appstream -v %{version}
