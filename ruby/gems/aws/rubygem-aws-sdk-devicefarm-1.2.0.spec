...
%global gem_name aws-sdk-devicefarm
Name: rubygem-aws-sdk-devicefarm
Version: 1.2.0
Release: 1.%{dist}
Summary: rubygem aws-sdk-devicefarm
...
Provides: rubygem-aws-sdk-devicefarm = %{version}
Provides: rubygem(aws-sdk-devicefarm) = %{version}
Obsoletes: rubygem-aws-sdk-devicefarm < %{version}
Obsoletes: rubygem(aws-sdk-devicefarm) < %{version}
...
%description
Official AWS Ruby gem for AWS Device Farm. This gem is part of the AWS SDK for Ruby.

%prep
%build
%install
export CONFIGURE_ARGS="--with-cflags='%{optflags}'"
gem install --install-dir %{buildroot}/%{gem_dir} --bindir %{buildroot}/%{_bindir} --force --no-rdoc --no-ri --no-doc --ignore-dependencies aws-sdk-devicefarm -v %{version}
