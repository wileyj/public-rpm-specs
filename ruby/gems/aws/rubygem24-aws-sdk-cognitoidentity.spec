...
Name: rubygem%{alinux_ruby}-aws-sdk-cognitoidentity
Version: 1.0.0
Release: 1.%{dist}
...
Provides: rubygem%{alinux_ruby}-aws-sdk-cognitoidentity = %{version}
Provides: rubygem%{alinux_ruby}(aws-sdk-cognitoidentity) = %{version}
Obsoletes: rubygem%{alinux_ruby}-aws-sdk-cognitoidentity < %{version}
Obsoletes: rubygem%{alinux_ruby}(aws-sdk-cognitoidentity) < %{version}
