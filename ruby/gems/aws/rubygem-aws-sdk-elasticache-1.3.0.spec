...
%global gem_name aws-sdk-elasticache
Name: rubygem-aws-sdk-elasticache
Version: 1.3.0
Release: 1.%{dist}
...
Provides: rubygem-aws-sdk-elasticache = %{version}
Provides: rubygem(aws-sdk-elasticache) = %{version}
Obsoletes: rubygem-aws-sdk-elasticache < %{version}
Obsoletes: rubygem(aws-sdk-elasticache) < %{version}
...
gem install --install-dir %{buildroot}/%{gem_dir} --bindir %{buildroot}/%{_bindir} --force --no-rdoc --no-ri --no-doc --ignore-dependencies aws-sdk-elasticache -v %{version}
