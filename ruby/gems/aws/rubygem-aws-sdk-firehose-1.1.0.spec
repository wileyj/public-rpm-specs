...
%global gem_name aws-sdk-firehose
Name: rubygem-aws-sdk-firehose
Version: 1.1.0
Release: 1.%{dist}
...
Provides: rubygem-aws-sdk-firehose = %{version}
Provides: rubygem(aws-sdk-firehose) = %{version}
Obsoletes: rubygem-aws-sdk-firehose < %{version}
Obsoletes: rubygem(aws-sdk-firehose) < %{version}
...
gem install --install-dir %{buildroot}/%{gem_dir} --bindir %{buildroot}/%{_bindir} --force --no-rdoc --no-ri --no-doc --ignore-dependencies aws-sdk-firehose -v %{version}
