...
Name: rubygem%{alinux_ruby}-aws-sdk-cloudsearchdomain
Version: 1.0.0
Release: 1.%{dist}
...
Provides: rubygem%{alinux_ruby}-aws-sdk-cloudsearchdomain = %{version}
Provides: rubygem%{alinux_ruby}(aws-sdk-cloudsearchdomain) = %{version}
Obsoletes: rubygem%{alinux_ruby}-aws-sdk-cloudsearchdomain < %{version}
Obsoletes: rubygem%{alinux_ruby}(aws-sdk-cloudsearchdomain) < %{version}
