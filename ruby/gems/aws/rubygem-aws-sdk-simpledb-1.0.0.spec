...
%global gem_name aws-sdk-simpledb
Name: rubygem-aws-sdk-simpledb
Version: 1.0.0
Release: 1.%{dist}
...
Provides: rubygem-aws-sdk-simpledb = %{version}
Provides: rubygem(aws-sdk-simpledb) = %{version}
Obsoletes: rubygem-aws-sdk-simpledb < %{version}
Obsoletes: rubygem(aws-sdk-simpledb) < %{version}
...
gem install --install-dir %{buildroot}/%{gem_dir} --bindir %{buildroot}/%{_bindir} --force --no-rdoc --no-ri --no-doc --ignore-dependencies aws-sdk-simpledb -v %{version}
