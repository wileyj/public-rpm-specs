...
%global gem_name aws-sdk-migrationhub
Name: rubygem-aws-sdk-migrationhub
Version: 1.0.0
Release: 1.%{dist}
Summary: rubygem aws-sdk-migrationhub
...
Provides: rubygem-aws-sdk-migrationhub = %{version}
Provides: rubygem(aws-sdk-migrationhub) = %{version}
Obsoletes: rubygem-aws-sdk-migrationhub < %{version}
Obsoletes: rubygem(aws-sdk-migrationhub) < %{version}
...
gem install --install-dir %{buildroot}/%{gem_dir} --bindir %{buildroot}/%{_bindir} --force --no-rdoc --no-ri --no-doc --ignore-dependencies aws-sdk-migrationhub -v %{version}
