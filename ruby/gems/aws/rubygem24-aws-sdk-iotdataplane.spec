...
Name: rubygem%{alinux_ruby}-aws-sdk-iotdataplane
Version: 1.0.0
Release: 1.%{dist}
...
Provides: rubygem%{alinux_ruby}-aws-sdk-iotdataplane = %{version}
Provides: rubygem%{alinux_ruby}(aws-sdk-iotdataplane) = %{version}
Obsoletes: rubygem%{alinux_ruby}-aws-sdk-iotdataplane < %{version}
Obsoletes: rubygem%{alinux_ruby}(aws-sdk-iotdataplane) < %{version}
