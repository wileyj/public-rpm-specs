...
%global gem_name aws-sdk-route53
Name: rubygem-aws-sdk-route53
Version: 1.5.0
Release: 1.%{dist}
...
Provides: rubygem-aws-sdk-route53 = %{version}
Provides: rubygem(aws-sdk-route53) = %{version}
Obsoletes: rubygem-aws-sdk-route53 < %{version}
Obsoletes: rubygem(aws-sdk-route53) < %{version}
...
gem install --install-dir %{buildroot}/%{gem_dir} --bindir %{buildroot}/%{_bindir} --force --no-rdoc --no-ri --no-doc --ignore-dependencies aws-sdk-route53 -v %{version}
