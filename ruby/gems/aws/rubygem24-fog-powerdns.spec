...
Name: rubygem%{alinux_ruby}-fog-powerdns
Version: 0.1.1
Release: 1.%{dist}
...
Provides: rubygem%{alinux_ruby}-fog-powerdns = %{version}
Provides: rubygem%{alinux_ruby}(fog-powerdns) = %{version}
Obsoletes: rubygem%{alinux_ruby}-fog-powerdns < %{version}
Obsoletes: rubygem%{alinux_ruby}(fog-powerdns) < %{version}


Requires: rubygem%{alinux_ruby}-fog-core  = 1.27
Requires: rubygem%{alinux_ruby}-fog-json  = 1.0
Requires: rubygem%{alinux_ruby}-fog-xml  = 0.1
