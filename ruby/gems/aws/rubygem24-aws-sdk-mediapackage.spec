...
%global gem_name aws-sdk-mediapackage
Name: rubygem%{alinux_ruby}-aws-sdk-mediapackage
Version: 1.0.0
Release: 1.%{dist}
Summary: rubygem aws-sdk-mediapackage
...
Provides: rubygem%{alinux_ruby}-aws-sdk-mediapackage = %{version}
Provides: rubygem%{alinux_ruby}(aws-sdk-mediapackage) = %{version}
Obsoletes: rubygem%{alinux_ruby}-aws-sdk-mediapackage < %{version}
Obsoletes: rubygem%{alinux_ruby}(aws-sdk-mediapackage) < %{version}
...
%description
Official AWS Ruby gem for AWS Elemental MediaPackage (MediaPackage). This gem is part of the AWS SDK for Ruby.
