...
Name: rubygem%{alinux_ruby}-aws-sdk-workspaces
Version: 1.0.0
Release: 1.%{dist}
...
Provides: rubygem%{alinux_ruby}-aws-sdk-workspaces = %{version}
Provides: rubygem%{alinux_ruby}(aws-sdk-workspaces) = %{version}
Obsoletes: rubygem%{alinux_ruby}-aws-sdk-workspaces < %{version}
Obsoletes: rubygem%{alinux_ruby}(aws-sdk-workspaces) < %{version}
