...
%global gem_name aws-sdk-lambda
Name: rubygem-aws-sdk-lambda
Version: 1.0.0
Release: 1.%{dist}
...
Provides: rubygem-aws-sdk-lambda = %{version}
Provides: rubygem(aws-sdk-lambda) = %{version}
Obsoletes: rubygem-aws-sdk-lambda < %{version}
Obsoletes: rubygem(aws-sdk-lambda) < %{version}
...
gem install --install-dir %{buildroot}/%{gem_dir} --bindir %{buildroot}/%{_bindir} --force --no-rdoc --no-ri --no-doc --ignore-dependencies aws-sdk-lambda -v %{version}
