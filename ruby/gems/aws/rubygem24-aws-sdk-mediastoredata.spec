...
%global gem_name aws-sdk-mediastoredata
Name: rubygem%{alinux_ruby}-aws-sdk-mediastoredata
Version: 1.1.0
Release: 1.%{dist}
Summary: rubygem aws-sdk-mediastoredata
...
Provides: rubygem%{alinux_ruby}-aws-sdk-mediastoredata = %{version}
Provides: rubygem%{alinux_ruby}(aws-sdk-mediastoredata) = %{version}
Obsoletes: rubygem%{alinux_ruby}-aws-sdk-mediastoredata < %{version}
Obsoletes: rubygem%{alinux_ruby}(aws-sdk-mediastoredata) < %{version}
