...
%global gem_name aws-sdk-cloudhsmv2
Name: rubygem-aws-sdk-cloudhsmv2
Version: 1.1.0
Release: 1.%{dist}
...
Provides: rubygem-aws-sdk-cloudhsmv2 = %{version}
Provides: rubygem(aws-sdk-cloudhsmv2) = %{version}
Obsoletes: rubygem-aws-sdk-cloudhsmv2 < %{version}
Obsoletes: rubygem(aws-sdk-cloudhsmv2) < %{version}
...
%description
Official AWS Ruby gem for AWS CloudHSM V2 (CloudHSM V2). This gem is part of the AWS SDK for Ruby.

%prep
%build
%install
export CONFIGURE_ARGS="--with-cflags='%{optflags}'"
gem install --install-dir %{buildroot}/%{gem_dir} --bindir %{buildroot}/%{_bindir} --force --no-rdoc --no-ri --no-doc --ignore-dependencies aws-sdk-cloudhsmv2 -v %{version}
