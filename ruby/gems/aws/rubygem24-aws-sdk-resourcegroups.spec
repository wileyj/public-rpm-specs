...
%global gem_name aws-sdk-resourcegroups
Name: rubygem%{alinux_ruby}-aws-sdk-resourcegroups
Version: 1.0.0
Release: 1.%{dist}
Summary: rubygem aws-sdk-resourcegroups
...
Provides: rubygem%{alinux_ruby}-aws-sdk-resourcegroups = %{version}
Provides: rubygem%{alinux_ruby}(aws-sdk-resourcegroups) = %{version}
Obsoletes: rubygem%{alinux_ruby}-aws-sdk-resourcegroups < %{version}
Obsoletes: rubygem%{alinux_ruby}(aws-sdk-resourcegroups) < %{version}
