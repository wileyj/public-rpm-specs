...
%global gem_name aws-sdk-emr
Name: rubygem-aws-sdk-emr
Version: 1.0.0
Release: 1.%{dist}
...
Provides: rubygem-aws-sdk-emr = %{version}
Provides: rubygem(aws-sdk-emr) = %{version}
Obsoletes: rubygem-aws-sdk-emr < %{version}
Obsoletes: rubygem(aws-sdk-emr) < %{version}
...
%description
Official AWS Ruby gem for Amazon Elastic MapReduce (Amazon EMR). This gem is part of the AWS SDK for Ruby.

%prep
%build
%install
export CONFIGURE_ARGS="--with-cflags='%{optflags}'"
gem install --install-dir %{buildroot}/%{gem_dir} --bindir %{buildroot}/%{_bindir} --force --no-rdoc --no-ri --no-doc --ignore-dependencies aws-sdk-emr -v %{version}
(
    cd %{buildroot}
