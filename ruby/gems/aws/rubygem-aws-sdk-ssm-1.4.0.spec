...
%global gem_name aws-sdk-ssm
Name: rubygem-aws-sdk-ssm
Version: 1.4.0
Release: 1.%{dist}
...
Provides: rubygem-aws-sdk-ssm = %{version}
Provides: rubygem(aws-sdk-ssm) = %{version}
Obsoletes: rubygem-aws-sdk-ssm < %{version}
Obsoletes: rubygem(aws-sdk-ssm) < %{version}
...
gem install --install-dir %{buildroot}/%{gem_dir} --bindir %{buildroot}/%{_bindir} --force --no-rdoc --no-ri --no-doc --ignore-dependencies aws-sdk-ssm -v %{version}
