...
%global gem_name aws-sdk-codepipeline
Name: rubygem%{alinux_ruby}-aws-sdk-codepipeline
Version: 1.1.0
Release: 1.%{dist}
...
Provides: rubygem%{alinux_ruby}-aws-sdk-codepipeline = %{version}
Provides: rubygem%{alinux_ruby}(aws-sdk-codepipeline) = %{version}
Obsoletes: rubygem%{alinux_ruby}-aws-sdk-codepipeline < %{version}
Obsoletes: rubygem%{alinux_ruby}(aws-sdk-codepipeline) < %{version}
...
%description
Official AWS Ruby gem for AWS CodePipeline (CodePipeline). This gem is part of the AWS SDK for Ruby.
