...
%global gem_name aws-sdk-marketplacecommerceanalytics
Name: rubygem-aws-sdk-marketplacecommerceanalytics
Version: 1.0.0
Release: 1.%{dist}
Summary: rubygem aws-sdk-marketplacecommerceanalytics
...
Provides: rubygem-aws-sdk-marketplacecommerceanalytics = %{version}
Provides: rubygem(aws-sdk-marketplacecommerceanalytics) = %{version}
Obsoletes: rubygem-aws-sdk-marketplacecommerceanalytics < %{version}
Obsoletes: rubygem(aws-sdk-marketplacecommerceanalytics) < %{version}
...
%description
Official AWS Ruby gem for AWS Marketplace Commerce Analytics. This gem is part of the AWS SDK for Ruby.

%prep
%build
%install
export CONFIGURE_ARGS="--with-cflags='%{optflags}'"
gem install --install-dir %{buildroot}/%{gem_dir} --bindir %{buildroot}/%{_bindir} --force --no-rdoc --no-ri --no-doc --ignore-dependencies aws-sdk-marketplacecommerceanalytics -v %{version}
