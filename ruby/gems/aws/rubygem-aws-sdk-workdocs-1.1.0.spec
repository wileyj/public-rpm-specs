...
%global gem_name aws-sdk-workdocs
Name: rubygem-aws-sdk-workdocs
Version: 1.1.0
Release: 1.%{dist}
Summary: rubygem aws-sdk-workdocs
...
Provides: rubygem-aws-sdk-workdocs = %{version}
Provides: rubygem(aws-sdk-workdocs) = %{version}
Obsoletes: rubygem-aws-sdk-workdocs < %{version}
Obsoletes: rubygem(aws-sdk-workdocs) < %{version}
...
gem install --install-dir %{buildroot}/%{gem_dir} --bindir %{buildroot}/%{_bindir} --force --no-rdoc --no-ri --no-doc --ignore-dependencies aws-sdk-workdocs -v %{version}
