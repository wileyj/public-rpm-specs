...
Name: rubygem%{alinux_ruby}-aws-sdk-inspector
Version: 1.2.0
Release: 1.%{dist}
...
Provides: rubygem%{alinux_ruby}-aws-sdk-inspector = %{version}
Provides: rubygem%{alinux_ruby}(aws-sdk-inspector) = %{version}
Obsoletes: rubygem%{alinux_ruby}-aws-sdk-inspector < %{version}
Obsoletes: rubygem%{alinux_ruby}(aws-sdk-inspector) < %{version}
