...
%global gem_name aws-sdk-gamelift
Name: rubygem-aws-sdk-gamelift
Version: 1.1.0
Release: 1.%{dist}
Summary: rubygem aws-sdk-gamelift
...
Provides: rubygem-aws-sdk-gamelift = %{version}
Provides: rubygem(aws-sdk-gamelift) = %{version}
Obsoletes: rubygem-aws-sdk-gamelift < %{version}
Obsoletes: rubygem(aws-sdk-gamelift) < %{version}
...
gem install --install-dir %{buildroot}/%{gem_dir} --bindir %{buildroot}/%{_bindir} --force --no-rdoc --no-ri --no-doc --ignore-dependencies aws-sdk-gamelift -v %{version}
