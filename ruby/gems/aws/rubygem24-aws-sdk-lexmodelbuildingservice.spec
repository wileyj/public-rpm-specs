...
Name: rubygem%{alinux_ruby}-aws-sdk-lexmodelbuildingservice
Version: 1.3.0
Release: 1.%{dist}
...
Provides: rubygem%{alinux_ruby}-aws-sdk-lexmodelbuildingservice = %{version}
Provides: rubygem%{alinux_ruby}(aws-sdk-lexmodelbuildingservice) = %{version}
Obsoletes: rubygem%{alinux_ruby}-aws-sdk-lexmodelbuildingservice < %{version}
Obsoletes: rubygem%{alinux_ruby}(aws-sdk-lexmodelbuildingservice) < %{version}
