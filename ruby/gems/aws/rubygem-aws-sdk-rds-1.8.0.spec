...
%global gem_name aws-sdk-rds
Name: rubygem-aws-sdk-rds
Version: 1.8.0
Release: 1.%{dist}
...
Provides: rubygem-aws-sdk-rds = %{version}
Provides: rubygem(aws-sdk-rds) = %{version}
Obsoletes: rubygem-aws-sdk-rds < %{version}
Obsoletes: rubygem(aws-sdk-rds) < %{version}
...
gem install --install-dir %{buildroot}/%{gem_dir} --bindir %{buildroot}/%{_bindir} --force --no-rdoc --no-ri --no-doc --ignore-dependencies aws-sdk-rds -v %{version}
