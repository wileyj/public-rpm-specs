...
%global gem_name aws-sdk-glue
Name: rubygem-aws-sdk-glue
Version: 1.2.0
Release: 1.%{dist}
...
Provides: rubygem-aws-sdk-glue = %{version}
Provides: rubygem(aws-sdk-glue) = %{version}
Obsoletes: rubygem-aws-sdk-glue < %{version}
Obsoletes: rubygem(aws-sdk-glue) < %{version}
...
gem install --install-dir %{buildroot}/%{gem_dir} --bindir %{buildroot}/%{_bindir} --force --no-rdoc --no-ri --no-doc --ignore-dependencies aws-sdk-glue -v %{version}
