...
%global gem_name aws-sdk-kinesisanalytics
Name: rubygem%{alinux_ruby}-aws-sdk-kinesisanalytics
Version: 1.2.0
Release: 1.%{dist}
Summary: rubygem aws-sdk-kinesisanalytics
...
Provides: rubygem%{alinux_ruby}-aws-sdk-kinesisanalytics = %{version}
Provides: rubygem%{alinux_ruby}(aws-sdk-kinesisanalytics) = %{version}
Obsoletes: rubygem%{alinux_ruby}-aws-sdk-kinesisanalytics < %{version}
Obsoletes: rubygem%{alinux_ruby}(aws-sdk-kinesisanalytics) < %{version}
...
%description
Official AWS Ruby gem for Amazon Kinesis Analytics (Kinesis Analytics). This gem is part of the AWS SDK for Ruby.
