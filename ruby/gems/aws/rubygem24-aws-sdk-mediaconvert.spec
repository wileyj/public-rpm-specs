...
%global gem_name aws-sdk-mediaconvert
Name: rubygem%{alinux_ruby}-aws-sdk-mediaconvert
Version: 1.0.0
Release: 1.%{dist}
Summary: rubygem aws-sdk-mediaconvert
...
Provides: rubygem%{alinux_ruby}-aws-sdk-mediaconvert = %{version}
Provides: rubygem%{alinux_ruby}(aws-sdk-mediaconvert) = %{version}
Obsoletes: rubygem%{alinux_ruby}-aws-sdk-mediaconvert < %{version}
Obsoletes: rubygem%{alinux_ruby}(aws-sdk-mediaconvert) < %{version}
