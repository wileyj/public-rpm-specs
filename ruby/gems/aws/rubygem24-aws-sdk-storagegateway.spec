...
Name: rubygem%{alinux_ruby}-aws-sdk-storagegateway
Version: 1.2.0
Release: 1.%{dist}
...
Provides: rubygem%{alinux_ruby}-aws-sdk-storagegateway = %{version}
Provides: rubygem%{alinux_ruby}(aws-sdk-storagegateway) = %{version}
Obsoletes: rubygem%{alinux_ruby}-aws-sdk-storagegateway < %{version}
Obsoletes: rubygem%{alinux_ruby}(aws-sdk-storagegateway) < %{version}
