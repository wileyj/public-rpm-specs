...
%global gem_name aws-sdk-lex
Name: rubygem-aws-sdk-lex
Version: 1.2.0
Release: 1.%{dist}
Summary: rubygem aws-sdk-lex
...
Provides: rubygem-aws-sdk-lex = %{version}
Provides: rubygem(aws-sdk-lex) = %{version}
Obsoletes: rubygem-aws-sdk-lex < %{version}
Obsoletes: rubygem(aws-sdk-lex) < %{version}
...
gem install --install-dir %{buildroot}/%{gem_dir} --bindir %{buildroot}/%{_bindir} --force --no-rdoc --no-ri --no-doc --ignore-dependencies aws-sdk-lex -v %{version}
