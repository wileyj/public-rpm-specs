...
%global gem_name aws-sdk-comprehend
Name: rubygem%{alinux_ruby}-aws-sdk-comprehend
Version: 1.0.0
Release: 1.%{dist}
Summary: rubygem aws-sdk-comprehend
...
Provides: rubygem%{alinux_ruby}-aws-sdk-comprehend = %{version}
Provides: rubygem%{alinux_ruby}(aws-sdk-comprehend) = %{version}
Obsoletes: rubygem%{alinux_ruby}-aws-sdk-comprehend < %{version}
Obsoletes: rubygem%{alinux_ruby}(aws-sdk-comprehend) < %{version}
