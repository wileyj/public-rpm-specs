...
Name: rubygem%{alinux_ruby}-aws-sdk-lambdapreview
Version: 1.0.0
Release: 1.%{dist}
...
Provides: rubygem%{alinux_ruby}-aws-sdk-lambdapreview = %{version}
Provides: rubygem%{alinux_ruby}(aws-sdk-lambdapreview) = %{version}
Obsoletes: rubygem%{alinux_ruby}-aws-sdk-lambdapreview < %{version}
Obsoletes: rubygem%{alinux_ruby}(aws-sdk-lambdapreview) < %{version}
