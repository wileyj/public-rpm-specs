...
%global gem_name aws-sdk-mturk
Name: rubygem-aws-sdk-mturk
Version: 1.1.0
Release: 1.%{dist}
Summary: rubygem aws-sdk-mturk
...
Provides: rubygem-aws-sdk-mturk = %{version}
Provides: rubygem(aws-sdk-mturk) = %{version}
Obsoletes: rubygem-aws-sdk-mturk < %{version}
Obsoletes: rubygem(aws-sdk-mturk) < %{version}
...
%description
Official AWS Ruby gem for Amazon Mechanical Turk (Amazon MTurk). This gem is part of the AWS SDK for Ruby.

%prep
%build
%install
export CONFIGURE_ARGS="--with-cflags='%{optflags}'"
gem install --install-dir %{buildroot}/%{gem_dir} --bindir %{buildroot}/%{_bindir} --force --no-rdoc --no-ri --no-doc --ignore-dependencies aws-sdk-mturk -v %{version}
