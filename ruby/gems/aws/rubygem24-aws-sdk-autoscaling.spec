...
Name: rubygem%{alinux_ruby}-aws-sdk-autoscaling
Version: 1.4.0
Release: 1.%{dist}
...
Provides: rubygem%{alinux_ruby}-aws-sdk-autoscaling = %{version}
Provides: rubygem%{alinux_ruby}(aws-sdk-autoscaling) = %{version}
Obsoletes: rubygem%{alinux_ruby}-aws-sdk-autoscaling < %{version}
Obsoletes: rubygem%{alinux_ruby}(aws-sdk-autoscaling) < %{version}
