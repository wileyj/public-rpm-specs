...
%global gem_name aws-sdk-pinpoint
Name: rubygem-aws-sdk-pinpoint
Version: 1.2.0
Release: 1.%{dist}
Summary: rubygem aws-sdk-pinpoint
...
Provides: rubygem-aws-sdk-pinpoint = %{version}
Provides: rubygem(aws-sdk-pinpoint) = %{version}
Obsoletes: rubygem-aws-sdk-pinpoint < %{version}
Obsoletes: rubygem(aws-sdk-pinpoint) < %{version}
...
gem install --install-dir %{buildroot}/%{gem_dir} --bindir %{buildroot}/%{_bindir} --force --no-rdoc --no-ri --no-doc --ignore-dependencies aws-sdk-pinpoint -v %{version}
