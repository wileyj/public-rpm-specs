...
Name: rubygem%{alinux_ruby}-fog-json
Version: 1.0.2
Release: 1.%{dist}
...
Provides: rubygem%{alinux_ruby}-fog-json = %{version}
Provides: rubygem%{alinux_ruby}(fog-json) = %{version}
Obsoletes: rubygem%{alinux_ruby}-fog-json < %{version}
Obsoletes: rubygem%{alinux_ruby}(fog-json) < %{version}


Requires: rubygem%{alinux_ruby}-fog-core  = 1.0
Requires: rubygem%{alinux_ruby}-multi_json  = 1.10
