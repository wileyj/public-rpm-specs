...
%global gem_name aws-sdk-datapipeline
Name: rubygem-aws-sdk-datapipeline
Version: 1.0.0
Release: 1.%{dist}
Summary: rubygem aws-sdk-datapipeline
...
Provides: rubygem-aws-sdk-datapipeline = %{version}
Provides: rubygem(aws-sdk-datapipeline) = %{version}
Obsoletes: rubygem-aws-sdk-datapipeline < %{version}
Obsoletes: rubygem(aws-sdk-datapipeline) < %{version}
...
gem install --install-dir %{buildroot}/%{gem_dir} --bindir %{buildroot}/%{_bindir} --force --no-rdoc --no-ri --no-doc --ignore-dependencies aws-sdk-datapipeline -v %{version}
