...
Name: rubygem%{alinux_ruby}-aws-sdk-applicationautoscaling
Version: 1.6.0
Release: 1.%{dist}
...
Provides: rubygem%{alinux_ruby}-aws-sdk-applicationautoscaling = %{version}
Provides: rubygem%{alinux_ruby}(aws-sdk-applicationautoscaling) = %{version}
Obsoletes: rubygem%{alinux_ruby}-aws-sdk-applicationautoscaling < %{version}
Obsoletes: rubygem%{alinux_ruby}(aws-sdk-applicationautoscaling) < %{version}
