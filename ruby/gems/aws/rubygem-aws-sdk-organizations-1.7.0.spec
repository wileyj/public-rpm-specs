...
Provides: rubygem-aws-sdk-organizations = %{version}
Provides: rubygem(aws-sdk-organizations) = %{version}
Obsoletes: rubygem-aws-sdk-organizations < %{version}
Obsoletes: rubygem(aws-sdk-organizations) < %{version}
...
gem install --install-dir %{buildroot}/%{gem_dir} --bindir %{buildroot}/%{_bindir} --force --no-rdoc --no-ri --no-doc --ignore-dependencies aws-sdk-organizations -v %{version}
