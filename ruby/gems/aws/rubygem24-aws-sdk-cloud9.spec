...
%global gem_name aws-sdk-cloud9
Name: rubygem%{alinux_ruby}-aws-sdk-cloud9
Version: 1.0.0
Release: 1.%{dist}
Summary: rubygem aws-sdk-cloud9
...
Provides: rubygem%{alinux_ruby}-aws-sdk-cloud9 = %{version}
Provides: rubygem%{alinux_ruby}(aws-sdk-cloud9) = %{version}
Obsoletes: rubygem%{alinux_ruby}-aws-sdk-cloud9 < %{version}
Obsoletes: rubygem%{alinux_ruby}(aws-sdk-cloud9) < %{version}
