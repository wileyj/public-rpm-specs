...
%global gem_name aws-sdk-kinesisvideoarchivedmedia
Name: rubygem%{alinux_ruby}-aws-sdk-kinesisvideoarchivedmedia
Version: 1.0.0
Release: 1.%{dist}
Summary: rubygem aws-sdk-kinesisvideoarchivedmedia
...
Provides: rubygem%{alinux_ruby}-aws-sdk-kinesisvideoarchivedmedia = %{version}
Provides: rubygem%{alinux_ruby}(aws-sdk-kinesisvideoarchivedmedia) = %{version}
Obsoletes: rubygem%{alinux_ruby}-aws-sdk-kinesisvideoarchivedmedia < %{version}
Obsoletes: rubygem%{alinux_ruby}(aws-sdk-kinesisvideoarchivedmedia) < %{version}
