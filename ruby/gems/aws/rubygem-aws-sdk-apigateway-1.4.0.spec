...
%global gem_name aws-sdk-apigateway
Name: rubygem-aws-sdk-apigateway
Version: 1.4.0
Release: 1.%{dist}
...
Provides: rubygem-aws-sdk-apigateway = %{version}
Provides: rubygem(aws-sdk-apigateway) = %{version}
Obsoletes: rubygem-aws-sdk-apigateway < %{version}
Obsoletes: rubygem(aws-sdk-apigateway) < %{version}
...
gem install --install-dir %{buildroot}/%{gem_dir} --bindir %{buildroot}/%{_bindir} --force --no-rdoc --no-ri --no-doc --ignore-dependencies aws-sdk-apigateway -v %{version}
(
    cd %{buildroot}
