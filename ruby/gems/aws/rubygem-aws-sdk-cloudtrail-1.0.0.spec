...
%global gem_name aws-sdk-cloudtrail
Name: rubygem-aws-sdk-cloudtrail
Version: 1.0.0
Release: 1.%{dist}
...
Provides: rubygem-aws-sdk-cloudtrail = %{version}
Provides: rubygem(aws-sdk-cloudtrail) = %{version}
Obsoletes: rubygem-aws-sdk-cloudtrail < %{version}
Obsoletes: rubygem(aws-sdk-cloudtrail) < %{version}
...
%description
Official AWS Ruby gem for AWS CloudTrail (CloudTrail). This gem is part of the AWS SDK for Ruby.

%prep
%build
%install
export CONFIGURE_ARGS="--with-cflags='%{optflags}'"
gem install --install-dir %{buildroot}/%{gem_dir} --bindir %{buildroot}/%{_bindir} --force --no-rdoc --no-ri --no-doc --ignore-dependencies aws-sdk-cloudtrail -v %{version}
