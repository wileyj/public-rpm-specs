...
Name: rubygem%{alinux_ruby}-fog-aws
Version: 0.6.0
Release: 1.%{dist}
...
Provides: rubygem%{alinux_ruby}-fog-aws = %{version}
Provides: rubygem%{alinux_ruby}(fog-aws) = %{version}
Obsoletes: rubygem%{alinux_ruby}-fog-aws < %{version}
Obsoletes: rubygem%{alinux_ruby}(fog-aws) < %{version}
...
Requires: rubygem%{alinux_ruby}-ipaddress  = 0.8
