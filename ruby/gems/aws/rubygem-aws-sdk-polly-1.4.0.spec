...
%global gem_name aws-sdk-polly
Name: rubygem-aws-sdk-polly
Version: 1.4.0
Release: 1.%{dist}
Summary: rubygem aws-sdk-polly
...
Provides: rubygem-aws-sdk-polly = %{version}
Provides: rubygem(aws-sdk-polly) = %{version}
Obsoletes: rubygem-aws-sdk-polly < %{version}
Obsoletes: rubygem(aws-sdk-polly) < %{version}
...
gem install --install-dir %{buildroot}/%{gem_dir} --bindir %{buildroot}/%{_bindir} --force --no-rdoc --no-ri --no-doc --ignore-dependencies aws-sdk-polly -v %{version}
