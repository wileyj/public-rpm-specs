...
%global gem_name aws-sdk-cloudsearch
Name: rubygem-aws-sdk-cloudsearch
Version: 1.0.0
Release: 1.%{dist}
Summary: rubygem aws-sdk-cloudsearch
...
Provides: rubygem-aws-sdk-cloudsearch = %{version}
Provides: rubygem(aws-sdk-cloudsearch) = %{version}
Obsoletes: rubygem-aws-sdk-cloudsearch < %{version}
Obsoletes: rubygem(aws-sdk-cloudsearch) < %{version}
...
gem install --install-dir %{buildroot}/%{gem_dir} --bindir %{buildroot}/%{_bindir} --force --no-rdoc --no-ri --no-doc --ignore-dependencies aws-sdk-cloudsearch -v %{version}
