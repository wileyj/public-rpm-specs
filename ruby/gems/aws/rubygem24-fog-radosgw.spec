...
Name: rubygem%{alinux_ruby}-fog-radosgw
Version: 0.0.2
Release: 1.%{dist}
...
Provides: rubygem%{alinux_ruby}-fog-radosgw = %{version}
Provides: rubygem%{alinux_ruby}(fog-radosgw) = %{version}
Obsoletes: rubygem%{alinux_ruby}-fog-radosgw < %{version}
Obsoletes: rubygem%{alinux_ruby}(fog-radosgw) < %{version}


Requires: rubygem%{alinux_ruby}-fog-core  >= 1.21.0
