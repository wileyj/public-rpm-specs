...
%global gem_name aws-sdk-translate
Name: rubygem%{alinux_ruby}-aws-sdk-translate
Version: 1.0.0
Release: 1.%{dist}
Summary: rubygem aws-sdk-translate
...
Provides: rubygem%{alinux_ruby}-aws-sdk-translate = %{version}
Provides: rubygem%{alinux_ruby}(aws-sdk-translate) = %{version}
Obsoletes: rubygem%{alinux_ruby}-aws-sdk-translate < %{version}
Obsoletes: rubygem%{alinux_ruby}(aws-sdk-translate) < %{version}
