...
Name: rubygem%{alinux_ruby}-aws-sdk-dynamodbstreams
Version: 1.0.0
Release: 1.%{dist}
...
Provides: rubygem%{alinux_ruby}-aws-sdk-dynamodbstreams = %{version}
Provides: rubygem%{alinux_ruby}(aws-sdk-dynamodbstreams) = %{version}
Obsoletes: rubygem%{alinux_ruby}-aws-sdk-dynamodbstreams < %{version}
Obsoletes: rubygem%{alinux_ruby}(aws-sdk-dynamodbstreams) < %{version}
