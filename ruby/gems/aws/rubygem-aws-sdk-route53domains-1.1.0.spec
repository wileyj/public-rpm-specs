...
%global gem_name aws-sdk-route53domains
Name: rubygem-aws-sdk-route53domains
Version: 1.1.0
Release: 1.%{dist}
...
Provides: rubygem-aws-sdk-route53domains = %{version}
Provides: rubygem(aws-sdk-route53domains) = %{version}
Obsoletes: rubygem-aws-sdk-route53domains < %{version}
Obsoletes: rubygem(aws-sdk-route53domains) < %{version}
...
gem install --install-dir %{buildroot}/%{gem_dir} --bindir %{buildroot}/%{_bindir} --force --no-rdoc --no-ri --no-doc --ignore-dependencies aws-sdk-route53domains -v %{version}
