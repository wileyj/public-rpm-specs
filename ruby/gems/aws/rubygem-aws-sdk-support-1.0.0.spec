...
%global gem_name aws-sdk-support
Name: rubygem-aws-sdk-support
Version: 1.0.0
Release: 1.%{dist}
Summary: rubygem aws-sdk-support
...
Provides: rubygem-aws-sdk-support = %{version}
Provides: rubygem(aws-sdk-support) = %{version}
Obsoletes: rubygem-aws-sdk-support < %{version}
Obsoletes: rubygem(aws-sdk-support) < %{version}
...
gem install --install-dir %{buildroot}/%{gem_dir} --bindir %{buildroot}/%{_bindir} --force --no-rdoc --no-ri --no-doc --ignore-dependencies aws-sdk-support -v %{version}
