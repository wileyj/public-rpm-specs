...
Name: rubygem%{alinux_ruby}-aws-sdk-cloudsearch
Version: 1.0.0
Release: 1.%{dist}
...
Provides: rubygem%{alinux_ruby}-aws-sdk-cloudsearch = %{version}
Provides: rubygem%{alinux_ruby}(aws-sdk-cloudsearch) = %{version}
Obsoletes: rubygem%{alinux_ruby}-aws-sdk-cloudsearch < %{version}
Obsoletes: rubygem%{alinux_ruby}(aws-sdk-cloudsearch) < %{version}
