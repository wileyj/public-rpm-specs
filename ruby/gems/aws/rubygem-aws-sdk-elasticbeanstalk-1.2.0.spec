...
%global gem_name aws-sdk-elasticbeanstalk
Name: rubygem-aws-sdk-elasticbeanstalk
Version: 1.2.0
Release: 1.%{dist}
...
Provides: rubygem-aws-sdk-elasticbeanstalk = %{version}
Provides: rubygem(aws-sdk-elasticbeanstalk) = %{version}
Obsoletes: rubygem-aws-sdk-elasticbeanstalk < %{version}
Obsoletes: rubygem(aws-sdk-elasticbeanstalk) < %{version}
...
gem install --install-dir %{buildroot}/%{gem_dir} --bindir %{buildroot}/%{_bindir} --force --no-rdoc --no-ri --no-doc --ignore-dependencies aws-sdk-elasticbeanstalk -v %{version}
