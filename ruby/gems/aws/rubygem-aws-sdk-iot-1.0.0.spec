...
%global gem_name aws-sdk-iot
Name: rubygem-aws-sdk-iot
Version: 1.0.0
Release: 1.%{dist}
Summary: rubygem aws-sdk-iot
...
Provides: rubygem-aws-sdk-iot = %{version}
Provides: rubygem(aws-sdk-iot) = %{version}
Obsoletes: rubygem-aws-sdk-iot < %{version}
Obsoletes: rubygem(aws-sdk-iot) < %{version}
...
gem install --install-dir %{buildroot}/%{gem_dir} --bindir %{buildroot}/%{_bindir} --force --no-rdoc --no-ri --no-doc --ignore-dependencies aws-sdk-iot -v %{version}
