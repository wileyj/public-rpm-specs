...
Name: rubygem%{alinux_ruby}-aws-sdk-elasticache
Version: 1.3.0
Release: 1.%{dist}
...
Provides: rubygem%{alinux_ruby}-aws-sdk-elasticache = %{version}
Provides: rubygem%{alinux_ruby}(aws-sdk-elasticache) = %{version}
Obsoletes: rubygem%{alinux_ruby}-aws-sdk-elasticache < %{version}
Obsoletes: rubygem%{alinux_ruby}(aws-sdk-elasticache) < %{version}
