...
Name: rubygem%{alinux_ruby}-aws-sdk-core
Version: 3.13.0
Release: 1.%{dist}
...
Provides: rubygem%{alinux_ruby}-aws-sdk-core = %{version}
Provides: rubygem%{alinux_ruby}(aws-sdk-core) = %{version}
Obsoletes: rubygem%{alinux_ruby}-aws-sdk-core < %{version}
Obsoletes: rubygem%{alinux_ruby}(aws-sdk-core) < %{version}


Requires: rubygem%{alinux_ruby}-aws-partitions  = 1.0
Requires: rubygem%{alinux_ruby}-aws-sigv4  = 1.0
Requires: rubygem%{alinux_ruby}-jmespath  = 1.0
