...
%global gem_name aws-sdk-elasticloadbalancingv2
Name: rubygem-aws-sdk-elasticloadbalancingv2
Version: 1.6.0
Release: 1.%{dist}
...
Provides: rubygem-aws-sdk-elasticloadbalancingv2 = %{version}
Provides: rubygem(aws-sdk-elasticloadbalancingv2) = %{version}
Obsoletes: rubygem-aws-sdk-elasticloadbalancingv2 < %{version}
Obsoletes: rubygem(aws-sdk-elasticloadbalancingv2) < %{version}
...
gem install --install-dir %{buildroot}/%{gem_dir} --bindir %{buildroot}/%{_bindir} --force --no-rdoc --no-ri --no-doc --ignore-dependencies aws-sdk-elasticloadbalancingv2 -v %{version}
