...
Name: rubygem%{alinux_ruby}-aws-sdk-route53domains
Version: 1.1.0
Release: 1.%{dist}
...
Provides: rubygem%{alinux_ruby}-aws-sdk-route53domains = %{version}
Provides: rubygem%{alinux_ruby}(aws-sdk-route53domains) = %{version}
Obsoletes: rubygem%{alinux_ruby}-aws-sdk-route53domains < %{version}
Obsoletes: rubygem%{alinux_ruby}(aws-sdk-route53domains) < %{version}
