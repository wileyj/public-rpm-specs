...
%global gem_name aws-sdk-dax
Name: rubygem-aws-sdk-dax
Version: 1.0.0
Release: 1.%{dist}
Summary: rubygem aws-sdk-dax
...
Provides: rubygem-aws-sdk-dax = %{version}
Provides: rubygem(aws-sdk-dax) = %{version}
Obsoletes: rubygem-aws-sdk-dax < %{version}
Obsoletes: rubygem(aws-sdk-dax) < %{version}
...
%description
Official AWS Ruby gem for Amazon DynamoDB Accelerator (DAX) (Amazon DAX). This gem is part of the AWS SDK for Ruby.

%prep
%build
%install
export CONFIGURE_ARGS="--with-cflags='%{optflags}'"
gem install --install-dir %{buildroot}/%{gem_dir} --bindir %{buildroot}/%{_bindir} --force --no-rdoc --no-ri --no-doc --ignore-dependencies aws-sdk-dax -v %{version}
