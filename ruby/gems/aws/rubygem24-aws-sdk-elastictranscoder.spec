...
Name: rubygem%{alinux_ruby}-aws-sdk-elastictranscoder
Version: 1.0.0
Release: 1.%{dist}
...
Provides: rubygem%{alinux_ruby}-aws-sdk-elastictranscoder = %{version}
Provides: rubygem%{alinux_ruby}(aws-sdk-elastictranscoder) = %{version}
Obsoletes: rubygem%{alinux_ruby}-aws-sdk-elastictranscoder < %{version}
Obsoletes: rubygem%{alinux_ruby}(aws-sdk-elastictranscoder) < %{version}
