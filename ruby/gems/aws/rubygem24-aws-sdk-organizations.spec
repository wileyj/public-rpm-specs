...
%global gem_name aws-sdk-organizations
Name: rubygem%{alinux_ruby}-aws-sdk-organizations
Version: 1.7.0
Release: 1.%{dist}
...
Provides: rubygem%{alinux_ruby}-aws-sdk-organizations = %{version}
Provides: rubygem%{alinux_ruby}(aws-sdk-organizations) = %{version}
Obsoletes: rubygem%{alinux_ruby}-aws-sdk-organizations < %{version}
Obsoletes: rubygem%{alinux_ruby}(aws-sdk-organizations) < %{version}
...
%description
Official AWS Ruby gem for AWS Organizations (Organizations). This gem is part of the AWS SDK for Ruby.
