...
%global gem_name aws-sdk-codedeploy
Name: rubygem-aws-sdk-codedeploy
Version: 1.0.0
Release: 1.%{dist}
...
Provides: rubygem-aws-sdk-codedeploy = %{version}
Provides: rubygem(aws-sdk-codedeploy) = %{version}
Obsoletes: rubygem-aws-sdk-codedeploy < %{version}
Obsoletes: rubygem(aws-sdk-codedeploy) < %{version}
...
%description
Official AWS Ruby gem for AWS CodeDeploy (CodeDeploy). This gem is part of the AWS SDK for Ruby.

%prep
%build
%install
export CONFIGURE_ARGS="--with-cflags='%{optflags}'"
gem install --install-dir %{buildroot}/%{gem_dir} --bindir %{buildroot}/%{_bindir} --force --no-rdoc --no-ri --no-doc --ignore-dependencies aws-sdk-codedeploy -v %{version}
