...
Name: rubygem%{alinux_ruby}-aws-sdk-configservice
Version: 1.5.0
Release: 1.%{dist}
...
Provides: rubygem%{alinux_ruby}-aws-sdk-configservice = %{version}
Provides: rubygem%{alinux_ruby}(aws-sdk-configservice) = %{version}
Obsoletes: rubygem%{alinux_ruby}-aws-sdk-configservice < %{version}
Obsoletes: rubygem%{alinux_ruby}(aws-sdk-configservice) < %{version}
