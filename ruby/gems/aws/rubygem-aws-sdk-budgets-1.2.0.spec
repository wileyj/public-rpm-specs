...
Provides: rubygem-aws-sdk-budgets = %{version}
Provides: rubygem(aws-sdk-budgets) = %{version}
Obsoletes: rubygem-aws-sdk-budgets < %{version}
Obsoletes: rubygem(aws-sdk-budgets) < %{version}
...
gem install --install-dir %{buildroot}/%{gem_dir} --bindir %{buildroot}/%{_bindir} --force --no-rdoc --no-ri --no-doc --ignore-dependencies aws-sdk-budgets -v %{version}
