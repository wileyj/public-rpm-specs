...
%global gem_name aws-sdk-elastictranscoder
Name: rubygem-aws-sdk-elastictranscoder
Version: 1.0.0
Release: 1.%{dist}
Summary: rubygem aws-sdk-elastictranscoder
...
Provides: rubygem-aws-sdk-elastictranscoder = %{version}
Provides: rubygem(aws-sdk-elastictranscoder) = %{version}
Obsoletes: rubygem-aws-sdk-elastictranscoder < %{version}
Obsoletes: rubygem(aws-sdk-elastictranscoder) < %{version}
...
%description
Official AWS Ruby gem for Amazon Elastic Transcoder. This gem is part of the AWS SDK for Ruby.

%prep
%build
%install
export CONFIGURE_ARGS="--with-cflags='%{optflags}'"
gem install --install-dir %{buildroot}/%{gem_dir} --bindir %{buildroot}/%{_bindir} --force --no-rdoc --no-ri --no-doc --ignore-dependencies aws-sdk-elastictranscoder -v %{version}
