...
%global gem_name aws-sdk-glacier
Name: rubygem-aws-sdk-glacier
Version: 1.4.0
Release: 1.%{dist}
Summary: rubygem aws-sdk-glacier
...
Provides: rubygem-aws-sdk-glacier = %{version}
Provides: rubygem(aws-sdk-glacier) = %{version}
Obsoletes: rubygem-aws-sdk-glacier < %{version}
Obsoletes: rubygem(aws-sdk-glacier) < %{version}
...
gem install --install-dir %{buildroot}/%{gem_dir} --bindir %{buildroot}/%{_bindir} --force --no-rdoc --no-ri --no-doc --ignore-dependencies aws-sdk-glacier -v %{version}
