...
%global gem_name aws-sdk-guardduty
Name: rubygem%{alinux_ruby}-aws-sdk-guardduty
Version: 1.0.0
Release: 1.%{dist}
...
Provides: rubygem%{alinux_ruby}-aws-sdk-guardduty = %{version}
Provides: rubygem%{alinux_ruby}(aws-sdk-guardduty) = %{version}
Obsoletes: rubygem%{alinux_ruby}-aws-sdk-guardduty < %{version}
Obsoletes: rubygem%{alinux_ruby}(aws-sdk-guardduty) < %{version}
...
%description
Official AWS Ruby gem for Amazon GuardDuty. This gem is part of the AWS SDK for Ruby.
