...
%global gem_name aws-sdk-workspaces
Name: rubygem-aws-sdk-workspaces
Version: 1.0.0
Release: 1.%{dist}
Summary: rubygem aws-sdk-workspaces
...
Provides: rubygem-aws-sdk-workspaces = %{version}
Provides: rubygem(aws-sdk-workspaces) = %{version}
Obsoletes: rubygem-aws-sdk-workspaces < %{version}
Obsoletes: rubygem(aws-sdk-workspaces) < %{version}
...
gem install --install-dir %{buildroot}/%{gem_dir} --bindir %{buildroot}/%{_bindir} --force --no-rdoc --no-ri --no-doc --ignore-dependencies aws-sdk-workspaces -v %{version}
