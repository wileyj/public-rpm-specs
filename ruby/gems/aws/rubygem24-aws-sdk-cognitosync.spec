...
Name: rubygem%{alinux_ruby}-aws-sdk-cognitosync
Version: 1.0.0
Release: 1.%{dist}
...
Provides: rubygem%{alinux_ruby}-aws-sdk-cognitosync = %{version}
Provides: rubygem%{alinux_ruby}(aws-sdk-cognitosync) = %{version}
Obsoletes: rubygem%{alinux_ruby}-aws-sdk-cognitosync < %{version}
Obsoletes: rubygem%{alinux_ruby}(aws-sdk-cognitosync) < %{version}
