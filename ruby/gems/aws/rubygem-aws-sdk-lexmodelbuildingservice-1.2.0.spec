...
%global gem_name aws-sdk-lexmodelbuildingservice
Name: rubygem-aws-sdk-lexmodelbuildingservice
Version: 1.2.0
Release: 1.%{dist}
Summary: rubygem aws-sdk-lexmodelbuildingservice
...
Provides: rubygem-aws-sdk-lexmodelbuildingservice = %{version}
Provides: rubygem(aws-sdk-lexmodelbuildingservice) = %{version}
Obsoletes: rubygem-aws-sdk-lexmodelbuildingservice < %{version}
Obsoletes: rubygem(aws-sdk-lexmodelbuildingservice) < %{version}
...
gem install --install-dir %{buildroot}/%{gem_dir} --bindir %{buildroot}/%{_bindir} --force --no-rdoc --no-ri --no-doc --ignore-dependencies aws-sdk-lexmodelbuildingservice -v %{version}
