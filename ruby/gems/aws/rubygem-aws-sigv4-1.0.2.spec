...
Provides: rubygem-aws-sigv4 = %{version}
Provides: rubygem(aws-sigv4) = %{version}
Obsoletes: rubygem-aws-sigv4 < %{version}
Obsoletes: rubygem(aws-sigv4) < %{version}
...
gem install --install-dir %{buildroot}/%{gem_dir} --bindir %{buildroot}/%{_bindir} --force --no-rdoc --no-ri --no-doc --ignore-dependencies aws-sigv4 -v %{version}
