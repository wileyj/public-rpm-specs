...
%global gem_name aws-sdk-ecr
Name: rubygem-aws-sdk-ecr
Version: 1.2.0
Release: 1.%{dist}
...
Provides: rubygem-aws-sdk-ecr = %{version}
Provides: rubygem(aws-sdk-ecr) = %{version}
Obsoletes: rubygem-aws-sdk-ecr < %{version}
Obsoletes: rubygem(aws-sdk-ecr) < %{version}
...
gem install --install-dir %{buildroot}/%{gem_dir} --bindir %{buildroot}/%{_bindir} --force --no-rdoc --no-ri --no-doc --ignore-dependencies aws-sdk-ecr -v %{version}
