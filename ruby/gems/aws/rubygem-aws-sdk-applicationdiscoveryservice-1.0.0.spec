...
%global gem_name aws-sdk-applicationdiscoveryservice
Name: rubygem-aws-sdk-applicationdiscoveryservice
Version: 1.0.0
Release: 1.%{dist}
Summary: rubygem aws-sdk-applicationdiscoveryservice
...
Provides: rubygem-aws-sdk-applicationdiscoveryservice = %{version}
Provides: rubygem(aws-sdk-applicationdiscoveryservice) = %{version}
Obsoletes: rubygem-aws-sdk-applicationdiscoveryservice < %{version}
Obsoletes: rubygem(aws-sdk-applicationdiscoveryservice) < %{version}
...
gem install --install-dir %{buildroot}/%{gem_dir} --bindir %{buildroot}/%{_bindir} --force --no-rdoc --no-ri --no-doc --ignore-dependencies aws-sdk-applicationdiscoveryservice -v %{version}
