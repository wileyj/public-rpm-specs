...
%global gem_name aws-sdk-databasemigrationservice
Name: rubygem-aws-sdk-databasemigrationservice
Version: 1.3.0
Release: 1.%{dist}
...
Provides: rubygem-aws-sdk-databasemigrationservice = %{version}
Provides: rubygem(aws-sdk-databasemigrationservice) = %{version}
Obsoletes: rubygem-aws-sdk-databasemigrationservice < %{version}
Obsoletes: rubygem(aws-sdk-databasemigrationservice) < %{version}
...
gem install --install-dir %{buildroot}/%{gem_dir} --bindir %{buildroot}/%{_bindir} --force --no-rdoc --no-ri --no-doc --ignore-dependencies aws-sdk-databasemigrationservice -v %{version}
