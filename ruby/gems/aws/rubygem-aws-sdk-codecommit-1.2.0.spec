...
%global gem_name aws-sdk-codecommit
Name: rubygem-aws-sdk-codecommit
Version: 1.2.0
Release: 1.%{dist}
...
Provides: rubygem-aws-sdk-codecommit = %{version}
Provides: rubygem(aws-sdk-codecommit) = %{version}
Obsoletes: rubygem-aws-sdk-codecommit < %{version}
Obsoletes: rubygem(aws-sdk-codecommit) < %{version}
...
gem install --install-dir %{buildroot}/%{gem_dir} --bindir %{buildroot}/%{_bindir} --force --no-rdoc --no-ri --no-doc --ignore-dependencies aws-sdk-codecommit -v %{version}
