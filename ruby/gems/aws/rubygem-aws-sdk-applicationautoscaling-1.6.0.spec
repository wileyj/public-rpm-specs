...
%global gem_name aws-sdk-applicationautoscaling
Name: rubygem-aws-sdk-applicationautoscaling
Version: 1.6.0
Release: 1.%{dist}
...
Provides: rubygem-aws-sdk-applicationautoscaling = %{version}
Provides: rubygem(aws-sdk-applicationautoscaling) = %{version}
Obsoletes: rubygem-aws-sdk-applicationautoscaling < %{version}
Obsoletes: rubygem(aws-sdk-applicationautoscaling) < %{version}
...
gem install --install-dir %{buildroot}/%{gem_dir} --bindir %{buildroot}/%{_bindir} --force --no-rdoc --no-ri --no-doc --ignore-dependencies aws-sdk-applicationautoscaling -v %{version}
