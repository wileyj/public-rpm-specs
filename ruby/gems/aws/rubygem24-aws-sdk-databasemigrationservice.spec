...
Name: rubygem%{alinux_ruby}-aws-sdk-databasemigrationservice
Version: 1.3.0
Release: 1.%{dist}
...
Provides: rubygem%{alinux_ruby}-aws-sdk-databasemigrationservice = %{version}
Provides: rubygem%{alinux_ruby}(aws-sdk-databasemigrationservice) = %{version}
Obsoletes: rubygem%{alinux_ruby}-aws-sdk-databasemigrationservice < %{version}
Obsoletes: rubygem%{alinux_ruby}(aws-sdk-databasemigrationservice) < %{version}
