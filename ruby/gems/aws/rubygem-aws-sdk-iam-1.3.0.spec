...
%global gem_name aws-sdk-iam
Name: rubygem-aws-sdk-iam
Version: 1.3.0
Release: 1.%{dist}
...
Provides: rubygem-aws-sdk-iam = %{version}
Provides: rubygem(aws-sdk-iam) = %{version}
Obsoletes: rubygem-aws-sdk-iam < %{version}
Obsoletes: rubygem(aws-sdk-iam) < %{version}
...
gem install --install-dir %{buildroot}/%{gem_dir} --bindir %{buildroot}/%{_bindir} --force --no-rdoc --no-ri --no-doc --ignore-dependencies aws-sdk-iam -v %{version}
