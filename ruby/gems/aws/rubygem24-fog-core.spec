...
Name: rubygem%{alinux_ruby}-fog-core
Version: 1.43.0
Release: 1.%{dist}
...
Provides: rubygem%{alinux_ruby}-fog-core = %{version}
Provides: rubygem%{alinux_ruby}(fog-core) = %{version}
Obsoletes: rubygem%{alinux_ruby}-fog-core < %{version}
Obsoletes: rubygem%{alinux_ruby}(fog-core) < %{version}


Requires: rubygem%{alinux_ruby}-builder
Requires: rubygem%{alinux_ruby}-excon  = 0.49
Requires: rubygem%{alinux_ruby}-formatador  = 0.2
