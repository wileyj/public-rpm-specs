...
Provides: rubygem-aws-sdk-cloudformation = %{version}
Provides: rubygem(aws-sdk-cloudformation) = %{version}
Obsoletes: rubygem-aws-sdk-cloudformation < %{version}
Obsoletes: rubygem(aws-sdk-cloudformation) < %{version}
...
gem install --install-dir %{buildroot}/%{gem_dir} --bindir %{buildroot}/%{_bindir} --force --no-rdoc --no-ri --no-doc --ignore-dependencies aws-sdk-cloudformation -v %{version}
