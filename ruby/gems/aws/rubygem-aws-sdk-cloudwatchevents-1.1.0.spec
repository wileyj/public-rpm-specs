...
%global gem_name aws-sdk-cloudwatchevents
Name: rubygem-aws-sdk-cloudwatchevents
Version: 1.1.0
Release: 1.%{dist}
...
Provides: rubygem-aws-sdk-cloudwatchevents = %{version}
Provides: rubygem(aws-sdk-cloudwatchevents) = %{version}
Obsoletes: rubygem-aws-sdk-cloudwatchevents < %{version}
Obsoletes: rubygem(aws-sdk-cloudwatchevents) < %{version}
...
gem install --install-dir %{buildroot}/%{gem_dir} --bindir %{buildroot}/%{_bindir} --force --no-rdoc --no-ri --no-doc --ignore-dependencies aws-sdk-cloudwatchevents -v %{version}
