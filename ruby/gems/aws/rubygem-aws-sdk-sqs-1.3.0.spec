...
Provides: rubygem-aws-sdk-sqs = %{version}
Provides: rubygem(aws-sdk-sqs) = %{version}
Obsoletes: rubygem-aws-sdk-sqs < %{version}
Obsoletes: rubygem(aws-sdk-sqs) < %{version}
...
gem install --install-dir %{buildroot}/%{gem_dir} --bindir %{buildroot}/%{_bindir} --force --no-rdoc --no-ri --no-doc --ignore-dependencies aws-sdk-sqs -v %{version}
