...
%global gem_name aws-sdk-snowball
Name: rubygem-aws-sdk-snowball
Version: 1.1.0
Release: 1.%{dist}
Summary: rubygem aws-sdk-snowball
...
Provides: rubygem-aws-sdk-snowball = %{version}
Provides: rubygem(aws-sdk-snowball) = %{version}
Obsoletes: rubygem-aws-sdk-snowball < %{version}
Obsoletes: rubygem(aws-sdk-snowball) < %{version}
...
gem install --install-dir %{buildroot}/%{gem_dir} --bindir %{buildroot}/%{_bindir} --force --no-rdoc --no-ri --no-doc --ignore-dependencies aws-sdk-snowball -v %{version}
