...
Name: rubygem%{alinux_ruby}-fog-terremark
Version: 0.1.0
Release: 1.%{dist}
...
Provides: rubygem%{alinux_ruby}-fog-terremark = %{version}
Provides: rubygem%{alinux_ruby}(fog-terremark) = %{version}
Obsoletes: rubygem%{alinux_ruby}-fog-terremark < %{version}
Obsoletes: rubygem%{alinux_ruby}(fog-terremark) < %{version}


Requires: rubygem%{alinux_ruby}-fog-core
Requires: rubygem%{alinux_ruby}-fog-xml
