...
%global gem_name aws-sdk-resourcegroupstaggingapi
Name: rubygem%{alinux_ruby}-aws-sdk-resourcegroupstaggingapi
Version: 1.0.0
Release: 1.%{dist}
Summary: rubygem aws-sdk-resourcegroupstaggingapi
...
Provides: rubygem%{alinux_ruby}-aws-sdk-resourcegroupstaggingapi = %{version}
Provides: rubygem%{alinux_ruby}(aws-sdk-resourcegroupstaggingapi) = %{version}
Obsoletes: rubygem%{alinux_ruby}-aws-sdk-resourcegroupstaggingapi < %{version}
Obsoletes: rubygem%{alinux_ruby}(aws-sdk-resourcegroupstaggingapi) < %{version}
