...
%global gem_name aws-sigv2
Name: rubygem-aws-sigv2
Version: 1.0.1
Release: 1.%{dist}
...
Provides: rubygem-aws-sigv2 = %{version}
Provides: rubygem(aws-sigv2) = %{version}
Obsoletes: rubygem-aws-sigv2 < %{version}
Obsoletes: rubygem(aws-sigv2) < %{version}
...
gem install --install-dir %{buildroot}/%{gem_dir} --bindir %{buildroot}/%{_bindir} --force --no-rdoc --no-ri --no-doc --ignore-dependencies aws-sigv2 -v %{version}
