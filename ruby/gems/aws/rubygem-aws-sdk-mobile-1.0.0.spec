...
%global gem_name aws-sdk-mobile
Name: rubygem-aws-sdk-mobile
Version: 1.0.0
Release: 1.%{dist}
Summary: rubygem aws-sdk-mobile
...
Provides: rubygem-aws-sdk-mobile = %{version}
Provides: rubygem(aws-sdk-mobile) = %{version}
Obsoletes: rubygem-aws-sdk-mobile < %{version}
Obsoletes: rubygem(aws-sdk-mobile) < %{version}
...
gem install --install-dir %{buildroot}/%{gem_dir} --bindir %{buildroot}/%{_bindir} --force --no-rdoc --no-ri --no-doc --ignore-dependencies aws-sdk-mobile -v %{version}
