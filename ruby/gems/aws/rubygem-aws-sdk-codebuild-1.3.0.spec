...
%global gem_name aws-sdk-codebuild
Name: rubygem-aws-sdk-codebuild
Version: 1.3.0
Release: 1.%{dist}
Summary: rubygem aws-sdk-codebuild
...
Provides: rubygem-aws-sdk-codebuild = %{version}
Provides: rubygem(aws-sdk-codebuild) = %{version}
Obsoletes: rubygem-aws-sdk-codebuild < %{version}
Obsoletes: rubygem(aws-sdk-codebuild) < %{version}
...
gem install --install-dir %{buildroot}/%{gem_dir} --bindir %{buildroot}/%{_bindir} --force --no-rdoc --no-ri --no-doc --ignore-dependencies aws-sdk-codebuild -v %{version}
(
    cd %{buildroot}
