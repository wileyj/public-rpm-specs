...
Name: rubygem%{alinux_ruby}-aws-sdk-marketplacecommerceanalytics
Version: 1.0.0
Release: 1.%{dist}
...
Provides: rubygem%{alinux_ruby}-aws-sdk-marketplacecommerceanalytics = %{version}
Provides: rubygem%{alinux_ruby}(aws-sdk-marketplacecommerceanalytics) = %{version}
Obsoletes: rubygem%{alinux_ruby}-aws-sdk-marketplacecommerceanalytics < %{version}
Obsoletes: rubygem%{alinux_ruby}(aws-sdk-marketplacecommerceanalytics) < %{version}


Requires: rubygem%{alinux_ruby}-aws-sdk-core  = 3
Requires: rubygem%{alinux_ruby}-aws-sigv4  = 1.0
