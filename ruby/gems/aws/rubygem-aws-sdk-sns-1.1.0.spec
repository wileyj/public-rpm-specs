...
%global gem_name aws-sdk-sns
Name: rubygem-aws-sdk-sns
Version: 1.1.0
Release: 1.%{dist}
...
Provides: rubygem-aws-sdk-sns = %{version}
Provides: rubygem(aws-sdk-sns) = %{version}
Obsoletes: rubygem-aws-sdk-sns < %{version}
Obsoletes: rubygem(aws-sdk-sns) < %{version}
...
gem install --install-dir %{buildroot}/%{gem_dir} --bindir %{buildroot}/%{_bindir} --force --no-rdoc --no-ri --no-doc --ignore-dependencies aws-sdk-sns -v %{version}
