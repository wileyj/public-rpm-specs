...
Name: rubygem%{alinux_ruby}-aws-sdk-lightsail
Version: 1.3.0
Release: 1.%{dist}
...
Provides: rubygem%{alinux_ruby}-aws-sdk-lightsail = %{version}
Provides: rubygem%{alinux_ruby}(aws-sdk-lightsail) = %{version}
Obsoletes: rubygem%{alinux_ruby}-aws-sdk-lightsail < %{version}
Obsoletes: rubygem%{alinux_ruby}(aws-sdk-lightsail) < %{version}
