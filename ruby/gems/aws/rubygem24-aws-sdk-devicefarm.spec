...
Name: rubygem%{alinux_ruby}-aws-sdk-devicefarm
Version: 1.2.0
Release: 1.%{dist}
...
Provides: rubygem%{alinux_ruby}-aws-sdk-devicefarm = %{version}
Provides: rubygem%{alinux_ruby}(aws-sdk-devicefarm) = %{version}
Obsoletes: rubygem%{alinux_ruby}-aws-sdk-devicefarm < %{version}
Obsoletes: rubygem%{alinux_ruby}(aws-sdk-devicefarm) < %{version}
