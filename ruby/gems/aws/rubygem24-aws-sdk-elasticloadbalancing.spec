...
Name: rubygem%{alinux_ruby}-aws-sdk-elasticloadbalancing
Version: 1.1.0
Release: 1.%{dist}
...
Provides: rubygem%{alinux_ruby}-aws-sdk-elasticloadbalancing = %{version}
Provides: rubygem%{alinux_ruby}(aws-sdk-elasticloadbalancing) = %{version}
Obsoletes: rubygem%{alinux_ruby}-aws-sdk-elasticloadbalancing < %{version}
Obsoletes: rubygem%{alinux_ruby}(aws-sdk-elasticloadbalancing) < %{version}
