...
%global gem_name aws-sdk-athena
Name: rubygem-aws-sdk-athena
Version: 1.0.0
Release: 1.%{dist}
...
Provides: rubygem-aws-sdk-athena = %{version}
Provides: rubygem(aws-sdk-athena) = %{version}
Obsoletes: rubygem-aws-sdk-athena < %{version}
Obsoletes: rubygem(aws-sdk-athena) < %{version}
...
gem install --install-dir %{buildroot}/%{gem_dir} --bindir %{buildroot}/%{_bindir} --force --no-rdoc --no-ri --no-doc --ignore-dependencies aws-sdk-athena -v %{version}
