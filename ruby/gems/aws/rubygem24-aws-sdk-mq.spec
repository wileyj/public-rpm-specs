...
%global gem_name aws-sdk-mq
Name: rubygem%{alinux_ruby}-aws-sdk-mq
Version: 1.0.0
Release: 1.%{dist}
...
Provides: rubygem%{alinux_ruby}-aws-sdk-mq = %{version}
Provides: rubygem%{alinux_ruby}(aws-sdk-mq) = %{version}
Obsoletes: rubygem%{alinux_ruby}-aws-sdk-mq < %{version}
Obsoletes: rubygem%{alinux_ruby}(aws-sdk-mq) < %{version}
