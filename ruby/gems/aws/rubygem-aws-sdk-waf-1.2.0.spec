...
%global gem_name aws-sdk-waf
Name: rubygem-aws-sdk-waf
Version: 1.2.0
Release: 1.%{dist}
...
Provides: rubygem-aws-sdk-waf = %{version}
Provides: rubygem(aws-sdk-waf) = %{version}
Obsoletes: rubygem-aws-sdk-waf < %{version}
Obsoletes: rubygem(aws-sdk-waf) < %{version}
...
gem install --install-dir %{buildroot}/%{gem_dir} --bindir %{buildroot}/%{_bindir} --force --no-rdoc --no-ri --no-doc --ignore-dependencies aws-sdk-waf -v %{version}
