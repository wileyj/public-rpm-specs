...
%global gem_name aws-sdk-pricing
Name: rubygem-aws-sdk-pricing
Version: 1.0.0
Release: 1.%{dist}
Summary: rubygem aws-sdk-pricing
...
Provides: rubygem-aws-sdk-pricing = %{version}
Provides: rubygem(aws-sdk-pricing) = %{version}
Obsoletes: rubygem-aws-sdk-pricing < %{version}
Obsoletes: rubygem(aws-sdk-pricing) < %{version}
...
%description
Official AWS Ruby gem for AWS Price List Service (AWS Pricing). This gem is part of the AWS SDK for Ruby.

%prep
%build
%install
export CONFIGURE_ARGS="--with-cflags='%{optflags}'"
gem install --install-dir %{buildroot}/%{gem_dir} --bindir %{buildroot}/%{_bindir} --force --no-rdoc --no-ri --no-doc --ignore-dependencies aws-sdk-pricing -v %{version}
