...
Name: rubygem%{alinux_ruby}-aws-sdk-codebuild
Version: 1.5.0
Release: 1.%{dist}
...
Provides: rubygem%{alinux_ruby}-aws-sdk-codebuild = %{version}
Provides: rubygem%{alinux_ruby}(aws-sdk-codebuild) = %{version}
Obsoletes: rubygem%{alinux_ruby}-aws-sdk-codebuild < %{version}
Obsoletes: rubygem%{alinux_ruby}(aws-sdk-codebuild) < %{version}
