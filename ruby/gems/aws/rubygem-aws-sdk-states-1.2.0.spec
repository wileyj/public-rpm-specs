...
%global gem_name aws-sdk-states
Name: rubygem-aws-sdk-states
Version: 1.2.0
Release: 1.%{dist}
...
Provides: rubygem-aws-sdk-states = %{version}
Provides: rubygem(aws-sdk-states) = %{version}
Obsoletes: rubygem-aws-sdk-states < %{version}
Obsoletes: rubygem(aws-sdk-states) < %{version}
...
%description
Official AWS Ruby gem for AWS Step Functions (AWS SFN). This gem is part of the AWS SDK for Ruby.

%prep
%build
%install
export CONFIGURE_ARGS="--with-cflags='%{optflags}'"
gem install --install-dir %{buildroot}/%{gem_dir} --bindir %{buildroot}/%{_bindir} --force --no-rdoc --no-ri --no-doc --ignore-dependencies aws-sdk-states -v %{version}
