...
%global gem_name aws-sdk-workmail
Name: rubygem%{alinux_ruby}-aws-sdk-workmail
Version: 1.0.0
Release: 1.%{dist}
Summary: rubygem aws-sdk-workmail
...
Provides: rubygem%{alinux_ruby}-aws-sdk-workmail = %{version}
Provides: rubygem%{alinux_ruby}(aws-sdk-workmail) = %{version}
Obsoletes: rubygem%{alinux_ruby}-aws-sdk-workmail < %{version}
Obsoletes: rubygem%{alinux_ruby}(aws-sdk-workmail) < %{version}
