...
%global gem_name aws-sdk-opsworkscm
Name: rubygem-aws-sdk-opsworkscm
Version: 1.2.0
Release: 1.%{dist}
Summary: rubygem aws-sdk-opsworkscm
...
Provides: rubygem-aws-sdk-opsworkscm = %{version}
Provides: rubygem(aws-sdk-opsworkscm) = %{version}
Obsoletes: rubygem-aws-sdk-opsworkscm < %{version}
Obsoletes: rubygem(aws-sdk-opsworkscm) < %{version}
...
gem install --install-dir %{buildroot}/%{gem_dir} --bindir %{buildroot}/%{_bindir} --force --no-rdoc --no-ri --no-doc --ignore-dependencies aws-sdk-opsworkscm -v %{version}
