...
%global gem_name aws-sdk-marketplacemetering
Name: rubygem-aws-sdk-marketplacemetering
Version: 1.0.0
Release: 1.%{dist}
Summary: rubygem aws-sdk-marketplacemetering
...
Provides: rubygem-aws-sdk-marketplacemetering = %{version}
Provides: rubygem(aws-sdk-marketplacemetering) = %{version}
Obsoletes: rubygem-aws-sdk-marketplacemetering < %{version}
Obsoletes: rubygem(aws-sdk-marketplacemetering) < %{version}
...
gem install --install-dir %{buildroot}/%{gem_dir} --bindir %{buildroot}/%{_bindir} --force --no-rdoc --no-ri --no-doc --ignore-dependencies aws-sdk-marketplacemetering -v %{version}
