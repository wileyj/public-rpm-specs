...
%global gem_name aws-sdk-alexaforbusiness
Name: rubygem%{alinux_ruby}-aws-sdk-alexaforbusiness
Version: 1.0.0
Release: 1.%{dist}
...
Provides: rubygem%{alinux_ruby}-aws-sdk-alexaforbusiness = %{version}
Provides: rubygem%{alinux_ruby}(aws-sdk-alexaforbusiness) = %{version}
Obsoletes: rubygem%{alinux_ruby}-aws-sdk-alexaforbusiness < %{version}
Obsoletes: rubygem%{alinux_ruby}(aws-sdk-alexaforbusiness) < %{version}
...
%description
Official AWS Ruby gem for Alexa For Business. This gem is part of the AWS SDK for Ruby.
