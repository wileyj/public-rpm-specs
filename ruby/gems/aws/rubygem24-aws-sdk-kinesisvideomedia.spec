...
%global gem_name aws-sdk-kinesisvideomedia
Name: rubygem%{alinux_ruby}-aws-sdk-kinesisvideomedia
Version: 1.0.0
Release: 1.%{dist}
Summary: rubygem aws-sdk-kinesisvideomedia
...
Provides: rubygem%{alinux_ruby}-aws-sdk-kinesisvideomedia = %{version}
Provides: rubygem%{alinux_ruby}(aws-sdk-kinesisvideomedia) = %{version}
Obsoletes: rubygem%{alinux_ruby}-aws-sdk-kinesisvideomedia < %{version}
Obsoletes: rubygem%{alinux_ruby}(aws-sdk-kinesisvideomedia) < %{version}
