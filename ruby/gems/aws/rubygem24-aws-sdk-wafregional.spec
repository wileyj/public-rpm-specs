...
%global gem_name aws-sdk-wafregional
Name: rubygem%{alinux_ruby}-aws-sdk-wafregional
Version: 1.3.0
Release: 1.%{dist}
Summary: rubygem aws-sdk-wafregional
...
Provides: rubygem%{alinux_ruby}-aws-sdk-wafregional = %{version}
Provides: rubygem%{alinux_ruby}(aws-sdk-wafregional) = %{version}
Obsoletes: rubygem%{alinux_ruby}-aws-sdk-wafregional < %{version}
Obsoletes: rubygem%{alinux_ruby}(aws-sdk-wafregional) < %{version}
