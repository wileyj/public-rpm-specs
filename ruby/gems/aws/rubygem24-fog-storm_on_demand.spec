...
Name: rubygem%{alinux_ruby}-fog-storm_on_demand
Version: 0.1.1
Release: 1.%{dist}
...
Provides: rubygem%{alinux_ruby}-fog-storm_on_demand = %{version}
Provides: rubygem%{alinux_ruby}(fog-storm_on_demand) = %{version}
Obsoletes: rubygem%{alinux_ruby}-fog-storm_on_demand < %{version}
Obsoletes: rubygem%{alinux_ruby}(fog-storm_on_demand) < %{version}
