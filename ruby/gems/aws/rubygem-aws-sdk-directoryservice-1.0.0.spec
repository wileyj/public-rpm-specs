...
Provides: rubygem-aws-sdk-directoryservice = %{version}
Provides: rubygem(aws-sdk-directoryservice) = %{version}
Obsoletes: rubygem-aws-sdk-directoryservice < %{version}
Obsoletes: rubygem(aws-sdk-directoryservice) < %{version}
...
gem install --install-dir %{buildroot}/%{gem_dir} --bindir %{buildroot}/%{_bindir} --force --no-rdoc --no-ri --no-doc --ignore-dependencies aws-sdk-directoryservice -v %{version}
