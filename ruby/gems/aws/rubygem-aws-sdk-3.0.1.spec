...
%global gem_name aws-sdk
Name: rubygem-aws-sdk
Version: 3.0.1
Release: 1.%{dist}
Summary: rubygem aws-sdk
...
Provides: rubygem-aws-sdk = %{version}
Provides: rubygem(aws-sdk) = %{version}
Obsoletes: rubygem-aws-sdk < %{version}
Obsoletes: rubygem(aws-sdk) < %{version}


Requires: rubygem-aws-sdk-resources  = 3
...
gem install --install-dir %{buildroot}/%{gem_dir} --bindir %{buildroot}/%{_bindir} --force --no-rdoc --no-ri --no-doc --ignore-dependencies aws-sdk -v %{version}
