...
%global gem_name aws-sdk-cloudsearchdomain
Name: rubygem-aws-sdk-cloudsearchdomain
Version: 1.0.0
Release: 1.%{dist}
Summary: rubygem aws-sdk-cloudsearchdomain
...
Provides: rubygem-aws-sdk-cloudsearchdomain = %{version}
Provides: rubygem(aws-sdk-cloudsearchdomain) = %{version}
Obsoletes: rubygem-aws-sdk-cloudsearchdomain < %{version}
Obsoletes: rubygem(aws-sdk-cloudsearchdomain) < %{version}
...
gem install --install-dir %{buildroot}/%{gem_dir} --bindir %{buildroot}/%{_bindir} --force --no-rdoc --no-ri --no-doc --ignore-dependencies aws-sdk-cloudsearchdomain -v %{version}
