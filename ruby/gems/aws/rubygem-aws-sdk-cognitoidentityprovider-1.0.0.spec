...
%global gem_name aws-sdk-cognitoidentityprovider
Name: rubygem-aws-sdk-cognitoidentityprovider
Version: 1.0.0
Release: 1.%{dist}
...
Provides: rubygem-aws-sdk-cognitoidentityprovider = %{version}
Provides: rubygem(aws-sdk-cognitoidentityprovider) = %{version}
Obsoletes: rubygem-aws-sdk-cognitoidentityprovider < %{version}
Obsoletes: rubygem(aws-sdk-cognitoidentityprovider) < %{version}
...
gem install --install-dir %{buildroot}/%{gem_dir} --bindir %{buildroot}/%{_bindir} --force --no-rdoc --no-ri --no-doc --ignore-dependencies aws-sdk-cognitoidentityprovider -v %{version}
