...
%global gem_name fog-powerdns
Name: rubygem-fog-powerdns
Version: 0.1.1
Release: 1.%{dist}
Summary: rubygem fog-powerdns
Group: Development/Languages
License: MIT
URL: http://github.com/cluobah/fog-powerdns
Vendor: %{vendor}
Packager: %{packager}
Requires: ruby rubygems
Provides: rubygem-fog-powerdns = %{version}
Provides: rubygem(fog-powerdns) = %{version}
Obsoletes: rubygem-fog-powerdns < %{version}
Obsoletes: rubygem(fog-powerdns) < %{version}


Requires: rubygem-fog-core  = 1.27
...
gem install --install-dir %{buildroot}/%{gem_dir} --bindir %{buildroot}/%{_bindir} --force --no-rdoc --no-ri --no-doc --ignore-dependencies fog-powerdns -v %{version}
