...
Name: rubygem%{alinux_ruby}-fog-profitbricks
Version: 4.1.1
Release: 1.%{dist}
...
Provides: rubygem%{alinux_ruby}-fog-profitbricks = %{version}
Provides: rubygem%{alinux_ruby}(fog-profitbricks) = %{version}
Obsoletes: rubygem%{alinux_ruby}-fog-profitbricks < %{version}
Obsoletes: rubygem%{alinux_ruby}(fog-profitbricks) < %{version}


Requires: rubygem%{alinux_ruby}-fog-core  = 1.42
