...
Name: rubygem%{alinux_ruby}-aws-sdk-appstream
Version: 1.4.0
Release: 1.%{dist}
...
Provides: rubygem%{alinux_ruby}-aws-sdk-appstream = %{version}
Provides: rubygem%{alinux_ruby}(aws-sdk-appstream) = %{version}
Obsoletes: rubygem%{alinux_ruby}-aws-sdk-appstream < %{version}
Obsoletes: rubygem%{alinux_ruby}(aws-sdk-appstream) < %{version}
