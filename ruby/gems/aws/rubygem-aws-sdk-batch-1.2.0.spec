...
%global gem_name aws-sdk-batch
Name: rubygem-aws-sdk-batch
Version: 1.2.0
Release: 1.%{dist}
...
Provides: rubygem-aws-sdk-batch = %{version}
Provides: rubygem(aws-sdk-batch) = %{version}
Obsoletes: rubygem-aws-sdk-batch < %{version}
Obsoletes: rubygem(aws-sdk-batch) < %{version}
...
gem install --install-dir %{buildroot}/%{gem_dir} --bindir %{buildroot}/%{_bindir} --force --no-rdoc --no-ri --no-doc --ignore-dependencies aws-sdk-batch -v %{version}
