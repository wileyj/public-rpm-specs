...
Name: rubygem%{alinux_ruby}-aws-sdk-cloudwatchevents
Version: 1.1.0
Release: 1.%{dist}
...
Provides: rubygem%{alinux_ruby}-aws-sdk-cloudwatchevents = %{version}
Provides: rubygem%{alinux_ruby}(aws-sdk-cloudwatchevents) = %{version}
Obsoletes: rubygem%{alinux_ruby}-aws-sdk-cloudwatchevents < %{version}
Obsoletes: rubygem%{alinux_ruby}(aws-sdk-cloudwatchevents) < %{version}
