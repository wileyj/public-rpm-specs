...
%global gem_name aws-sdk-storagegateway
Name: rubygem-aws-sdk-storagegateway
Version: 1.1.0
Release: 1.%{dist}
Summary: rubygem aws-sdk-storagegateway
...
Provides: rubygem-aws-sdk-storagegateway = %{version}
Provides: rubygem(aws-sdk-storagegateway) = %{version}
Obsoletes: rubygem-aws-sdk-storagegateway < %{version}
Obsoletes: rubygem(aws-sdk-storagegateway) < %{version}
...
gem install --install-dir %{buildroot}/%{gem_dir} --bindir %{buildroot}/%{_bindir} --force --no-rdoc --no-ri --no-doc --ignore-dependencies aws-sdk-storagegateway -v %{version}
(
    cd %{buildroot}
