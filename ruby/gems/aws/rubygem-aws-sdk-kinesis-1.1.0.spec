...
%global gem_name aws-sdk-kinesis
Name: rubygem-aws-sdk-kinesis
Version: 1.1.0
Release: 1.%{dist}
...
Provides: rubygem-aws-sdk-kinesis = %{version}
Provides: rubygem(aws-sdk-kinesis) = %{version}
Obsoletes: rubygem-aws-sdk-kinesis < %{version}
Obsoletes: rubygem(aws-sdk-kinesis) < %{version}
...
gem install --install-dir %{buildroot}/%{gem_dir} --bindir %{buildroot}/%{_bindir} --force --no-rdoc --no-ri --no-doc --ignore-dependencies aws-sdk-kinesis -v %{version}
