...
%global gem_name aws-sdk-sms
Name: rubygem-aws-sdk-sms
Version: 1.0.0
Release: 1.%{dist}
...
Provides: rubygem-aws-sdk-sms = %{version}
Provides: rubygem(aws-sdk-sms) = %{version}
Obsoletes: rubygem-aws-sdk-sms < %{version}
Obsoletes: rubygem(aws-sdk-sms) < %{version}
...
gem install --install-dir %{buildroot}/%{gem_dir} --bindir %{buildroot}/%{_bindir} --force --no-rdoc --no-ri --no-doc --ignore-dependencies aws-sdk-sms -v %{version}
