...
%global gem_name aws-sdk-autoscaling
Name: rubygem-aws-sdk-autoscaling
Version: 1.3.0
Release: 1.%{dist}
...
Provides: rubygem-aws-sdk-autoscaling = %{version}
Provides: rubygem(aws-sdk-autoscaling) = %{version}
Obsoletes: rubygem-aws-sdk-autoscaling < %{version}
Obsoletes: rubygem(aws-sdk-autoscaling) < %{version}
...
gem install --install-dir %{buildroot}/%{gem_dir} --bindir %{buildroot}/%{_bindir} --force --no-rdoc --no-ri --no-doc --ignore-dependencies aws-sdk-autoscaling -v %{version}
