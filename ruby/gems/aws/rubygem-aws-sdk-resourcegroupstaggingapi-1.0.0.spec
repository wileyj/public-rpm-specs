...
Provides: rubygem-aws-sdk-resourcegroupstaggingapi = %{version}
Provides: rubygem(aws-sdk-resourcegroupstaggingapi) = %{version}
Obsoletes: rubygem-aws-sdk-resourcegroupstaggingapi < %{version}
Obsoletes: rubygem(aws-sdk-resourcegroupstaggingapi) < %{version}
...
gem install --install-dir %{buildroot}/%{gem_dir} --bindir %{buildroot}/%{_bindir} --force --no-rdoc --no-ri --no-doc --ignore-dependencies aws-sdk-resourcegroupstaggingapi -v %{version}
