...
Name: rubygem-aws-sdk-v1
Version: 1.67.0
Release: 1.%{dist}
Summary: rubygem aws-sdk-v1
...
Provides: rubygem-aws-sdk-v1 = %{version}
Provides: rubygem(aws-sdk-v1) = %{version}
Obsoletes: rubygem-aws-sdk-v1 < %{version}
Obsoletes: rubygem(aws-sdk-v1) < %{version}


Requires: rubygem-json   = 1.4
Requires: rubygem-nokogiri   = 1
...
gem install --install-dir %{buildroot}/%{gem_dir} --bindir %{buildroot}/%{_bindir} --force --no-rdoc --no-ri --no-doc --ignore-dependencies aws-sdk-v1 -v %{version}
(
    cd %{buildroot}
