...
%global gem_name aws-sdk-iotdataplane
Name: rubygem-aws-sdk-iotdataplane
Version: 1.0.0
Release: 1.%{dist}
Summary: rubygem aws-sdk-iotdataplane
...
Provides: rubygem-aws-sdk-iotdataplane = %{version}
Provides: rubygem(aws-sdk-iotdataplane) = %{version}
Obsoletes: rubygem-aws-sdk-iotdataplane < %{version}
Obsoletes: rubygem(aws-sdk-iotdataplane) < %{version}
...
%description
Official AWS Ruby gem for AWS IoT Data Plane. This gem is part of the AWS SDK for Ruby.

%prep
%build
%install
export CONFIGURE_ARGS="--with-cflags='%{optflags}'"
gem install --install-dir %{buildroot}/%{gem_dir} --bindir %{buildroot}/%{_bindir} --force --no-rdoc --no-ri --no-doc --ignore-dependencies aws-sdk-iotdataplane -v %{version}
