...
Name: rubygem%{alinux_ruby}-aws-sdk-cloudfront
Version: 1.1.0
Release: 1.%{dist}
...
Provides: rubygem%{alinux_ruby}-aws-sdk-cloudfront = %{version}
Provides: rubygem%{alinux_ruby}(aws-sdk-cloudfront) = %{version}
Obsoletes: rubygem%{alinux_ruby}-aws-sdk-cloudfront < %{version}
Obsoletes: rubygem%{alinux_ruby}(aws-sdk-cloudfront) < %{version}
