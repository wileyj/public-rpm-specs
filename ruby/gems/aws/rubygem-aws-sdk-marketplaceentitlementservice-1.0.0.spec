...
%global gem_name aws-sdk-marketplaceentitlementservice
Name: rubygem-aws-sdk-marketplaceentitlementservice
Version: 1.0.0
Release: 1.%{dist}
Summary: rubygem aws-sdk-marketplaceentitlementservice
...
Provides: rubygem-aws-sdk-marketplaceentitlementservice = %{version}
Provides: rubygem(aws-sdk-marketplaceentitlementservice) = %{version}
Obsoletes: rubygem-aws-sdk-marketplaceentitlementservice < %{version}
Obsoletes: rubygem(aws-sdk-marketplaceentitlementservice) < %{version}
...
gem install --install-dir %{buildroot}/%{gem_dir} --bindir %{buildroot}/%{_bindir} --force --no-rdoc --no-ri --no-doc --ignore-dependencies aws-sdk-marketplaceentitlementservice -v %{version}
