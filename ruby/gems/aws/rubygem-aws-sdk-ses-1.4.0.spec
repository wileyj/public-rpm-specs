...
%global gem_name aws-sdk-ses
Name: rubygem-aws-sdk-ses
Version: 1.4.0
Release: 1.%{dist}
...
Provides: rubygem-aws-sdk-ses = %{version}
Provides: rubygem(aws-sdk-ses) = %{version}
Obsoletes: rubygem-aws-sdk-ses < %{version}
Obsoletes: rubygem(aws-sdk-ses) < %{version}
...
gem install --install-dir %{buildroot}/%{gem_dir} --bindir %{buildroot}/%{_bindir} --force --no-rdoc --no-ri --no-doc --ignore-dependencies aws-sdk-ses -v %{version}
