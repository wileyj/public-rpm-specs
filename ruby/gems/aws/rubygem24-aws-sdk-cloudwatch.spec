...
Name: rubygem%{alinux_ruby}-aws-sdk-cloudwatch
Version: 1.4.0
Release: 1.%{dist}
...
Provides: rubygem%{alinux_ruby}-aws-sdk-cloudwatch = %{version}
Provides: rubygem%{alinux_ruby}(aws-sdk-cloudwatch) = %{version}
Obsoletes: rubygem%{alinux_ruby}-aws-sdk-cloudwatch < %{version}
Obsoletes: rubygem%{alinux_ruby}(aws-sdk-cloudwatch) < %{version}
