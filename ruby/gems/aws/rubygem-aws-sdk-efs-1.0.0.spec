...
%global gem_name aws-sdk-efs
Name: rubygem-aws-sdk-efs
Version: 1.0.0
Release: 1.%{dist}
...
Provides: rubygem-aws-sdk-efs = %{version}
Provides: rubygem(aws-sdk-efs) = %{version}
Obsoletes: rubygem-aws-sdk-efs < %{version}
Obsoletes: rubygem(aws-sdk-efs) < %{version}
...
gem install --install-dir %{buildroot}/%{gem_dir} --bindir %{buildroot}/%{_bindir} --force --no-rdoc --no-ri --no-doc --ignore-dependencies aws-sdk-efs -v %{version}
