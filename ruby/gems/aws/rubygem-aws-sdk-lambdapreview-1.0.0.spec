...
%global gem_name aws-sdk-lambdapreview
Name: rubygem-aws-sdk-lambdapreview
Version: 1.0.0
Release: 1.%{dist}
Summary: rubygem aws-sdk-lambdapreview
...
Provides: rubygem-aws-sdk-lambdapreview = %{version}
Provides: rubygem(aws-sdk-lambdapreview) = %{version}
Obsoletes: rubygem-aws-sdk-lambdapreview < %{version}
Obsoletes: rubygem(aws-sdk-lambdapreview) < %{version}
...
gem install --install-dir %{buildroot}/%{gem_dir} --bindir %{buildroot}/%{_bindir} --force --no-rdoc --no-ri --no-doc --ignore-dependencies aws-sdk-lambdapreview -v %{version}
