...
%global gem_name aws-sdk-greengrass
Name: rubygem%{alinux_ruby}-aws-sdk-greengrass
Version: 1.2.0
Release: 1.%{dist}
Summary: rubygem aws-sdk-greengrass
...
Provides: rubygem%{alinux_ruby}-aws-sdk-greengrass = %{version}
Provides: rubygem%{alinux_ruby}(aws-sdk-greengrass) = %{version}
Obsoletes: rubygem%{alinux_ruby}-aws-sdk-greengrass < %{version}
Obsoletes: rubygem%{alinux_ruby}(aws-sdk-greengrass) < %{version}
