...
%global gem_name aws-sdk-appsync
Name: rubygem%{alinux_ruby}-aws-sdk-appsync
Version: 1.0.0
Release: 1.%{dist}
Summary: rubygem aws-sdk-appsync
...
Provides: rubygem%{alinux_ruby}-aws-sdk-appsync = %{version}
Provides: rubygem%{alinux_ruby}(aws-sdk-appsync) = %{version}
Obsoletes: rubygem%{alinux_ruby}-aws-sdk-appsync < %{version}
Obsoletes: rubygem%{alinux_ruby}(aws-sdk-appsync) < %{version}
