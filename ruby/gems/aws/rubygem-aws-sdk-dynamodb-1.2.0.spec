...
%global gem_name aws-sdk-dynamodb
Name: rubygem-aws-sdk-dynamodb
Version: 1.2.0
Release: 1.%{dist}
...
Provides: rubygem-aws-sdk-dynamodb = %{version}
Provides: rubygem(aws-sdk-dynamodb) = %{version}
Obsoletes: rubygem-aws-sdk-dynamodb < %{version}
Obsoletes: rubygem(aws-sdk-dynamodb) < %{version}
...
gem install --install-dir %{buildroot}/%{gem_dir} --bindir %{buildroot}/%{_bindir} --force --no-rdoc --no-ri --no-doc --ignore-dependencies aws-sdk-dynamodb -v %{version}
