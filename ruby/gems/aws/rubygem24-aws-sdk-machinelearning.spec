...
Name: rubygem%{alinux_ruby}-aws-sdk-machinelearning
Version: 1.0.0
Release: 1.%{dist}
...
Provides: rubygem%{alinux_ruby}-aws-sdk-machinelearning = %{version}
Provides: rubygem%{alinux_ruby}(aws-sdk-machinelearning) = %{version}
Obsoletes: rubygem%{alinux_ruby}-aws-sdk-machinelearning < %{version}
Obsoletes: rubygem%{alinux_ruby}(aws-sdk-machinelearning) < %{version}
