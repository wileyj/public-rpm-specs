...
Provides: rubygem-aws-sdk-directconnect = %{version}
Provides: rubygem(aws-sdk-directconnect) = %{version}
Obsoletes: rubygem-aws-sdk-directconnect < %{version}
Obsoletes: rubygem(aws-sdk-directconnect) < %{version}
...
gem install --install-dir %{buildroot}/%{gem_dir} --bindir %{buildroot}/%{_bindir} --force --no-rdoc --no-ri --no-doc --ignore-dependencies aws-sdk-directconnect -v %{version}
