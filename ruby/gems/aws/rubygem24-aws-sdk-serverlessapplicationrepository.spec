...
%global gem_name aws-sdk-serverlessapplicationrepository
Name: rubygem%{alinux_ruby}-aws-sdk-serverlessapplicationrepository
Version: 1.0.0
Release: 1.%{dist}
Summary: rubygem aws-sdk-serverlessapplicationrepository
...
Provides: rubygem%{alinux_ruby}-aws-sdk-serverlessapplicationrepository = %{version}
Provides: rubygem%{alinux_ruby}(aws-sdk-serverlessapplicationrepository) = %{version}
Obsoletes: rubygem%{alinux_ruby}-aws-sdk-serverlessapplicationrepository < %{version}
Obsoletes: rubygem%{alinux_ruby}(aws-sdk-serverlessapplicationrepository) < %{version}
