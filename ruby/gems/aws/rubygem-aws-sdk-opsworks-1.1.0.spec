...
%global gem_name aws-sdk-opsworks
Name: rubygem-aws-sdk-opsworks
Version: 1.1.0
Release: 1.%{dist}
Summary: rubygem aws-sdk-opsworks
...
Provides: rubygem-aws-sdk-opsworks = %{version}
Provides: rubygem(aws-sdk-opsworks) = %{version}
Obsoletes: rubygem-aws-sdk-opsworks < %{version}
Obsoletes: rubygem(aws-sdk-opsworks) < %{version}
...
%description
Official AWS Ruby gem for AWS OpsWorks. This gem is part of the AWS SDK for Ruby.

%prep
%build
%install
export CONFIGURE_ARGS="--with-cflags='%{optflags}'"
gem install --install-dir %{buildroot}/%{gem_dir} --bindir %{buildroot}/%{_bindir} --force --no-rdoc --no-ri --no-doc --ignore-dependencies aws-sdk-opsworks -v %{version}
