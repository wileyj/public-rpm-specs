...
%global gem_name aws-sdk-cloudfront
Name: rubygem-aws-sdk-cloudfront
Version: 1.1.0
Release: 1.%{dist}
...
Provides: rubygem-aws-sdk-cloudfront = %{version}
Provides: rubygem(aws-sdk-cloudfront) = %{version}
Obsoletes: rubygem-aws-sdk-cloudfront < %{version}
Obsoletes: rubygem(aws-sdk-cloudfront) < %{version}
...
gem install --install-dir %{buildroot}/%{gem_dir} --bindir %{buildroot}/%{_bindir} --force --no-rdoc --no-ri --no-doc --ignore-dependencies aws-sdk-cloudfront -v %{version}
