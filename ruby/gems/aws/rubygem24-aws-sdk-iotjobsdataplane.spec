...
%global gem_name aws-sdk-iotjobsdataplane
Name: rubygem%{alinux_ruby}-aws-sdk-iotjobsdataplane
Version: 1.0.0
Release: 1.%{dist}
Summary: rubygem aws-sdk-iotjobsdataplane
...
Provides: rubygem%{alinux_ruby}-aws-sdk-iotjobsdataplane = %{version}
Provides: rubygem%{alinux_ruby}(aws-sdk-iotjobsdataplane) = %{version}
Obsoletes: rubygem%{alinux_ruby}-aws-sdk-iotjobsdataplane < %{version}
Obsoletes: rubygem%{alinux_ruby}(aws-sdk-iotjobsdataplane) < %{version}
...
%description
Official AWS Ruby gem for AWS IoT Jobs Data Plane. This gem is part of the AWS SDK for Ruby.
