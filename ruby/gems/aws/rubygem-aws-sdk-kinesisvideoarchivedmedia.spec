...
Name: rubygem-aws-sdk-kinesisvideoarchivedmedia
Version: 1.0.0
Release: 1.%{dist}
...
Provides: rubygem-aws-sdk-kinesisvideoarchivedmedia = %{version}
Provides: rubygem(aws-sdk-kinesisvideoarchivedmedia) = %{version}
Obsoletes: rubygem-aws-sdk-kinesisvideoarchivedmedia < %{version}
Obsoletes: rubygem(aws-sdk-kinesisvideoarchivedmedia) < %{version}
