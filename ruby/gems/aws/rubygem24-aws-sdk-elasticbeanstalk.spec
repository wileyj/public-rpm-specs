...
Name: rubygem%{alinux_ruby}-aws-sdk-elasticbeanstalk
Version: 1.3.0
Release: 1.%{dist}
...
Provides: rubygem%{alinux_ruby}-aws-sdk-elasticbeanstalk = %{version}
Provides: rubygem%{alinux_ruby}(aws-sdk-elasticbeanstalk) = %{version}
Obsoletes: rubygem%{alinux_ruby}-aws-sdk-elasticbeanstalk < %{version}
Obsoletes: rubygem%{alinux_ruby}(aws-sdk-elasticbeanstalk) < %{version}
