...
%global gem_name aws-sdk-medialive
Name: rubygem%{alinux_ruby}-aws-sdk-medialive
Version: 1.0.0
Release: 1.%{dist}
Summary: rubygem aws-sdk-medialive
...
Provides: rubygem%{alinux_ruby}-aws-sdk-medialive = %{version}
Provides: rubygem%{alinux_ruby}(aws-sdk-medialive) = %{version}
Obsoletes: rubygem%{alinux_ruby}-aws-sdk-medialive < %{version}
Obsoletes: rubygem%{alinux_ruby}(aws-sdk-medialive) < %{version}
...
%description
Official AWS Ruby gem for AWS Elemental MediaLive (MediaLive). This gem is part of the AWS SDK for Ruby.
