...
Name: rubygem-fog-profitbricks
Version: 4.0.0
Release: 1.%{dist}
Summary: rubygem fog-profitbricks
...
Provides: rubygem-fog-profitbricks = %{version}
Provides: rubygem(fog-profitbricks) = %{version}
Obsoletes: rubygem-fog-profitbricks < %{version}
Obsoletes: rubygem(fog-profitbricks) < %{version}
...
gem install --install-dir %{buildroot}/%{gem_dir} --bindir %{buildroot}/%{_bindir} --force --no-rdoc --no-ri --no-doc --ignore-dependencies fog-profitbricks -v %{version}
