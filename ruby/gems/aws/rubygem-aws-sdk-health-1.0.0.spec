...
%global gem_name aws-sdk-health
Name: rubygem-aws-sdk-health
Version: 1.0.0
Release: 1.%{dist}
Summary: rubygem aws-sdk-health
...
Provides: rubygem-aws-sdk-health = %{version}
Provides: rubygem(aws-sdk-health) = %{version}
Obsoletes: rubygem-aws-sdk-health < %{version}
Obsoletes: rubygem(aws-sdk-health) < %{version}
...
%description
Official AWS Ruby gem for AWS Health APIs and Notifications (AWSHealth). This gem is part of the AWS SDK for Ruby.

%prep
%build
%install
export CONFIGURE_ARGS="--with-cflags='%{optflags}'"
gem install --install-dir %{buildroot}/%{gem_dir} --bindir %{buildroot}/%{_bindir} --force --no-rdoc --no-ri --no-doc --ignore-dependencies aws-sdk-health -v %{version}
