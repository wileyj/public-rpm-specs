...
%global gem_name aws-sdk-cognitoidentity
Name: rubygem-aws-sdk-cognitoidentity
Version: 1.0.0
Release: 1.%{dist}
...
Provides: rubygem-aws-sdk-cognitoidentity = %{version}
Provides: rubygem(aws-sdk-cognitoidentity) = %{version}
Obsoletes: rubygem-aws-sdk-cognitoidentity < %{version}
Obsoletes: rubygem(aws-sdk-cognitoidentity) < %{version}
...
%description
Official AWS Ruby gem for Amazon Cognito Identity. This gem is part of the AWS SDK for Ruby.

%prep
%build
%install
export CONFIGURE_ARGS="--with-cflags='%{optflags}'"
gem install --install-dir %{buildroot}/%{gem_dir} --bindir %{buildroot}/%{_bindir} --force --no-rdoc --no-ri --no-doc --ignore-dependencies aws-sdk-cognitoidentity -v %{version}
