...
Name: rubygem%{alinux_ruby}-http-cookie
Version: 1.0.3
Release: 1.%{dist}
AutoReqProv : no
...
Provides: rubygem%{alinux_ruby}-http-cookie = %{version}
Provides: rubygem%{alinux_ruby}(http-cookie) = %{version}
Obsoletes: rubygem%{alinux_ruby}-http-cookie < %{version}
Obsoletes: rubygem%{alinux_ruby}(http-cookie) < %{version}


Requires: rubygem%{alinux_ruby}-domain_name  >= 0.5
