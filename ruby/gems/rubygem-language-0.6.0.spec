...
%global gem_name language
Name: rubygem-language
Version: 0.6.0
Release: 1.%{dist}
Summary: rubygem language
Group: Development/Languages
License: GPL
URL: http://rubyworks.github.com/language
Vendor: %{vendor}
Packager: %{packager}
Requires: ruby rubygems
Provides: rubygem-language = %{version}
Provides: rubygem(language) = %{version}
Obsoletes: rubygem-language < %{version}
Obsoletes: rubygem(language) < %{version}
...
gem install --install-dir %{buildroot}/%{gem_dir} --bindir %{buildroot}/%{_bindir} --force --no-rdoc --no-ri --no-doc --ignore-dependencies language -v %{version}
