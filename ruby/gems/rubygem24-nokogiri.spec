...
Name: rubygem%{alinux_ruby}-nokogiri
Version: 1.6.0
Release: 1.%{dist}
AutoReqProv : no
...
Provides: rubygem%{alinux_ruby}-nokogiri = %{version}
Provides: rubygem%{alinux_ruby}(nokogiri) = %{version}
Obsoletes: rubygem%{alinux_ruby}-nokogiri < %{version}
Obsoletes: rubygem%{alinux_ruby}(nokogiri) < %{version}


Requires: rubygem%{alinux_ruby}-mini_portile  >= 0.5.0
