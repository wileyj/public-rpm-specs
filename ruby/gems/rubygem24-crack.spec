...
Name: rubygem%{alinux_ruby}-crack
Version: 0.4.2
Release: 1.%{dist}
AutoReqProv : no
...
Provides: rubygem%{alinux_ruby}-crack = %{version}
Provides: rubygem%{alinux_ruby}(crack) = %{version}
Obsoletes: rubygem%{alinux_ruby}-crack < %{version}
Obsoletes: rubygem%{alinux_ruby}(crack) < %{version}


Requires: rubygem%{alinux_ruby}-safe_yaml  >= 1.0.0
