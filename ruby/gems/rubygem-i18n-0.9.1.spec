...
Provides: rubygem(i18n) = %{version}
Obsoletes: rubygem-i18n < %{version}
Obsoletes: rubygem(i18n) < %{version}
...
gem install --install-dir %{buildroot}/%{gem_dir} --bindir %{buildroot}/%{_bindir} --force --no-rdoc --no-ri --no-doc --ignore-dependencies i18n -v %{version}
