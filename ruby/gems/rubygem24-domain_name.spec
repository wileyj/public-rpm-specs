...
Name: rubygem%{alinux_ruby}-domain_name
...
Provides: rubygem%{alinux_ruby}-domain_name = %{version}
Provides: rubygem%{alinux_ruby}(domain_name) = %{version}
Obsoletes: rubygem%{alinux_ruby}-domain_name < %{version}
Obsoletes: rubygem%{alinux_ruby}(domain_name) < %{version}


Requires: rubygem%{alinux_ruby}-unf  < 1.0.0,
