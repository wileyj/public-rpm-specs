...
Name: rubygem%{alinux_ruby}-fission
Version: 0.5.0
Release: 1.%{dist}
AutoReqProv : no
...
Provides: rubygem%{alinux_ruby}-fission = %{version}
Provides: rubygem%{alinux_ruby}(fission) = %{version}
Obsoletes: rubygem%{alinux_ruby}-fission < %{version}
Obsoletes: rubygem%{alinux_ruby}(fission) < %{version}


Requires: rubygem%{alinux_ruby}-CFPropertyList  >= 2.2
