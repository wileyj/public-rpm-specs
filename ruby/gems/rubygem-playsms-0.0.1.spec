...
%global gem_name playsms
Name: rubygem-playsms
Version: 0.0.1
Release: 1.%{dist}
Summary: rubygem playsms
Group: Development/Languages
License: MIT
URL: https://github.com/WIU/playsms-ruby
Vendor: %{vendor}
Packager: %{packager}
Requires: ruby rubygems
Provides: rubygem-playsms = %{version}
Provides: rubygem(playsms) = %{version}
Obsoletes: rubygem-playsms < %{version}
Obsoletes: rubygem(playsms) < %{version}
...
gem install --install-dir %{buildroot}/%{gem_dir} --bindir %{buildroot}/%{_bindir} --force --no-rdoc --no-ri --no-doc --ignore-dependencies playsms -v %{version}
