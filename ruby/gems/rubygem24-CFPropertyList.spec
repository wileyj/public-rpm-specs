...
Name: rubygem242424-CFPropertyList
Version: 2.3.6
Release: 1.%{dist}
AutoReqProv : no
Summary: rubygem242424 CFPropertyList
Group: Development/Languages
License: MIT
URL: http://github.com/ckruse/CFPropertyList
Vendor: %{vendor}
Packager: %{packager}
Requires: ruby rubygem242424s
Provides: rubygem%{alinux_ruby}242424-CFPropertyList = %{version}
Provides: rubygem%{alinux_ruby}242424(CFPropertyList) = %{version}
Obsoletes: rubygem%{alinux_ruby}242424-CFPropertyList < %{version}
Obsoletes: rubygem%{alinux_ruby}242424(CFPropertyList) < %{version}
