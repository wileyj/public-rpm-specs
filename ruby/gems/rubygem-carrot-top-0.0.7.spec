...
%global gem_name carrot-top
Name: rubygem-carrot-top
Version: 0.0.7
Release: 1.%{dist}
Summary: rubygem carrot-top
Group: Development/Languages
License: GPL
URL: https://github.com/portertech/carrot-top
Vendor: %{vendor}
Packager: %{packager}
Requires: ruby rubygems
Provides: rubygem-carrot-top = %{version}
Provides: rubygem(carrot-top) = %{version}
Obsoletes: rubygem-carrot-top < %{version}
Obsoletes: rubygem(carrot-top) < %{version}
...
gem install --install-dir %{buildroot}/%{gem_dir} --bindir %{buildroot}/%{_bindir} --force --no-rdoc --no-ri --no-doc --ignore-dependencies carrot-top -v %{version}
