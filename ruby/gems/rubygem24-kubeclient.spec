...
Name: rubygem%{alinux_ruby}-kubeclient
Version: 2.5.1
Release: 1.%{dist}
AutoReqProv : no
Summary: rubygem kubeclient
...
Provides: rubygem%{alinux_ruby}-kubeclient = %{version}
Provides: rubygem%{alinux_ruby}(kubeclient) = %{version}
Obsoletes: rubygem%{alinux_ruby}-kubeclient < %{version}
Obsoletes: rubygem%{alinux_ruby}(kubeclient) < %{version}


Requires: rubygem%{alinux_ruby}-http  >= 0.9.8
Requires: rubygem%{alinux_ruby}-recursive-open-struct  >= 1.0.0
Requires: rubygem%{alinux_ruby}-rest-client
