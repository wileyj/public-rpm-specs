...
Name: rubygem%{alinux_ruby}-english
Version: 0.6.3
Release: 1.%{dist}
AutoReqProv : no
...
Provides: rubygem%{alinux_ruby}-english = %{version}
Provides: rubygem%{alinux_ruby}(english) = %{version}
Obsoletes: rubygem%{alinux_ruby}-english < %{version}
Obsoletes: rubygem%{alinux_ruby}(english) < %{version}


Requires: rubygem%{alinux_ruby}-language
