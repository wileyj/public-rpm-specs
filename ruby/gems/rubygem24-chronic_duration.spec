...
Name: rubygem%{alinux_ruby}-chronic_duration
Version: 0.10.6
Release: 1.%{dist}
AutoReqProv : no
...
Provides: rubygem%{alinux_ruby}-chronic_duration = %{version}
Provides: rubygem%{alinux_ruby}(chronic_duration) = %{version}
Obsoletes: rubygem%{alinux_ruby}-chronic_duration < %{version}
Obsoletes: rubygem%{alinux_ruby}(chronic_duration) < %{version}


Requires: rubygem%{alinux_ruby}-numerizer  >= 0.1.1
