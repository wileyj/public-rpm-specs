...
Provides: rubygem%{alinux_ruby}-i18n = %{version}
Provides: rubygem%{alinux_ruby}(i18n) = %{version}
Obsoletes: rubygem%{alinux_ruby}-i18n < %{version}
Obsoletes: rubygem%{alinux_ruby}(i18n) < %{version}


Requires: rubygem%{alinux_ruby}-concurrent-ruby  >= 1.0
