...
%global gem_name ruby-mysql
Name: rubygem-ruby-mysql
Version: 2.9.14
Release: 1.%{dist}
Summary: rubygem ruby-mysql
...
Provides: rubygem-ruby-mysql = %{version}
Provides: rubygem(ruby-mysql) = %{version}
Obsoletes: rubygem-ruby-mysql < %{version}
Obsoletes: rubygem(ruby-mysql) < %{version}
...
gem install --install-dir %{buildroot}/%{gem_dir} --bindir %{buildroot}/%{_bindir} --force --no-rdoc --no-ri --no-doc --ignore-dependencies ruby-mysql -v %{version}
